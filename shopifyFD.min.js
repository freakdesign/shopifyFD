...
f=0,g=c.products.length;f<g;f++)d+='<option value="'+c.products[f].handle+'">'+c.products[f].title+"</option>";e.append(d);a.after(e).hide()}else $.ajax({type:"GET",url:"/admin/products.json?limit=250",dataType:"json",success:function(c){if(c.products.length){b.data("products",c);for(var d="",f=$("<select />",{}).change(function(){var b=$(this);$("#metafield_value").val(b.val())}).html('<option value="">Add product handle as value</option>'),e=0,q=c.products.length;e<q;e++)d+='<option value="'+c.products[e].handle+
'">'+c.products[e].title+"</option>";f.append(d);a.after(f).hide()}},fail:function(){b.notice("Failed to load products",!0)}});return!1});$("#adv_get_collections").off("click").on("click",function(){var a=$(this);if(b.data("collections")){for(var c=b.data("collections"),d="",e=$("<select />",{}).change(function(){var b=$(this);$("#metafield_value").val(b.val())}).html('<option value="">Add collection handle as value</option>'),f=0,g=c.collections.length;f<g;f++)d+='<option value="'+c.collections[f].handle+
'">'+c.collections[f].title+"</option>";e.append(d);a.after(e).hide()}else $.ajax({type:"GET",url:"/admin/collections.json?limit=250",dataType:"json",success:function(c){if(c.collections.length){b.data("collections",c);for(var d="",f=$("<select />",{}).change(function(){var b=$(this);$("#metafield_value").val(b.val())}).html('<option value="">Add collection handle as value</option>'),e=0,q=c.collections.length;e<q;e++)d+='<option value="'+c.collections[e].handle+'">'+c.collections[e].title+"</option>";
...
c=a.find("a.create"),d=a.find("a.createint");a.find("a.update");a.find("a.delete");var e=a.find("#bulk_namespace"),f=a.find("#bulk_key"),g=a.find("#bulk_value"),h=a.find("textarea.debug"),p=function(){return 1<e.val().length&&1<f.val().length&&1<g.val().length?!0:!1};c.off("click").on("click",function(){if(p){var a={metafield:{namespace:e.val(),key:f.val(),value:g.val(),value_type:"string"}};b.bulk_save_metafield_queue(a,0,h)}else b.notice("No empty fields allowed")});d.off("click").on("click",function(){if(p)if(isNaN(g.val()))b.notice("Value not an integer",
...
return!1}),p=$("<a/>",{"class":"btn",href:"#",title:"Create a linklist with all vendors"}).text("Create Vendor linklist").on("click",function(){e();return!1}),k=$("<p/>",{"class":"box warning",style:"margin-top:1em"}).text("If you use the trash can button to remove a linklist some ShopifyFD features will not reload. Navigate away from the page, and back again.");a&&a.append("<br><br>",g,"<br><br>",h,"<br><br>",p).find("p:eq(0)").append(k)},setup_collections:function(){b.data("collections",!1);var a=
...
"Edit tags for all products in a collection",!0);var a=$("#fdmodal"),c=a.find('select[data-action="action"]'),d=a.find("a").eq(1),e=a.find('select[data-action="collection"]'),k=a.find("input").eq(0);c.change(function(b){"purge"==c.val()||"set"==c.val()?("purge"==c.val()&&k.val("").attr("disabled","disabled"),d.addClass("delete")):(k.removeAttr("disabled"),d.removeClass("delete"))});var t=function(b,a,c,e){var f=b.products[a].id,g={product:{id:f,tags:c}};d.text(a+1+"/"+b.products.length);$.ajax({type:"PUT",
url:"/admin/products/"+f+".json",data:g,dataType:"json",success:function(d){++a;a<b.products.length?t(b,a,c,e):e()}})},q=function(b,a,c,e){if(b.products[a].tags){var f=c.replace(/, /g,",").split(","),g=b.products[a].tags.replace(/, /g,",").split(","),g=$(g).not(f).get()+"",f=b.products[a].id,g={product:{id:f,tags:g}};d.text(a+1+"/"+b.products.length);$.ajax({type:"PUT",url:"/admin/products/"+f+".json",data:g,dataType:"json",success:function(d){++a;a<b.products.length?q(b,a,c,e):e()}})}else++a,a<b.products.length?
q(b,a,c,e):e()},v=function(a,c,e,f){var g=e.replace(/, /g,",").split(","),q=a.products[c].tags.split(","),q=b.array_unique(g.concat(q))+"",g=a.products[c].id,q={product:{id:g,tags:q}};d.text(c+1+"/"+a.products.length);$.ajax({type:"PUT",url:"/admin/products/"+g+".json",data:q,dataType:"json",success:function(b){++c;c<a.products.length?v(a,c,e,f):f()}})};d.on("click",function(){e.val().length?("add"==c.val()&&k.val().length&&$.ajax({type:"GET",url:"/admin/products.json?collection_id="+e.val()+"&fields=id,tags",
dataType:"json",success:function(a){d.addClass("disabled");v(a,0,k.val(),function(){b.notice("Done. Tags have been added");d.text("Update tags").removeClass("disabled")})}}),"purge"!=c.val()&&"set"!=c.val()||$.ajax({type:"GET",url:"/admin/products.json?collection_id="+e.val()+"&fields=id",dataType:"json",success:function(a){d.addClass("disabled");t(a,0,k.val(),function(){b.notice("Done.");d.text("Update tags").removeClass("disabled")})}}),"remove"==c.val()&&$.ajax({type:"GET",url:"/admin/products.json?collection_id="+
e.val()+"&fields=id,tags",dataType:"json",success:function(a){d.addClass("disabled");q(a,0,k.val(),function(){b.notice("Matched tags have been removed.");d.text("Update tags").removeClass("disabled")})}})):b.notice("Choose a collection",!0);return!1});c.hide();$.ajax({type:"GET",url:"/admin/collections.json?limit=250",dataType:"json",success:function(a){if(a.collections.length){b.data("collections",a);for(var d="",f=0,q=a.collections.length;f<q;f++)d+='<option value="'+a.collections[f].id+'">'+a.collections[f].title+
"</option>";e.append(d).find("option:eq(0)").text("Select a collection");c.show()}}});return!1});c.append(e,d);a.append(c);$(".header-right .segmented").eq(0).after(a)},setup_copypaste:function(){if(b.supportsHTML5Storage()){var a=$('<div><a class="btn btn-slim" id="fd_copymetafields">Copy Metafields</a> <a class="btn btn-slim" id="fd_pastemetafields">Paste Metafields</a> <a class="btn btn-slim tooltip tooltip-bottom" href="#" id="fd_whatmetafields"><span class="tooltip-container"><span class="tooltip-label">View what is in the clipboard</span></span>?</a></div>'),
...
g;for(g in e){var h=e[g],p;for(p in h)h.hasOwnProperty(p)&&f.push({variant:{id:h[p],compare_at_price:d}})}f.length&&b.updateVariant(f,0,a)}else b.notice("Unexpected variant found.",!0);else b.notice("You only have 1 variant. No need to bulk edit",!0)});g.append(h);f.append('<i class="ico ico-20-svg ico-sidebar-bottom-website"></i>');a.append(f);b.loadmeta(d,n);$("#product-inner-variants th:last-child").before("<th>Variant ID</th>");$("th.inventory.tc").text("#").prop("title","Quantity");$("tr.variant").each(function(b){var a=
...
f(0,e)}else b.notice("Did you set a weight?",!0);return!1});return!1});$("<span/>",{"class":"hidden"});a.append(k);$('tr.variant input[type="checkbox"]').on("change",function(){1<$('tr.variant input[type="checkbox"]:checked').length?k.removeClass("hidden"):k.addClass("hidden")})}"object"===typeof e&&1<Object.keys(e).length&&c.after(p)},setup_pages:function(){var a=$("div.span6.section-summary").eq(0),c=$("h1.header-main"),d=a.find("a").eq(0).attr("href"),d=$("<a />",{href:d,target:"_blank",style:"display: inline-block;vertical-align: top;",
...
a.find("a.delete_all").on("click",function(){$.ajax({type:"GET",url:"/admin/countries.json",dataType:"json",success:function(a){a.countries.length&&(n.countries=a.countries,b.notice(a.countries.length+" countries returned"),b.shipping_remove_all(a.countries.length-1,a.countries))}});return!1});b.fd_modal(!0,a,"Delete all countries",!0);return!1});a.find("header").eq(0).append(c);if($("div.shipping-rate-table").length===b.data("countries").countries.length){var d=[],e=[],f=[],g=function(a,c,d){if(c.length){var e=
[];$.ajax({type:"GET",url:"/admin/countries/"+a+".json",dataType:"json",success:function(a){var f=a.country.weight_based_shipping_rates,g=a.country.price_based_shipping_rates,h=a.country.carrier_shipping_rate_providers;a=0;for(var s=f.length;a<s;a++)e.push([f[a].id,"weight"]);a=0;for(s=g.length;a<s;a++)e.push([g[a].id,"price"]);a=0;for(s=h.length;a<s;a++)e.push([h[a].id,"carrier"]);a=0;for(s=e.length;a<s;a++)f="","weight"==e[a][1]&&(f="/admin/weight_based_shipping_rates/"),"price"==e[a][1]&&(f="/admin/price_based_shipping_rates/"),
"carrier"==e[a][1]&&(f="/admin/carrier_shipping_rate_providers/"),$.ajax({type:"DELETE",url:f+e[a][0]+".json",dataType:"json",success:function(b){}});b.save_new_rates(c,0,d)},fail:function(){b.notice("I failed to get the country.json",!0)}})}else b.notice("Missing items to add",!0)};$("div.shipping-rate-table").each(function(a){var c=$(this),k=$("<a/>",{href:"#","data-country":b.data("countries").countries[a].name,"data-cid":b.data("countries").countries[a].id,"data-index":a,"class":"btn btn-slim copyrates",
...
"data-cid":b.data("countries").countries[a].id,"data-index":a,"class":"bulkpaste btn btn-slim",style:"float:right;margin-right:.5em"}).text("Paste rates").on("click",function(){var b=$(this),a=b.attr("data-cid"),c=d,h=e,k=f,p=[],l=0;b.parent().parent().find("tbody").remove();b.parent().find("a.copyrates").remove();for(var r=0,n=c.length;r<n;r++)c[r].country_id=a,delete c[r].id,c[r].type="weight",p[l]=c[r],l++;r=0;for(n=h.length;r<n;r++)h[r].country_id=a,delete h[r].id,h[r].type="price",p[l]=h[r],
l++;r=0;for(n=k.length;r<n;r++)k[r].country_id=a,delete k[r].id,k[r].type="carrier",p[l]=k[r],l++;g(a,p,b);return!1}).hide();c.find('a[data-event-click="setupNewShippingRateForm"]').after(a,k)})}else b.notice("Mismatch in country count. Reload this page.",!0)}else $.ajax({type:"GET",url:"/admin/countries.json",dataType:"json",success:function(a){a.countries.length&&(b.data("countries",a),b.notice(a.countries.length+" countries loaded"),b.setup_shipping(!0))}})},setup_custom_collections:function(){$("div.row.section.visibility").eq(0).after('<div class="row section" id="customer_meta_box"><div class="span12 section-summary"><div class="sub_section-summary fadein"><h1><strong>Metafields</strong> <span id="metacount">0</span></h1><div class="content"><i class="ico ico-20 ico-20-loading"></i></div></div></div></div>');
var a=$("div.sub_section-summary .content");b.loadmeta(a,n);0===$("#rte_extra").length&&($("#collection-description_iframecontainer").eq(0).after('<div id="rte_extra"><a class="btn btn-slim tooltip tooltip-bottom" id="clearformatting" href="#"><span class="tooltip-container"><span class="tooltip-label">Careful, this method is brutal...</span></span>Purge html</a> <a class="btn btn-slim tooltip tooltip-bottom" id="createbackup" href="#"><span class="tooltip-container"><span class="tooltip-label">Save contents as metafield</span></span>Create Backup</a> <a class="btn btn-slim" style="display:none;" id="restorebackup" href="#">Restore Backup</a> <a class="btn btn-slim tooltip tooltip-bottom" id="save_images_to_meta" href="#"><span class="tooltip-container"><span class="tooltip-label">Add image paths to a metafield</span></span>Images to Metafields</a></div>'),
b.setup_rte())},get_files:function(a,c){var d=$("#settings-general table");b.notice("Loading files...");$.ajax({type:"GET",url:"/admin/files.json?limit=50&direction=next&page="+a,success:function(a,f,g){if(a){$("");f=0;for(g=a.files.length;f<g;f++){var h=$("<tr />",{"class":"file_row"}),p=$("<td />"),k=$("<td />"),l=$("<td />"),q=$("<td />",{"class":"tr"}),n=$("<td />"),u=$("<a />",{href:"#","data-src":a.files[f].public_url.replace("http:","")});if(-1<a.files[f].content_type.indexOf("image")){u.on("click",
function(){var a=$(this);b.fd_modal(!0,'<img src="'+a.attr("data-src")+'" />',"Image Preview",!0);return!1}).text(a.files[f].key.replace("files/",""));var w=a.files[f].public_url.replace(/(\.[^\.]+)$/,"_thumb$1").replace("http:","");p.html('<img src="'+w+'" />');k.append(u);l.html('<input class="select-all-on-focus" value="'+a.files[f].public_url+'">')}else u.attr("href",a.files[f].public_url).attr("target","_blank").text(a.files[f].key.replace("files/",""));q.html(Math.floor(a.files[f].size/1024)+
" kB");h.append(p,k,l,q,n);d.append(h)}f>=c?(b.notice("All loaded"),$(".header-right .segmented").hide()):(++f,b.get_files(f,c))}}})},setup_files:function(){var a=$("<ul/>",{"class":"segmented",id:"get_all_images"}),c=$("<li/>"),d=$("<a/>",{"class":"btn",href:"#",style:"margin-left:1em"}).html("Show all files").on("click",function(){var a=$(this);a.addClass("is-loading").attr("style","margin-left:1em;text-indent: -9999px;");$.ajax({type:"GET",url:"/admin/files.json?limit=2&fields=id",success:function(c,
...
b.clearmetaform()})},add_ui:function(){if(0===$("#shopifyJSbar").length){var a=$("body"),c=$("<div>",{id:"shopifyJSbar","class":"loading noprint fadein"}),d=$("<div>",{"class":"wrapper clearfix"}),e=$("<ul>",{id:"shopifyJSnav"});e.html('<li><a id="aboutapp" href="javascript:void(0)" class="tooltip tooltip-bottom"><span class="tooltip-container"><span class="tooltip-label">About this tool</span></span>About ShopifyFD</a></li><li><a id="getnotifications" href="javascript:void(0)" class="tooltip tooltip-bottom"><span class="tooltip-container"><span class="tooltip-label">View news and announcements</span></span><i style="background-size: contain;" class="ico ico-16 ico-sidebar-bottom-announcements-inactive"></i></a></li><li><a id="togglestyle" href="javascript:void(0)" class="tooltip tooltip-bottom"><span class="tooltip-container"><span class="tooltip-label">Toggle ShopifyFD style overrides</span></span>Toggle CSS</a></li><li><a id="bulkmetafields" href="javascript:void(0)" class="tooltip tooltip-bottom"><span class="tooltip-container"><span class="tooltip-label">Experimental feature - has limitations</span></span>Bulk Metafields</a></li><li><a href="//freakdesign-us.s3.amazonaws.com/shopify/shopifyFD/freakdesign-shopifyfd-for-shopify-guide.pdf" target="_blank" class="tooltip tooltip-bottom"><span class="tooltip-container"><span class="tooltip-label">Open the help PDF in new window</span></span>Help</a></li><li class="animated delay bounce"><a href="http://shopifyfd.com/#install" target="_blank" class="tooltip tooltip-bottom"><span class="tooltip-container"><span class="tooltip-label">Your support is appreciated.</span></span>Use this free tool? Tip me! ($)</a></li>');
e.find("a").on("click",function(){if(b.isloading())b.notice("We better wait for this page to load first...",!0);else{var a=$(this),c=a.prop("id");if(c)"bulkmetafields"==c?b.bulkmetafields():"togglestyle"==c?(b.toggleStyle(),a.toggleClass("active")):"aboutapp"==c?b.about_app():"getnotifications"==c&&b.show_notification();else return!0}return!1});d.append(e);c.append(d);a.append(c);c.removeClass("loading")}},load_css:function(){var a=document.createElement("link");a.type="text/css";a.rel="stylesheet";
a.id="shopifyjs";a.href="//rawgithub.com/freakdesign/shopifyFD/master/shopifyFD.css";document.getElementsByTagName("head")[0].appendChild(a)},get_theme_data:function(){b.data("themeID")||$.ajax({type:"GET",url:"/admin/themes.json",success:function(a){if(a)for(var c=0,d=a.themes.length;c<d;c++)"main"===a.themes[c].role&&(b.flog(a.themes[c].id),b.data("themeID",a.themes[c].id),b.data("themeName",a.themes[c].name))}})},init:function(){b.get_theme_data();b.data("debug")||b.readCookie("shopifyfd")||(b.flash_notification(),
b.createCookie("shopifyfd","loaded",3));$("html").addClass("shopifyJSoverride");setInterval(function(){b.data("content",$("#content"));if(!b.data("content").hasClass("loading")){b.add_ui();var a=l.URL.split("#")[0].split("?")[0].split("/"),a=a[a.length-2],c=l.URL.split("/").pop();if(a!==b.data("alpha")||c!==b.data("omega"))b.data("alpha",a),b.data("omega",c),b.flog(b.data("alpha")+","+b.data("omega")),"customers"!=b.data("alpha")||isNaN(b.data("omega"))?"articles"!=b.data("alpha")||isNaN(b.data("omega"))?
"pages"!=b.data("alpha")||isNaN(b.data("omega"))?"smart_collections"!==b.data("alpha")||isNaN(b.data("omega"))?"custom_collections"!==b.data("alpha")||isNaN(b.data("omega"))?"collections"!==b.data("alpha")||isNaN(b.data("omega"))?"blogs"!=b.data("alpha")||isNaN(b.data("omega"))?"products"==b.data("alpha")?b.setup_products():"admin"==b.data("alpha")&&"products"==b.data("omega")?b.setup_products_list():"orders"!=b.data("alpha")||isNaN(b.data("omega"))?"admin"==b.data("alpha")&&"orders"==b.data("omega")?
b.setup_orders():"admin"==b.data("alpha")&&"collections"==b.data("omega")?b.setup_collections():"admin"==b.data("alpha")&&"link_lists"==b.data("omega")?b.setup_link_lists():"admin"==b.data("alpha")&&"links"==b.data("omega")?b.setup_link_lists():"admin"==b.data("alpha")&&"themes"==b.data("omega")?b.setup_themes():"link_lists"!=b.data("alpha")||isNaN(b.data("omega"))?"admin"==b.data("alpha")&&"discounts"==b.data("omega")?b.setup_discounts():"settings"==b.data("alpha")&&"general"==b.data("omega")?b.setup_settings_general():
"settings"==b.data("alpha")&&"files"==b.data("omega")?b.setup_files():"settings"==b.data("alpha")&&"shipping"==b.data("omega")?b.setup_shipping():"settings"==b.data("alpha")&&b.data("omega"):b.setup_link_lists_edit():b.setup_single_order():b.setup_blogs():b.setup_custom_collections():b.setup_custom_collections():b.setup_custom_collections():b.setup_pages():b.setup_articles():b.setup_customers()}},b.data("wait"));b.notice("ShopifyFD loaded")},data:function(a,b){if("undefined"===typeof b)return n[a];
n[a]=b},toggleStyle:function(){$("html").toggleClass("shopifyJSoverride")},isloading:function(){return b.data("content").hasClass("loading")}}}();b.load_css();b.init()}else alert("Error. This should be run within the Shopify Admin page.")}else alert("Error. jQuery not found.")})();