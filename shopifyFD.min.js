...
e=0,h=b.collections.length;e<h;e++)c+='<option value="'+b.collections[e].handle+'">'+b.collections[e].title+"</option>";d.append(c);a.after(d).hide()}},error:function(){f("Failed to load collections",!0)}});return!1});$("#metafieldselect").change(function(){var a=$(this).find(":selected");if(a.attr("data-id")){var b=m.metafields[a.attr("data-id")];$(".metafield-next-label").text(n.edit_metafield);$("#metafield_namespace").val(b.namespace).prop("disabled",!0);$("#metafield_key").val(b.key).prop("disabled",
!0);$("#metafield_value").val(b.value);$("#metafield_id").val(a.attr("data-id"));$("#shopifyjs_deletemetafield").removeClass("hide")}else R()});$("#shopifyjs_deletemetafield").on("click",function(a){a.preventDefault();a=$("#metafield_id").val()||!1;if(!a)return f("Object ID Missing",!0),!1;a=z(a);-1<a.indexOf("?show_all_images")||-1<a.indexOf("products.json")||$.ajax({type:"DELETE",url:a,success:function(a){f(n.metafield_deleted);r()},error:function(a){f("Failed to delete",!0)}})});$(".metafield-content a.savemymeta").off("click").on("click",
...
error:function(a){a=JSON.parse(a.responseText);var b="";a.errors.namespace&&(b+="Namespace "+B(a.errors.namespace[0])+". ");a.errors.key&&(b+="Key "+B(a.errors.key[0])+". ");a.errors.value&&(b+="Value "+B(a.errors.value[0])+". ");f("Metafield failed to save: "+b,!0)}}));return!1})})},ia=function(){var a=$("iframe:first").contents().find("#tinymce:first");if(!a.length)return!1;var b=["href","target","class","src"];a.find("*").each(function(a,d){for(a=d.attributes.length-1;0<=a;a--)0>b.indexOf(d.attributes[a].name)&&
...
c[0].href=["//",location.host,location.pathname].join("")+".json"):(b[0].classList.add("hidden"),c[0].href="")}},ka=function(){if(function(){var a=document.createElement("div");return"draggable"in a||"ondragstart"in a&&"ondrop"in a}()){v("has dnd");var a=document.documentElement;a.ondragover=function(){this.className="dragit";return!1};a.ondragleave=function(){this.className="";return!1};a.ondragend=function(){this.className="";return!1};a.ondrop=function(a){a.preventDefault&&a.preventDefault();var c=
a.dataTransfer.files,d=c.length,e=0,h=new FileReader,l={};h.onload=function(a){v("load");a=a.target.result.split(",")[1];l[e]={name:c[e].name,data:a};e++;e<d?(f("Reading file ["+(e+1)+"] contents..."),h.readAsDataURL(c[e])):ja(l)};d&&(document.documentElement.className="dragit",f("Reading file ["+(e+1)+"] contents..."),h.readAsDataURL(c[e]));return!1}}},ja=function(a){var b=m.data.themeId;if(!b||isNaN(b))return f("Theme ID not found",!0),!1;var c=Object.keys(a).length,d=0;"themes"==g("alpha")&&(b=
...
l="put"}$.ajax({type:l,url:k,data:b,success:function(b){v(b);x(a);f("Metafield saved")},error:function(b){x(a);f("Error Saving",!0)}})},la=function(a,b){var c="/admin/variants/"+a+"/metafields/"+b+".json";if(-1<c.indexOf("?")||-1<c.indexOf("products.json"))return!1;$.ajax({type:"DELETE",url:c,success:function(b){v(b);x(a);f(n.metafield_deleted)},error:function(b){x(a);f("Failed to delete",!0)}})},x=function(a){if("undefined"===typeof a||isNaN(a)||!a)return f("Could not find ID",!0),!1;$("#mv_namespace").val("").prop("disabled",
...
function(){g("current_vid")||g("current_vid","");T(a,$("#mv_namespace").val(),$("#mv_key").val(),$("#mv_value").val(),g("current_vid"));return!1});$("#vrow .saveinteger").off("click").on("click",function(){g("current_vid")||g("current_vid","");T(a,$("#mv_namespace").val(),$("#mv_key").val(),$("#mv_value").val(),g("current_vid"),!0);return!1});$("#vrow .delete").addClass("hidden").off("click").on("click",function(){la(a,g("current_vid"));return!1});$("#vrow select").eq(0).off("change").change(function(){var a=
...
A())},N=function(){$("#restorebackup").show().on("click",function(a){a.preventDefault();a:{g("omega");a=$("iframe").contents().find("#tinymce").eq(0);var b=g("m");if(b)for(var c=0,d=b.length;c<d;c++){if("backups"===b[c].namespace){a.html(b[c].value);f("Backup restored");break a}}else f("Error, nothing to restore",!0)}})},A=function(){var a=$("#restorebackup");a.length&&(g("hasbackup")?N():a.hide());$("#clearformatting").on("click",function(a){a.preventDefault();a=$("iframe:first").contents().find("#tinymce:first");
if(a.length){var c=document.createElement("div");c.innerHTML=a.html();a.text(c.textContent||c.innerText||"")}});$("#clear-html-attributes").on("click",function(a){a.preventDefault();ia()});$("#createbackup").on("click",function(a){a.preventDefault();M(g("omega"))});$("#save_images_to_meta").on("click",function(a){a.preventDefault();qa()})},qa=function(){var a=$("iframe:first").contents().find("#tinymce:first").find("img");if(a&&a.length){var b="";a.each(function(c){var d=$(this).prop("src").replace(/https:/i,
"");b+=d;c<a.length-1&&(b+=",")});var c={metafield:{namespace:"helpers",key:"images",value:b,value_type:"string"}},d=[location.protocol,"//",location.host,location.pathname,"/metafields.json"].join("");"articles"===g("alpha")&&(d="/admin/articles/"+g("omega")+"/metafields.json");$.ajax({type:"POST",url:d,dataType:"json",data:c,success:function(a){r();f("Images saved to metafield")},error:function(a){f("Error saving",!0)}})}else f("No images found",!0)},E=function(a){a=a.concat();for(var b=0;b<a.length;++b)for(var c=
...
e+"</span>");b+1<a.length?g(a,b+1):(f("SKUs and Variant IDs Loaded"),d.removeClass("is-loading").text("Data Loaded"))}})};f("Loading SKUs and Variant IDs, please wait...");g(b,0)}});c.append(d);b.append(c);a.append(b)},V=function(){if("undefined"===typeof m.data.themes)$.ajax({type:"GET",url:"/admin/themes.json",success:function(a){if(a){m.data.themes=a.themes;for(var b=0,c=a.themes.length;b<c;b++)"main"===a.themes[b].role&&(m.data.themeId=a.themes[b].id);V()}}});else{var a=function(a){if("undefined"===
typeof m.data.themes||"undefined"===typeof a)return!1;a=parseInt(a);for(var b=m.data.themes.length-1;0<=b;b--)if(m.data.themes[b].id===a)return m.data.themes[b]},b=$(".published-theme-title");$(".unpublished-theme-title");for(var c=$("div.unpublished-box"),d=[],e=0;e<c.length;e++){var h=c[e].id.split("_").pop();d.push(h);var l=c.eq(e).find(".unpublished-theme-title"),k=a(h),g="";k&&(g+="<br>Created at: "+(new Date(k.created_at)).toString(),g+="<br>Updated at: "+(new Date(k.updated_at)).toString());
l.after('<div style="font-size:90%;opacity:.5" class="theme-data" data-id="'+h+'">Theme ID: '+h+g+"</div>")}b.length&&(c=$(".published-theme .btn-primary").eq(0).attr("href"),"undefined"!==typeof c&&-1<c.indexOf("/admin/themes")&&(h=c.split("/")[3],d.push(h),k=a(h),g="",k&&(g+="<br>Created at: "+(new Date(k.created_at)).toString(),g+="<br>Updated at: "+(new Date(k.updated_at)).toString()),b.after('<div style="font-size:90%;opacity:.5" class="theme-data" data-id="'+h+'">Theme ID: '+h+g+"</div>")));
2>d.length||(a=$(".header .header__secondary-actions:first"),a.length&&(b=$("<a />",{"class":"btn fd-btn"}).text("Export all themes").on("click",function(a){a.preventDefault();for(a=0;a<d.length;a++)$.ajax({type:"POST",data:{_method:"post"},url:"/admin/themes/"+d[a]+"/export"});f(d.length+" export request"+(1<d.length?"s":"")+" sent. Check your inbox")}),a.append(b)))}},sa=function(){var a=$(".header .header__primary-actions:first");if(!a.length)return!1;$.ajax({type:"GET",url:"/admin/link_lists.json",
dataType:"json",success:function(b){if(b){b=b.link_lists;for(var c="",d=0,e=b.length;d<e;d++)g("omega")!==b[d].id.toString()&&(c+='<option value="'+b[d].id+'">'+b[d].title+"</option>");b=$("<select />",{"class":"header-select fadein"}).append("<option>Edit other Menu</option>",c).change(function(){var a=$(this).val();a&&p("/admin/link_lists/"+a)});a.prepend(b)}},error:function(a){f("Error loading linklist data",!0)}})},W=function(){var a=$(".next-card__section .next-grid__cell--no-flex"),b=function(){$.ajax({type:"GET",
url:"/admin/collections.json?limit=250",dataType:"json",success:function(a){for(var b=$.param({utf8:"\u2713","link_list[handle]":"all-collections","link_list[title]":"All Collections"}),c=[],d=0,h=a.collections.length;d<h;++d){c.push({position:d+1,title:a.collections[d].title,link_type:"collection",subject_id:a.collections[d].id});var f={};f["link_list[links][][position]"]=d+1;f["link_list[links][][title]"]=a.collections[d].title;f["link_list[links][][link_type]"]="collection";f["link_list[links][][subject_id]"]=
a.collections[d].id;b+="&"+$.param(f)}e(b)},error:function(){f("Error! Are you sure you have access to collections?",!0)}});return!1},c=function(){$.ajax({type:"GET",url:"/admin/pages.json?limit=250",dataType:"json",success:function(a){for(var b=$.param({utf8:"\u2713","link_list[handle]":"all-pages","link_list[title]":"All Pages"}),c=[],d=0,h=a.pages.length;d<h;++d){c.push({position:d+1,title:a.pages[d].title,link_type:"page",subject_id:a.pages[d].id});var f={};f["link_list[links][][position]"]=d+
1;f["link_list[links][][title]"]=a.pages[d].title;f["link_list[links][][link_type]"]="page";f["link_list[links][][subject_id]"]=a.pages[d].id;b+="&"+$.param(f)}e(b)},error:function(){f("Error! Are you sure you have access to pages?",!0)}});return!1},d=function(){$.ajax({type:"GET",url:"/admin/products/vendors.json",dataType:"json",success:function(a){for(var b=$.param({utf8:"\u2713","link_list[handle]":"all-vendors","link_list[title]":"All Vendors"}),d=[],c=0,f=a.vendors.length;c<f;++c){var h={position:c+
1,title:a.vendors[c],link_type:"http",subject:"/collections/vendors?q="+encodeURIComponent(a.vendors[c].toLowerCase()).replace(/%20/g,"+")},l={};l["link_list[links][][position]"]=c+1;l["link_list[links][][title]"]=a.vendors[c];l["link_list[links][][link_type]"]="http";l["link_list[links][][subject]"]="/collections/vendors?q="+encodeURIComponent(a.vendors[c].toLowerCase()).replace(/%20/g,"+");b+="&"+$.param(l);d.push(h)}e(b)}})},e=function(a){"undefined"!==typeof a&&$.ajax({type:"POST",url:"/admin/link_lists",
data:a,success:function(a,b,c){(b=c.getResponseHeader("X-XHR-Redirected-To"))?(linklistID=b.split("/").pop(),isNaN(linklistID)?f("Error creating linklist - ID not returned",!0):(f("Link list added"),p("/admin/link_lists/"+linklistID))):(linklistID=$(a).find("form").eq(0).attr("action").split("/").pop(),isNaN(linklistID)||(f("Link list added"),p("/admin/link_lists/"+linklistID)))},error:function(){f("Error creating linklist",!0)}})},h=$("<a/>",{href:"#","class":"tooltip-bottom tooltip",style:"margin-right:1.5em"}).html('<span class="tooltip-container"><span class="tooltip-label">Make a copy of this linklist</span></span>Duplicate').on("click",
...
c.val(d);a.shift();0<a.length?H(a):f("Bulk redirection additions complete")},error:function(e){d+=b.redirect.path+", "+b.redirect.target+", "+e.responseJSON.errors.path[0]+"\n";c.val(d);a.shift();0<a.length?H(a):f("Bulk redirection additions complete")}})}}},ta=function(){if(!document.getElementsByClassName("bulk-redirect-panel").length){$(".header .header__secondary-actions:first");var a=$(".next-card.has-bulk-actions");a.length||(a=$("#url_redirects"));if(!a.length)return f("Could not add bulk redirect panel",
...
"Edit tags for all products in a collection",!0);var a=$("#fdmodal"),b=a.find('select[data-action="action"]'),c=a.find("a").eq(1),d=a.find('select[data-action="collection"]'),e=a.find("input").eq(0);b.change(function(a){"purge"==b.val()||"set"==b.val()?("purge"==b.val()&&e.val("").attr("disabled","disabled"),c.addClass("delete")):(e.removeAttr("disabled"),c.removeClass("delete"))});var O=function(a,b,d,e){var f=a.products[b].id,h={product:{id:f,tags:d}};c.text(b+1+"/"+a.products.length);$.ajax({type:"PUT",
url:"/admin/products/"+f+".json",data:h,dataType:"json",success:function(c){++b;b<a.products.length?O(a,b,d,e):"function"===typeof e&&e()}})},m=function(a,b,d,e){if(a.products[b].tags){var f=d.replace(/, /g,",").split(","),h=a.products[b].tags.replace(/, /g,",").split(","),h=$(h).not(f).get()+"",f=a.products[b].id,h={product:{id:f,tags:h}};c.text(b+1+"/"+a.products.length);$.ajax({type:"PUT",url:"/admin/products/"+f+".json",data:h,dataType:"json",success:function(c){++b;b<a.products.length?m(a,b,
d,e):"function"===typeof e&&e()}})}else++b,b<a.products.length?m(a,b,d,e):"function"===typeof e&&e()},P=function(a,b,d,e){var f=d.replace(/, /g,",").split(","),h=a.products[b].tags.split(","),h=E(f.concat(h))+"",f=a.products[b].id,h={product:{id:f,tags:h}};c.text(b+1+"/"+a.products.length);$.ajax({type:"PUT",url:"/admin/products/"+f+".json",data:h,dataType:"json",success:function(c){++b;b<a.products.length?P(a,b,d,e):e()}})};c.on("click",function(){d.val().length?("add"===b.val()&&e.val().length&&
$.ajax({type:"GET",url:"/admin/products.json?collection_id="+d.val()+"&fields=id,tags",dataType:"json",success:function(a){c.addClass("disabled");P(a,0,e.val(),function(){f("Done. Tags have been added");c.text("Update tags").removeClass("disabled")})}}),"purge"!==b.val()&&"set"!==b.val()||$.ajax({type:"GET",url:"/admin/products.json?collection_id="+d.val()+"&fields=id",dataType:"json",success:function(a){c.addClass("disabled");O(a,0,e.val(),function(){f("Done.");c.text("Update tags").removeClass("disabled")})}}),
...
a.removeClass("is-loading").text(n.save))}})};a.addClass("is-loading").text("");e(0,d)}else f("Did you set a weight?",!0);return!1});return!1});d.append(F);$('tr.variant input[type="checkbox"]').on("change",function(){1<$('tr.variant input[type="checkbox"]:checked').length?F.removeClass("hide"):F.addClass("hide")})}a.length&&"object"===typeof l&&1<Object.keys(l).length&&a.find("header a.btn--plain:last").after(q)},xa=function(){var a=$(".ui-layout__section--secondary .ui-layout__item:last");if(a.length){a.find("a").eq(0).clone(!0);
...
a[Object.keys(a)[0]].id;"undefined"!==b&&p("/admin/collections/"+b)}catch(c){}},error:function(){f("Error duplicating.",!0)}});else{var e=0,g=window.location.pathname.split("/").pop(),m=function(a,d,e,g){"undefined"!==typeof a&&"undefined"!==typeof d&&("undefined"===typeof e&&(e=1),"undefined"===typeof g&&(g=[]),f("Duplicating collection, please wait..."),$.ajax({type:"GET",url:"/admin/collects.json?limit=250&fields=product_id&page="+e+"&collection_id="+a,success:function(h){g=g.concat(h.collects);
250*e>d?(b.custom_collection.collects=g,$.ajax({type:"POST",url:c,contentType:"application/json;charset=utf-8",data:JSON.stringify(b),success:function(a){try{var b=a[Object.keys(a)[0]].id;"undefined"!==b&&p("/admin/collections/"+b)}catch(c){}},error:function(){f("Error duplicating.",!0)}})):m(a,d,++e,g)}}))};(function(){$.ajax({type:"GET",url:"/admin/collects/count.json?collection_id="+g,success:function(a){e=a.count;0<e&&m(g,e,1)}})})()}})});c.append(d);a.append(c);b.prepend(a)}else f("ShopifyFD error : setup_articles : Header button missing",
...
a).text("Hidden in Sitemap"):$(".seo-hide-button").removeClass("active").removeAttr("data-id").text(n.hide_from_sitemap)},r=function(){var a=z();$.getJSON(a,function(a){var c="";a=a.metafields;D();if(a.length){g("m",a);$("#metacount").text(a.length).removeClass("hide");for(var d=0,e=a.length;d<e;d++)c+='<option data-type="'+a[d].value_type+'" data-id="'+a[d].id+'">'+a[d].namespace+"."+a[d].key+"</option>",m.metafields[a[d].id]={namespace:a[d].namespace,value:a[d].value,key:a[d].key},"backups"===a[d].namespace&&
$("#restorebackup").show(),"seo"===a[d].namespace&&"hidden"===a[d].key&&1===a[d].value&&D(a[d].id);c=y+c}else $("#metacount").text("0").addClass("hide"),g("m",!1),$("#restorebackup").hide(),c=y;$("#metafieldselect").html(c);R()})};(function(){document.getElementsByTagName("html")[0].className+=" shopifyJSoverride";ka();ea();var a=document.querySelectorAll('a[href="/admin/products"]');a.length&&(a[0].href="/admin/products?limit=250");a=document.querySelectorAll('a[href="'+[location.protocol,"//",location.host].join("")+
'/admin/apps"]');a.length&&(a[0].href="/admin/apps/installed");setInterval(function(){m.cache.content=document.getElementById("content");if(!m.cache.content.classList.contains("loading")){ga();var a=K(),c=!1,d=a[0],e=a[1],a=a[2];"next"===e||"prev"===e||d===g("alpha")&&e===g("omega")?"next"!==e&&"prev"!==e&&a!=m.queryString&&("products"!==d||isNaN(e)?"admin"===d&&"products"===e?c=!0:"admin"===d&&"redirects"===e&&(c=!0):c=!0):c=!0;if(c)if(m.alpha=d,m.omega=e,m.queryString=a,"customers"===d&&!isNaN(e))c=
...
f("ShopifyFD error : setup_customers : target HTML not found");else if("articles"===d&&!isNaN(e))pa();else if("blogs"===d&&!isNaN(e))targetHTML=$(".ui-layout__section--secondary .ui-layout__item:last"),targetHTML.length?(targetHTML.prepend('<div class="next-card-metafield next-card next-card--aside fadein"><section class="next-card__section"><h3 class="next-heading">Metafields <span id="metacount" class="hide">0</span></h3><div class="metafield-content content"><i class="ico ico-20 ico-20-loading"></i></div></section></div>'),
c=$("div.metafield-content"),t(c)):f("ShopifyFD error : setup_blogs : target html not found",!0);else if("collections"===d&&!isNaN(e))za();else if("link_lists"===d&&!isNaN(e))sa();else if("orders"===d&&!isNaN(e))Ba();else if("pages"===d&&!isNaN(e))xa();else if("products"===d&&!isNaN(e))wa();else if("variants"===d&&!isNaN(e))G(!0),c=$(".next-layout__sidebar > div:first"),c.length&&(c.after('<div class="next-card-metafield next-card next-card--aside fadein"><section class="next-card__section"><h3 class="next-heading">Metafields <span id="metacount" class="hide">0</span></h3><div class="metafield-content content"><i class="ico ico-20 ico-20-loading"></i></div></section></div>'),
t($("div.metafield-content")));else if("admin"!==d||"apps"!==e)if("admin"!==d||"channels"!==e)if("admin"===d&&"collections"===e)ua();else if("admin"===d&&"discounts"===e)oa();else if("admin"!==d||"draft_orders"!==e)if("admin"===d&&"link_lists"===e)W();else if("admin"===d&&"links"===e)W();else if("admin"===d&&"orders"===e)Ca();else if("admin"===d&&"products"===e)ra();else if("admin"===d&&"redirects"===e)ta();else if("admin"!==d||"reports"!==e)if("admin"===d&&"themes"===e)V();else if("admin"!==d||"transfers"!==
e)if("online_store"!==d||"preferences"!==e)"settings"===d&&"account"===e?$(".ui-annotated-section:last").after('<section class="ui-annotated-section"><div class="ui-annotated-section__annotation"><div class="ui-annotated-section__title"><h2 class="next-heading next-heading--no-margin">Purge / Delete all site content</h2></div><div class="ui-annotated-section__description"><p>Delete all content on the store to start fresh</p></div></div><div class="ui-annotated-section__content"><div class="next-card"><div class="next-card__section"><p>Coming soon...</p></div></div></div></section>'):
