...
m.save+'</a> <a class="btn createint">Save Integer</a></td><td><span style="display:none"><a class="btn delete">Delete</a> <input type="text" style="width:50%" placeholder="Type delete" /></span></td></tr><tr><td colspan="2"><textarea class="debug" placeholder="Data Output (future use only)"></textarea></td></tr></table>',K=function(a){"undefined"===typeof a&&(a=[location.protocol,"//",location.host,location.pathname].join(""));var b=a.split("/");a=b[b.length-2];b=b.pop();return[a,b,location.search.substring(1)]},
C=function(a){return a.replace(/[\\]/g,"\\\\").replace(/[\"]/g,'\\"').replace(/[\/]/g,"\\/").replace(/[\b]/g,"\\b").replace(/[\f]/g,"\\f").replace(/[\n]/g,"\\n").replace(/[\r]/g,"\\r").replace(/[\t]/g,"\\t")},p=function(a){if("undefined"!==typeof a&&"function"===typeof Turbolinks)try{Turbolinks.visit(a)}catch(b){return!1}},L=function(a,b){return a.getAttribute("value")?b.getAttribute("value")?a.innerHTML>b.innerHTML?1:-1:1:-1},f=function(a,b){"function"===typeof Shopify.Flash.error&&"function"===
typeof Shopify.Flash.notice&&(b?Shopify.Flash.error(a):Shopify.Flash.notice(a))},g=function(a,b){if("undefined"===typeof b)return n[a];n[a]=b},ca=function(){"undefined"===typeof n.data.themeId&&$.ajax({type:"GET",url:"/admin/themes.json",success:function(a){if(a){n.data.themes=a;for(var b=0,c=a.themes.length;b<c;b++)"main"===a.themes[b].role&&(n.data.themeId=a.themes[b].id)}}})},ea=function(){if(0<$("#shopifyJSbar").length)return!1;var a=$("<div />",{id:"shopifyJSbar","class":"loading noprint fadein"}),
b=$("<div>",{"class":"wrapper clearfix"}),c=$("<ul>",{id:"shopifyJSnav"});c.html(aa).find("a").on("click",function(a){if(!n.cache.content.classList.contains("loading")){a=$(this).prop("id");if("bulkmetafields"===a)return da(),!1;if("aboutapp"===a)return u(!0,'<p>ShopifyFD is "honor-ware", which means that we trust each other to be nice. As the developer of it, I\'m committed to keep the tool something that\'s actually useful. By releasing new features and correcting possible bugs on a constant basis I can do just that, but I need your support. If you use it and intend to keep it, please sponsor its development by making a small <a target="_blank" href="http://shopifyfd.com/">contribution</a>.</p><p>You can track changes by keeping an eye on the project page or following me on <a target="_blank" href="https://twitter.com/freakdesign">twitter</a>.</p><p><h4 style="margin-top:1em">Resources and links</h4><ul><li><a href="http://freakdesign.com.au/pages/shopifyfd" target="_blank">Project home page</a></li><li><a href="http://goo.gl/OsFK2d" target="_blank">Feature Request</a></li><li><a href="http://bit.ly/shopifyFD_forum" target="_blank">Shopify forum post</a></li></ul></p>',
m.about_shopifyfd,!0),!1}});b.append(c);a.append(b);$("body").append(a);a.removeClass("loading")},M=function(a,b){if("undefined"===typeof a||!a)return!1;var c=$("iframe:first").contents().find("#tinymce:first");if(!c.length)return!1;c=c.html();c={metafield:{namespace:"backups",key:a,value:c,value_type:"string"}};if("undefined"!==typeof b){if(0>window.location.href.indexOf("/admin/products/")||!$("#autosave").hasClass("active"))return!1;$("#autosave").addClass("is-loading").removeClass("active");c.metafield.namespace=
"autosave";c.metafield.key="html"}var d=[location.protocol,"//",location.host,location.pathname,"/metafields.json"].join("");"articles"===g("alpha")&&(d="/admin/articles/"+a+"/metafields.json");$.ajax({type:"POST",url:d,dataType:"json",data:c,success:function(a){r();"undefined"===typeof b?f("Backup saved"):$("#autosave").removeClass("is-loading").addClass("active")},error:function(a){a=JSON.parse(a.responseText);f(a.errors.value[0],!0)}});return!0},D=function(a,b,c){if("undefined"===typeof a||"undefined"===
typeof b)return!1;$.ajax({type:"POST",url:"/admin/products/"+g("products")[b].id+"/metafields.json",dataType:"json",data:a,success:function(d){c&&(d=c.val(),c.val(d+b+": "+g("products")[b].id+": ok\n"));b+1<g("products").length?D(a,b+1,c):("products"==g("alpha")&&r(),f("Bulk changes done!"))}})},z=function(a,b){"undefined"===typeof b&&(b=[location.protocol,"//",location.host,location.pathname].join(""));var c="/metafields.json",d=K(b),e=d[0],d=d[1];"undefined"===typeof a||isNaN(a)||(c="/metafields/"+
a+".json");return"general"===d?"/admin"+c:b=[location.protocol,"//",location.host,"/admin/",e,"/",d,c].join("")},da=function(){var a=$(ba),b=a.find("a.create"),c=a.find("a.createint"),d=a.find("#bulk_namespace"),e=a.find("#bulk_key"),h=a.find("#bulk_value"),l=a.find("textarea.debug"),k=function(){return 1<d.val().length&&1<e.val().length&&1<h.val().length?!0:!1};b.off("click").on("click",function(){if(k){var a={metafield:{namespace:d.val(),key:e.val(),value:h.val(),value_type:"string"}};D(a,0,l)}else f("No empty fields allowed")});
c.off("click").on("click",function(){if(k)if(isNaN(h.val()))f("Value not an integer",!0);else{l.val(g("products"));var a={metafield:{namespace:d.val(),key:e.val(),value:h.val(),value_type:"integer"}};D(a,0,l)}else f("No empty fields allowed",!0)});$.ajax({type:"GET",url:"/admin/products.json?limit=250&fields=id,title",dataType:"json",success:function(b){b.products&&(b.products.length?(g("products",b.products),u(!0,a,"Bulk Metafield editing (for "+b.products.length+" products)",!0)):f("No products found",
!0))},error:function(a){f("Error getting products",!0)}})},t=function(a,b){var c=z()+"?limit=250";$.getJSON(c,function(b){var c="",h=g("datalistNamespace")||["global","test","theme"],l=g("datalistKey")||[];if(b=b.metafields){g("m",b);g("hasbackup",!1);$("#restorebackup").hide();"products"!==g("alpha")&&"collections"!==g("alpha")&&"pages"!==g("alpha")||fa();var k=$("#metacount");k.text(b.length).removeClass("hide");0===b.length&&k.addClass("hide");for(var k=0,q=b.length;k<q;k++)c+='<option data-type="'+
b[k].value_type+'" data-id="'+b[k].id+'">'+b[k].namespace+"."+b[k].key+"</option>",n.metafields[b[k].id]={namespace:b[k].namespace,value:b[k].value,key:b[k].key},"backups"==b[k].namespace&&!1===g("hasbackup")&&($("#restorebackup").show(),g("hasbackup",!0),N()),"seo"===b[k].namespace&&"hidden"===b[k].key&&1===b[k].value&&E(b[k].id),h.push(b[k].namespace),l.push(b[k].key);h=F(h);l=F(l);g("datalistNamespace",h);g("datalistKey",l);c='<select id="metafieldselect" class="ssb">'+y+c+"</select>"}else c='<select id="metafieldselect" class="ssb">'+
y+"</select>";a.html(c).append(Y);for(k=0;k<h.length;k++)c=$("<option />",{value:h[k]}),$("#fd-dl-namespace").append(c);for(k=0;k<l.length;k++)c=$("<option />",{value:l[k]}),$("#fd-dl-key").append(c);$("#advanced_meta_features").off("click").on("click",function(){$("#advanced_meta").eq(0).toggleClass("hide");return!1});$("#adv_clear_cache").off("click").on("click",function(){$("#advanced_meta").find("select").remove().end().find("a").show();g("products",!1);g("collections",!1);return!1});$("#adv_get_products").off("click").on("click",
...
e=0,h=b.collections.length;e<h;e++)c+='<option value="'+b.collections[e].handle+'">'+b.collections[e].title+"</option>";d.append(c);a.after(d).hide()}},error:function(){f("Failed to load collections",!0)}});return!1});$("#metafieldselect").change(function(){var a=$(this).find(":selected");if(a.attr("data-id")){var b=n.metafields[a.attr("data-id")];$(".metafield-next-label").text(m.edit_metafield);$("#metafield_namespace").val(b.namespace).prop("disabled",!0);$("#metafield_key").val(b.key).prop("disabled",
!0);$("#metafield_value").val(b.value);$("#metafield_id").val(a.attr("data-id"));$("#shopifyjs_deletemetafield").removeClass("hide")}else Q()});$("#shopifyjs_deletemetafield").on("click",function(a){a.preventDefault();a=$("#metafield_id").val()||!1;if(!a)return f("Object ID Missing",!0),!1;a=z(a);-1<a.indexOf("?show_all_images")||-1<a.indexOf("products.json")||$.ajax({type:"DELETE",url:a,success:function(a){f(m.metafield_deleted);r()},error:function(a){f("Failed to delete",!0)}})});$(".metafield-content a.savemymeta").off("click").on("click",
function(){var a="string";$(this).hasClass("int")&&(a="integer");var b=$("#metafield_namespace").val(),c=$("#metafield_key").val(),d=$("#metafield_value").val(),e=$("#metafield_id").val(),b={metafield:{namespace:b,key:c,value:d,value_type:a}},a={metafield:{id:e,value:d,value_type:a}};5<e.length?(e=z(e),$.ajax({type:"PUT",url:e,dataType:"json",data:a,success:function(a){r();v(a);f("Metafield updated")}})):(e=z(),$.ajax({type:"POST",url:e,dataType:"json",data:b,success:function(a){r();f("Metafield saved")},
error:function(a){a=JSON.parse(a.responseText);var b="";a.errors.namespace&&(b+="Namespace "+C(a.errors.namespace[0])+". ");a.errors.key&&(b+="Key "+C(a.errors.key[0])+". ");a.errors.value&&(b+="Value "+C(a.errors.value[0])+". ");f("Metafield failed to save: "+b,!0)}}));return!1})})},ga=function(){var a=$("iframe:first").contents().find("#tinymce:first");if(!a.length)return!1;var b=["href","target","class","src"];a.find("*").each(function(a,d){for(a=d.attributes.length-1;0<=a;a--)0>b.indexOf(d.attributes[a].name)&&
d.removeAttribute(d.attributes[a].name)})},Q=function(){$(".metafield-next-label").text(m.add_new_metafield);$("#metafield_namespace").val("").prop("disabled",!1);$("#metafield_key").val("").prop("disabled",!1);$("#metafield_value").val("");$("#metafield_id").val("");$("#shopifyjs_deletemetafield").addClass("hide")},G=function(a){var b=document.getElementsByClassName("view-json-endpoint");if(b.length){var c=document.getElementsByClassName("view-json-endpoint-link");"undefined"!==typeof a?(b[0].classList.remove("hidden"),
c[0].href=["//",location.host,location.pathname].join("")+".json"):(b[0].classList.add("hidden"),c[0].href="")}},ia=function(){if(function(){var a=document.createElement("div");return"draggable"in a||"ondragstart"in a&&"ondrop"in a}()){v("has dnd");var a=document.documentElement;a.ondragover=function(){this.className="dragit";return!1};a.ondragleave=function(){this.className="";return!1};a.ondragend=function(){this.className="";return!1};a.ondrop=function(a){a.preventDefault&&a.preventDefault();var c=
a.dataTransfer.files,d=c.length,e=0,h=new FileReader,l={};h.onload=function(a){v("load");a=a.target.result.split(",")[1];l[e]={name:c[e].name,data:a};e++;e<d?(f("Reading file ["+(e+1)+"] contents..."),h.readAsDataURL(c[e])):ha(l)};d&&(document.documentElement.className="dragit",f("Reading file ["+(e+1)+"] contents..."),h.readAsDataURL(c[e]));return!1}}},ha=function(a){var b=n.data.themeId;if(!b||isNaN(b))return f("Theme ID not found",!0),!1;var c=Object.keys(a).length,d=0;"themes"==g("alpha")&&(b=
g("omega"));"settings"!=g("omega")||isNaN(g("alpha"))||(b=g("alpha"));var e=function(){$.ajax({type:"PUT",url:"/admin/themes/"+b+"/assets.json",data:{asset:{key:"assets/"+a[d].name,attachment:a[d].data}},success:function(){f(a[d].name+" uploaded ("+(d+1)+"/"+c+")");d++;d<c&&e()},error:function(){f("File upload failed",!0)}})};e()},R=function(a,b,c){if("undefined"===typeof a)return!1;f("Updating Variant "+(b+1)+"/"+a.length+"...");"undefined"===typeof b&&(b=0);"undefined"===typeof c&&(c=!1);$.ajax({type:"PUT",
url:"/admin/variants/"+a[b].variant.id,dataType:"json",data:a[b],success:function(d){++b;b<a.length?R(a,b,c):(f("Variants updated"),"function"===typeof c&&c())},error:function(){f("Update failed",!0)}})},S=function(a,b,c,d,e,h){h="undefined"!==typeof h?"integer":"string";var l="post",k="/admin/variants/"+a+"/metafields.json";b={metafield:{namespace:b,key:c,value:d,value_type:h}};if(e.length){if(isNaN(e))return!1;b={metafield:{id:e,value:d,value_type:h}};k="/admin/variants/"+a+"/metafields/"+e+".json";
l="put"}$.ajax({type:l,url:k,data:b,success:function(b){v(b);x(a);f("Metafield saved")},error:function(b){x(a);f("Error Saving",!0)}})},ja=function(a,b){var c="/admin/variants/"+a+"/metafields/"+b+".json";if(-1<c.indexOf("?")||-1<c.indexOf("products.json"))return!1;$.ajax({type:"DELETE",url:c,success:function(b){v(b);x(a);f(m.metafield_deleted)},error:function(b){x(a);f("Failed to delete",!0)}})},x=function(a){if("undefined"===typeof a||isNaN(a)||!a)return f("Could not find ID",!0),!1;$("#mv_namespace").val("").prop("disabled",
...
function(){g("current_vid")||g("current_vid","");S(a,$("#mv_namespace").val(),$("#mv_key").val(),$("#mv_value").val(),g("current_vid"));return!1});$("#vrow .saveinteger").off("click").on("click",function(){g("current_vid")||g("current_vid","");S(a,$("#mv_namespace").val(),$("#mv_key").val(),$("#mv_value").val(),g("current_vid"),!0);return!1});$("#vrow .delete").addClass("hidden").off("click").on("click",function(){ja(a,g("current_vid"));return!1});$("#vrow select").eq(0).off("change").change(function(){var a=
$(this).val();g("current_vid",a);v(g("vm"));if(a.length){$("#mv_namespace").prop("disabled",!0);$("#mv_key").prop("disabled",!0);$("#vrow .delete").removeClass("hidden");a:{for(var b,c=0,d=g("vm").length;c<d;c++)if(b=g("vm")[c],parseInt(b.id)==parseInt(a)){a=b;break a}a=!1}a&&($("#mv_namespace").val(a.namespace),$("#mv_key").val(a.key),$("#mv_value").val(a.value))}else $("#mv_namespace").val("").prop("disabled",!1),$("#mv_key").val("").prop("disabled",!1),$("#mv_value").val(""),$("#vrow .delete").addClass("hidden")});
$("#vrow .mybuttons").fadeIn()},error:function(a){f("Error grabbing metafields",!0)}});window.dispatchEvent(new Event("resize"))},ka=function(){$("td.vid input").on("change",function(){var a=$(this);a.val(a.attr("data-val"))}).on("click",function(){$(this).select()});var a=$(".edit-variant-metafield");a.on("click",function(b){b.preventDefault();$("#vrow").remove();a.removeClass("active");var c=$(this);if(c.hasClass("active"))return!0;c.addClass("active");b=c.attr("data-val");g("currentvrow",b);$("tr.variant.active").removeClass("active");
var c=c.parent().parent().parent(),d=c.find("td").length+1;c.addClass("active").after('<tr id="vrow"><td colspan="'+d+'">'+J+"</td></tr>");x(b)})},la=function(a){if("product"!==a||null!==document.getElementById("removealltags"))return!0;a=$("ul.js-tag-list").eq(0).parent();a.length?(a.append('<a style="margin-top:.75em" id="removealltags" href="#" class="fd-btn btn delete">Remove all tags</a>'),$("#removealltags").on("click",function(a){a.preventDefault();$("ul.next-token-list").eq(0).find("a").click()})):
f("ShopifyFD error : btn_removealltags : target html not found",!0)},v=function(a){g("debug")&&console.log(a)},u=function(a,b,c,d){v("fdmodal");var e=$("#fdmodal");if(a){e.length&&e.remove();a=$('<div id="fdmodal" class="modalWindow"><div class="main content"><header></header></div></div>');c&&a.find("header").html("<h2>"+c+"</h2>");b&&(b=$("<div/>",{}).append(b),a.find("div.main.content").append(b));if(d)d=$('<a href="#" class="close-modal">&times;</a>'),d.on("click",function(){u(!1);return!1}),
a.find("header").prepend(d).end().fadeIn();else a.fadeIn().on("click",function(){u(!1)});$("body").append(a)}else e.off("click").remove()},ma=function(){var a=$(".header .header__secondary-actions:first");if(!a.length)return f("ShopifyFD error : setup_discounts : target html not found",!0),!1;var b=$("<ul/>",{"class":"segmented",id:"discount_buttons"}),c=$("<li/>"),d=$("<a/>",{"class":"btn btn-separate disabled",href:"#"}).html("Bulk create").on("click",function(a){a.preventDefault()});c.append(d);
b.append(c);a.prepend(b)},na=function(){var a=$(".ui-layout__section--secondary .ui-layout__item:last"),b=$(".header .header__secondary-actions:first");b.length||(b=$(".header .header__primary-actions:first"));if(a.length){var c=$('<div class="ui-layout__item"><div class="next-card"></div></div>');c.find(".next-card").append('<div class="next-card-metafield next-card next-card--aside fadein"><section class="next-card__section"><h3 class="next-heading">Metafields <span id="metacount" class="hide">0</span></h3><div class="metafield-content content"><i class="ico ico-20 ico-20-loading"></i></div></section></div>');
...
data:{article:{author:a.article.author,blog_id:a.article.blog_id,body_html:a.article.body_html,summary_html:a.article.summary_html,tags:a.article.tags,template_suffix:a.article.template_suffix,title:a.article.title+" [copy]",published:!1}},success:function(a){p("/admin/blogs/"+a.article.blog_id+"/articles/"+a.article.id)},error:function(a){f("Error saving",!0)}})})});c.append(d);a.append(c);b.prepend(a)}else f("ShopifyFD error : setup_articles : Header button missing",!0);0===$("#rte_extra").length&&
...
B())},N=function(){$("#restorebackup").show().on("click",function(a){a.preventDefault();a:{g("omega");a=$("iframe").contents().find("#tinymce").eq(0);var b=g("m");if(b)for(var c=0,d=b.length;c<d;c++){if("backups"===b[c].namespace){a.html(b[c].value);f("Backup restored");break a}}else f("Error, nothing to restore",!0)}})},B=function(){var a=$("#restorebackup");a.length&&(g("hasbackup")?N():a.hide());$("#clearformatting").on("click",function(a){a.preventDefault();a=$("iframe:first").contents().find("#tinymce:first");
if(a.length){var c=document.createElement("div");c.innerHTML=a.html();a.text(c.textContent||c.innerText||"")}});$("#clear-html-attributes").on("click",function(a){a.preventDefault();ga()});$("#createbackup").on("click",function(a){a.preventDefault();M(g("omega"))});$("#save_images_to_meta").on("click",function(a){a.preventDefault();oa()})},oa=function(){var a=$("iframe:first").contents().find("#tinymce:first").find("img");if(a&&a.length){var b="";a.each(function(c){var d=$(this).prop("src").replace(/https:/i,
"");b+=d;c<a.length-1&&(b+=",")});var c={metafield:{namespace:"helpers",key:"images",value:b,value_type:"string"}},d=[location.protocol,"//",location.host,location.pathname,"/metafields.json"].join("");"articles"===g("alpha")&&(d="/admin/articles/"+g("omega")+"/metafields.json");$.ajax({type:"POST",url:d,dataType:"json",data:c,success:function(a){r();f("Images saved to metafield")},error:function(a){f("Error saving",!0)}})}else f("No images found",!0)},F=function(a){a=a.concat();for(var b=0;b<a.length;++b)for(var c=
...
a.append(b)))},ra=function(){var a=$(".header .header__primary-actions:first");if(!a.length)return!1;$.ajax({type:"GET",url:"/admin/link_lists.json",dataType:"json",success:function(b){if(b){b=b.link_lists;for(var c="",d=0,e=b.length;d<e;d++)g("omega")!==b[d].id.toString()&&(c+='<option value="'+b[d].id+'">'+b[d].title+"</option>");b=$("<select />",{"class":"header-select fadein"}).append("<option>Edit other Menu</option>",c).change(function(){var a=$(this).val();a&&p("/admin/link_lists/"+a)});a.prepend(b)}},
error:function(a){f("Error loading linklist data",!0)}})},U=function(){var a=$(".next-card__section .next-grid__cell--no-flex"),b=function(){$.ajax({type:"GET",url:"/admin/collections.json?limit=250",dataType:"json",success:function(a){for(var b=$.param({utf8:"\u2713","link_list[handle]":"all-collections","link_list[title]":"All Collections"}),c=[],d=0,h=a.collections.length;d<h;++d){c.push({position:d+1,title:a.collections[d].title,link_type:"collection",subject_id:a.collections[d].id});var f={};
f["link_list[links][][position]"]=d+1;f["link_list[links][][title]"]=a.collections[d].title;f["link_list[links][][link_type]"]="collection";f["link_list[links][][subject_id]"]=a.collections[d].id;b+="&"+$.param(f)}e(b)},error:function(){f("Error! Are you sure you have access to collections?",!0)}});return!1},c=function(){$.ajax({type:"GET",url:"/admin/pages.json?limit=250",dataType:"json",success:function(a){for(var b=$.param({utf8:"\u2713","link_list[handle]":"all-pages","link_list[title]":"All Pages"}),
c=[],d=0,f=a.pages.length;d<f;++d){c.push({position:d+1,title:a.pages[d].title,link_type:"page",subject_id:a.pages[d].id});var h={};h["link_list[links][][position]"]=d+1;h["link_list[links][][title]"]=a.pages[d].title;h["link_list[links][][link_type]"]="page";h["link_list[links][][subject_id]"]=a.pages[d].id;b+="&"+$.param(h)}e(b)},error:function(){f("Error! Are you sure you have access to pages?",!0)}});return!1},d=function(){$.ajax({type:"GET",url:"/admin/products/vendors.json",dataType:"json",
success:function(a){for(var b=$.param({utf8:"\u2713","link_list[handle]":"all-vendors","link_list[title]":"All Vendors"}),d=[],c=0,h=a.vendors.length;c<h;++c){var f={position:c+1,title:a.vendors[c],link_type:"http",subject:"/collections/vendors?q="+encodeURIComponent(a.vendors[c].toLowerCase()).replace(/%20/g,"+")},l={};l["link_list[links][][position]"]=c+1;l["link_list[links][][title]"]=a.vendors[c];l["link_list[links][][link_type]"]="http";l["link_list[links][][subject]"]="/collections/vendors?q="+
encodeURIComponent(a.vendors[c].toLowerCase()).replace(/%20/g,"+");b+="&"+$.param(l);d.push(f)}e(b)}})},e=function(a){"undefined"!==typeof a&&$.ajax({type:"POST",url:"/admin/link_lists",data:a,success:function(a,b,c){(b=c.getResponseHeader("X-XHR-Redirected-To"))?(linklistID=b.split("/").pop(),isNaN(linklistID)?f("Error creating linklist - ID not returned",!0):(f("Link list added"),p("/admin/link_lists/"+linklistID))):(linklistID=$(a).find("form").eq(0).attr("action").split("/").pop(),isNaN(linklistID)||
(f("Link list added"),p("/admin/link_lists/"+linklistID)))},error:function(){f("Error creating linklist",!0)}})},h=$("<a/>",{href:"#","class":"tooltip-bottom tooltip",style:"margin-right:1.5em"}).html('<span class="tooltip-container"><span class="tooltip-label">Make a copy of this linklist</span></span>Duplicate').on("click",function(a){a.preventDefault();var b=$(this);a=b.parent().find('a[href^="/admin/link_lists"]').eq(0);a.length?(b.addClass("btn is-loading no-btn"),href=a.attr("href").split("/").pop(),
...
dataType:"json",success:function(b){b&&(g("link_lists",b),a.each(function(a){$(this).parent().find("h3").append('<span class="fadein" style="color:#ccc;display: block;font-size: 11px;font-family: monospace;">'+b.link_lists[a].handle+"</span>")}))}})):a.prepend(h);var h=$(".ui-annotated-section__description").eq(0),l=$("<a/>",{"class":"btn tooltip-bottom tooltip fd-btn sst",href:"#"}).html('<span class="tooltip-container"><span class="tooltip-label">Create a menu with every collection</span></span>Create Collections menu').on("click",
function(){$(this).addClass("is-loading disabled");b();return!1}),k=$("<a/>",{"class":"btn tooltip-bottom tooltip fd-btn sst",href:"#"}).html('<span class="tooltip-container"><span class="tooltip-label">Create a menu with every page</span></span>Create Pages menu').on("click",function(){$(this).addClass("is-loading disabled");c();return!1}),q=$("<a/>",{"class":"btn tooltip-bottom tooltip fd-btn sst",href:"#"}).html('<span class="tooltip-container"><span class="tooltip-label">Create a menu with all vendors</span></span>Create Vendor menu').on("click",
function(){$(this).addClass("is-loading disabled");d();return!1});h.length&&h.append("<br>",l,"<br>",k,"<br>",q);h=$('.ui-annotated-section__description a[href="/admin/link_lists/new"]');if(h.length&&(l=$("#link_lists .next-grid--no-outside-padding a:last-child"),l.length)){var w="";2<l.length&&(l.each(function(){var a=$(this),b=a.parent().parent().find("h3").text(),a=a.attr("href");b.length&&a.length&&(w+='<option value="'+a+'">'+b+"</option>")}),w.length&&(l=$("<select />",{style:"width: 100%"}).on("change",
function(){var a=$(this).val();a.length&&p(a)}).html('<option value="">Select Menu</option>'+w),k=$("<div />",{"class":"sst"}),k.append('<label class="next-label">Select a menu to quickly edit.</label>',l),h.after(k)))}},H=function(a){if("undefined"!==typeof a&&a.length){var b=a[0];if("object"===typeof b){var c=$('textarea[name="bulk-redirect-log"]'),d=c.val();$.ajax({type:"POST",url:"/admin/redirects.json",dataType:"json",data:b,success:function(b){d+=b.redirect.path+", "+b.redirect.target+", success\n";
c.val(d);a.shift();0<a.length?H(a):f("Bulk redirection additions complete")},error:function(e){d+=b.redirect.path+", "+b.redirect.target+", "+e.responseJSON.errors.path[0]+"\n";c.val(d);a.shift();0<a.length?H(a):f("Bulk redirection additions complete")}})}}},sa=function(){if(!document.getElementsByClassName("bulk-redirect-panel").length){$(".header .header__secondary-actions:first");var a=$(".next-card.has-bulk-actions");a.length||(a=$("#url_redirects"));if(!a.length)return f("Could not add bulk redirect panel",
...
c=b.find(".redirect-process"),d=b.find(".redirect-reload"),e=b.find('textarea[name="bulk-redirect-paste"]'),h=b.find('textarea[name="bulk-redirect-log"]');d.on("click",function(a){a.preventDefault();p("/admin/redirects?"+Math.floor(1E6*Math.random()))});c.on("click",function(a){a.preventDefault();a=e.val().replace(/ /g,"");if(!(4>a.length)&&(a=a.split("\n"),a.length)){for(var b=[],c=0;c<a.length;c++){var d=a[c].split(",");2===d.length&&(d[0]=d[0].trim(),d[1]=d[1].trim(),"/"!==d[1].substring(0,1)&&
...
"Edit tags for all products in a collection",!0);var a=$("#fdmodal"),b=a.find('select[data-action="action"]'),c=a.find("a").eq(1),d=a.find('select[data-action="collection"]'),e=a.find("input").eq(0);b.change(function(a){"purge"==b.val()||"set"==b.val()?("purge"==b.val()&&e.val("").attr("disabled","disabled"),c.addClass("delete")):(e.removeAttr("disabled"),c.removeClass("delete"))});var A=function(a,b,d,e){var f=a.products[b].id,h={product:{id:f,tags:d}};c.text(b+1+"/"+a.products.length);$.ajax({type:"PUT",
url:"/admin/products/"+f+".json",data:h,dataType:"json",success:function(c){++b;b<a.products.length?A(a,b,d,e):"function"===typeof e&&e()}})},m=function(a,b,d,e){if(a.products[b].tags){var f=d.replace(/, /g,",").split(","),h=a.products[b].tags.replace(/, /g,",").split(","),h=$(h).not(f).get()+"",f=a.products[b].id,h={product:{id:f,tags:h}};c.text(b+1+"/"+a.products.length);$.ajax({type:"PUT",url:"/admin/products/"+f+".json",data:h,dataType:"json",success:function(c){++b;b<a.products.length?m(a,b,
d,e):"function"===typeof e&&e()}})}else++b,b<a.products.length?m(a,b,d,e):"function"===typeof e&&e()},O=function(a,b,d,e){var f=d.replace(/, /g,",").split(","),h=a.products[b].tags.split(","),h=F(f.concat(h))+"",f=a.products[b].id,h={product:{id:f,tags:h}};c.text(b+1+"/"+a.products.length);$.ajax({type:"PUT",url:"/admin/products/"+f+".json",data:h,dataType:"json",success:function(c){++b;b<a.products.length?O(a,b,d,e):e()}})};c.on("click",function(){d.val().length?("add"===b.val()&&e.val().length&&
$.ajax({type:"GET",url:"/admin/products.json?collection_id="+d.val()+"&fields=id,tags",dataType:"json",success:function(a){c.addClass("disabled");O(a,0,e.val(),function(){f("Done. Tags have been added");c.text("Update tags").removeClass("disabled")})}}),"purge"!==b.val()&&"set"!==b.val()||$.ajax({type:"GET",url:"/admin/products.json?collection_id="+d.val()+"&fields=id",dataType:"json",success:function(a){c.addClass("disabled");A(a,0,e.val(),function(){f("Done.");c.text("Update tags").removeClass("disabled")})}}),
"remove"===b.val()&&$.ajax({type:"GET",url:"/admin/products.json?collection_id="+d.val()+"&fields=id,tags",dataType:"json",success:function(a){c.addClass("disabled");m(a,0,e.val(),function(){f("Matched tags have been removed.");c.text("Update tags").removeClass("disabled")})}})):f("Choose a collection",!0);return!1});b.hide();$.ajax({type:"GET",url:"/admin/collections.json?limit=250",dataType:"json",success:function(a){if(a.collections.length){g("collections",a);for(var c="",e=0,f=a.collections.length;e<
f;e++)c+='<option value="'+a.collections[e].id+'">'+a.collections[e].title+"</option>";d.append(c).find("option:eq(0)").text("Select a collection");b.show()}}});return!1});c.append(e,d);b.append(c);a.prepend(b)}else f("ShopifyFD error : setup_collections : target html not found")},fa=function(){var a;try{a="localStorage"in window&&null!==window.localStorage}catch(d){a=!1}if(a){a=$('<div class="metafield-copy-paste sst"><a class="fd-btn btn btn-slim" id="fd_copymetafields">Copy All Metafields</a> <a class="fd-btn btn btn-slim" id="fd_pastemetafields">Paste Metafields</a> <a class="btn btn-slim tooltip tooltip-bottom" href="#" id="fd_whatmetafields"><span class="tooltip-container"><span class="tooltip-label">View what is in the clipboard</span></span>?</a></div>');
var b=a.find("#fd_pastemetafields"),c=a.find("#fd_whatmetafields");a.find("#fd_copymetafields").on("click",function(a){a.preventDefault();"undefined"!==typeof g("m")?0<g("m").length?(localStorage.metafieldCopy=JSON.stringify(g("m")),f(g("m").length+" Metafields copied"),b.show(),c.show()):f("No metafields to copy",!0):(b.hide(),c.hide())});c.on("click",function(a){a.preventDefault();if("undefined"!==typeof localStorage.metafieldCopy){a="";var b=!1;try{b=JSON.parse(localStorage.metafieldCopy)}catch(c){return!1}if(b){for(var f=
0,g=b.length;f<g;f++){var k=b[f].value,q=document.createElement("div");q.innerHTML=k;a+="<p><strong>"+b[f].namespace+"."+b[f].key+" ("+b[f].value_type+")</strong><br>"+(q.textContent||q.innerText)+"</p><hr>"}u(!0,a,"In the virtual clipboard...")}}});b.on("click",function(a){a.preventDefault();"undefined"!==typeof localStorage.metafieldCopy?(a=JSON.parse(localStorage.metafieldCopy),a.length?(g("m-copy",a),V(g("m-copy"),0)):f("Nothing to paste",!0)):f("Nothing to paste",!0)});"undefined"===typeof localStorage.metafieldCopy&&
(b.hide(),c.hide());$(".metafield-content").after(a)}},V=function(a,b){if("undefined"===typeof a||"undefined"===typeof b)return!1;f("Pasting metafields...");var c={metafield:{namespace:a[b].namespace,key:a[b].key,value:a[b].value,value_type:a[b].value_type}};$.ajax({type:"POST",url:[location.protocol,"//",location.host,location.pathname,"/metafields.json"].join(""),dataType:"json",data:c,success:function(c){b+1<a.length?V(a,++b):(r(),f("All metafields pasted!"))}})},ua=function(a,b){if("undefined"===
...
(c+='<option value="'+a[e].id+'">'+a[e].title+"</option>");a=$("<select />",{"class":"product-switcher header-select fadein"}).append("<option>Edit other Product</option>",c).change(function(){var a=$(this).val();a&&p("/admin/products/"+a)});a.find("option").sort(L).appendTo(a);b.prepend(a)}},error:function(a){f("Error loading linklist data",!0)}});a=$("#js-collections");if(a.length){var c=a.find(".list-of-added-collections a");if(c.length){var d=$("<a />",{"class":"btn fd-btn delete"}).text("Remove from all").on("click",
...
if(!document.getElementsByClassName("remove-all-images").length){var h=$("<a />",{"class":"btn delete tooltip tooltip-bottom"}).html('Remove all images<span class="tooltip-container"><span class="tooltip-label">Instant, and no undo</span></span>').on("click",function(a){a.preventDefault();$(this);a=window.location.pathname.split("/").pop();ua(a)});e.append(h)}a.after(d)}document.getElementsByClassName("seo-hide-button").length||(a=$(".next-card.visibility .next-card__section:first"),a.length&&(d=
$("<a />",{"class":"btn fd-btn seo-hide-button"}).text(m.hide_from_sitemap).on("click",function(a){a.preventDefault();(a=$(this).attr("data-id"))?$.ajax({type:"DELETE",url:["//",location.host,location.pathname].join("")+"/metafields/"+a+".json",success:function(a){r()},error:function(a){f("Failed to delete",!0)}}):$.ajax({type:"POST",url:["//",location.host,location.pathname].join("")+"/metafields.json",dataType:"json",data:{metafield:{namespace:"seo",key:"hidden",value:1,value_type:"integer"}},success:function(a){r()},
...
a.removeClass("is-loading").text(m.save))}})};a.addClass("is-loading").text("");e(0,d)}else f("Did you set a weight?",!0);return!1});return!1});d.append(n);$('tr.variant input[type="checkbox"]').on("change",function(){1<$('tr.variant input[type="checkbox"]:checked').length?n.removeClass("hide"):n.addClass("hide")})}a.length&&"object"===typeof l&&1<Object.keys(l).length&&a.find("header a.btn--plain:last").after(q)},wa=function(){var a=$(".ui-layout__section--secondary .ui-layout__item:last");if(a.length){a.find("a").eq(0).clone(!0);
...
a[Object.keys(a)[0]].id;"undefined"!==b&&p("/admin/collections/"+b)}catch(c){}},error:function(){f("Error duplicating.",!0)}});else{var e=0,g=window.location.pathname.split("/").pop(),m=function(a,d,e,h){"undefined"!==typeof a&&"undefined"!==typeof d&&("undefined"===typeof e&&(e=1),"undefined"===typeof h&&(h=[]),f("Duplicating collection, please wait..."),$.ajax({type:"GET",url:"/admin/collects.json?limit=250&fields=product_id&page="+e+"&collection_id="+a,success:function(g){h=h.concat(g.collects);
250*e>d?(b.custom_collection.collects=h,$.ajax({type:"POST",url:c,contentType:"application/json;charset=utf-8",data:JSON.stringify(b),success:function(a){try{var b=a[Object.keys(a)[0]].id;"undefined"!==b&&p("/admin/collections/"+b)}catch(c){}},error:function(){f("Error duplicating.",!0)}})):m(a,d,++e,h)}}))};(function(){$.ajax({type:"GET",url:"/admin/collects/count.json?collection_id="+g,success:function(a){e=a.count;0<e&&m(g,e,1)}})})()}})});c.append(d);a.append(c);b.prepend(a)}else f("ShopifyFD error : setup_articles : Header button missing",
!0)},za=function(){var a=$(".header .header__primary-actions:first > div");if(a.length){var b=$("<ul/>",{"class":"segmented",id:"get_all_images"}),c=$("<li/>"),d=$("<a/>",{"class":"btn",href:"#",style:"margin-left:1em"}).html("Download file list").on("click",function(){var a=$(this);(function(){var b=[];a.addClass("is-loading").attr("style","margin-left:1em;text-indent: -9999px;");var c=function(d){"undefined"===typeof d&&(d="/admin/settings/files");$.ajax({url:d,success:function(d){d=$(d);for(var g=
...
k=window.URL.createObjectURL(k),g.href=k,g.download=d,g.click(),window.URL.revokeObjectURL(k)):f("No files exist. Nothing to list.",!0))}})};c()})();return!1});c.append(d);b.append(c);a.prepend(b)}},Aa=function(){var a=$(".ui-layout__section--secondary .ui-layout__item:last");if(a.length){var b=$('<div class="ui-layout__item"><div class="next-card"></div></div>');b.find(".next-card").append('<div class="next-card-metafield next-card next-card--aside fadein"><section class="next-card__section"><h3 class="next-heading">Metafields <span id="metacount" class="hide">0</span></h3><div class="metafield-content content"><i class="ico ico-20 ico-20-loading"></i></div></section></div>');
...
m="",n=0,p=f.length;n<p;n++)m+='<li style="white-space:normal">'+f[n].quantity+" &times; "+f[n].name+"</li>";e.order.fulfillment_status&&g.length&&(m+='<li style="white-space:normal;border-top: 1px solid #ccc;margin-top: .5em;padding-top: .5em;">Tracking#: <b>'+g[0].tracking_number+"</b></li>");a.data("order",m);b.html(m);a.find("div.bubble").removeClass("hide")}}})},100)},function(){clearTimeout(b);$(this).find("div.bubble").addClass("hide")})},E=function(a){"undefined"!==typeof a?$(".seo-hide-button").addClass("active").attr("data-id",
a).text("Hidden in Sitemap"):$(".seo-hide-button").removeClass("active").removeAttr("data-id").text(m.hide_from_sitemap)},r=function(){var a=z();$.getJSON(a,function(a){var c="";a=a.metafields;E();if(a.length){g("m",a);$("#metacount").text(a.length).removeClass("hide");for(var d=0,e=a.length;d<e;d++)c+='<option data-type="'+a[d].value_type+'" data-id="'+a[d].id+'">'+a[d].namespace+"."+a[d].key+"</option>",n.metafields[a[d].id]={namespace:a[d].namespace,value:a[d].value,key:a[d].key},"backups"===a[d].namespace&&
$("#restorebackup").show(),"seo"===a[d].namespace&&"hidden"===a[d].key&&1===a[d].value&&E(a[d].id);c=y+c}else $("#metacount").text("0").addClass("hide"),g("m",!1),$("#restorebackup").hide(),c=y;$("#metafieldselect").html(c);Q()})};(function(){document.getElementsByTagName("html")[0].className+=" shopifyJSoverride";ia();ca();var a=document.querySelectorAll('a[href="/admin/products"]');a.length&&(a[0].href="/admin/products?limit=250");a=document.querySelectorAll('a[href="'+[location.protocol,"//",location.host].join("")+
'/admin/apps"]');a.length&&(a[0].href="/admin/apps/installed");setInterval(function(){n.cache.content=document.getElementById("content");if(!n.cache.content.classList.contains("loading")){ea();var a=K(),c=!1,d=a[0],e=a[1],a=a[2];"next"===e||"prev"===e||d===g("alpha")&&e===g("omega")?"next"!==e&&"prev"!==e&&a!=n.queryString&&("products"!==d||isNaN(e)?"admin"===d&&"products"===e?c=!0:"admin"===d&&"redirects"===e&&(c=!0):c=!0):c=!0;if(c)if(n.alpha=d,n.omega=e,n.queryString=a,"customers"===d&&!isNaN(e))c=
$(".ui-layout__section--secondary .ui-layout__item:last"),c.length?(d=$('<div class="ui-layout__item"><div class="next-card"></div></div>'),d.find(".next-card").append('<div class="next-card-metafield next-card next-card--aside fadein"><section class="next-card__section"><h3 class="next-heading">Metafields <span id="metacount" class="hide">0</span></h3><div class="metafield-content content"><i class="ico ico-20 ico-20-loading"></i></div></section></div>'),c.after(d),c=$("div.metafield-content"),t(c)):
...
c=$("div.metafield-content"),t(c)):f("ShopifyFD error : setup_blogs : target html not found",!0);else if("collections"===d&&!isNaN(e))ya();else if("link_lists"===d&&!isNaN(e))ra();else if("orders"===d&&!isNaN(e))Aa();else if("pages"===d&&!isNaN(e))wa();else if("products"===d&&!isNaN(e))va();else if("variants"===d&&!isNaN(e))G(!0),c=$(".next-layout__sidebar > div:first"),c.length&&(c.after('<div class="next-card-metafield next-card next-card--aside fadein"><section class="next-card__section"><h3 class="next-heading">Metafields <span id="metacount" class="hide">0</span></h3><div class="metafield-content content"><i class="ico ico-20 ico-20-loading"></i></div></section></div>'),
t($("div.metafield-content")));else if("admin"!==d||"apps"!==e)if("admin"!==d||"channels"!==e)if("admin"===d&&"collections"===e)ta();else if("admin"===d&&"discounts"===e)ma();else if("admin"!==d||"draft_orders"!==e)if("admin"===d&&"link_lists"===e)U();else if("admin"===d&&"links"===e)U();else if("admin"===d&&"orders"===e)Ba();else if("admin"===d&&"products"===e)pa();else if("admin"===d&&"redirects"===e)sa();else if("admin"!==d||"reports"!==e)if("admin"===d&&"themes"===e)qa();else if("admin"!==d||
