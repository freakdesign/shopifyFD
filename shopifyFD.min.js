...
x='<option value="">'+p.select_or_create_metafield+"</option>",K='<div class="vbox fadein"><fieldset><select>'+x+'</select><input id="mv_namespace" placeholder="namespace" /><input id="mv_key" placeholder="key" /><input id="mv_value" placeholder="value" /></fieldset><span class="mybuttons"><a class="save btn btn-slim" href="#">'+p.save+'</a> <a class="btn btn-slim saveinteger" href="#">'+p.save+' as Integer</a> <a title="'+p["delete"]+'" class="btn-slim delete hidden" href="#">'+p["delete"]+"</a></span></div>",
Y='<div class="vbox-single-card next-card"><div class="next-card__section"><h2 class="next-heading--quarter-margin">Variant Metafields</h2><div id="vrow" class="single-variant">'+K+"</div></div></div>",A=function(a){"undefined"===typeof a&&(a=[location.protocol,"//",location.host,location.pathname].join(""));var c=a.split("/");a=c[c.length-2];c=c.pop();return[a,c,location.search.substring(1)]},D=function(a){return a.replace(/[\\]/g,"\\\\").replace(/[\"]/g,'\\"').replace(/[\/]/g,"\\/").replace(/[\b]/g,
"\\b").replace(/[\f]/g,"\\f").replace(/[\n]/g,"\\n").replace(/[\r]/g,"\\r").replace(/[\t]/g,"\\t")},r=function(a){if("undefined"!==typeof a&&"function"===typeof Turbolinks)try{Turbolinks.visit(a)}catch(c){return!1}},Z=function(a,c){return a.getAttribute("value")?c.getAttribute("value")?a.innerHTML>c.innerHTML?1:-1:1:-1},L=function(){try{return"localStorage"in window&&null!==window.localStorage}catch(a){return!1}},f=function(a,c){"function"===typeof Shopify.Flash.error&&"function"===typeof Shopify.Flash.notice&&
(c?Shopify.Flash.error(a):Shopify.Flash.notice(a))},h=function(a,c){if("undefined"===typeof c)return k[a];k[a]=c},aa=function(){"undefined"===typeof k.data.themeId&&$.ajax({type:"GET",url:"/admin/themes.json",success:function(a){if(a){k.data.themes=a.themes;for(var c=0,b=a.themes.length;c<b;c++)"main"===a.themes[c].role&&(k.data.themeId=a.themes[c].id)}}})},M=function(a,c){if("undefined"===typeof a||!a)return!1;var b=$("iframe:first").contents().find("#tinymce:first");if(!b.length)return!1;b=b.html();
...
"products"!==h("alpha")&&"collections"!==h("alpha")&&"pages"!==h("alpha")||ba();var g=$("#metacount");g.text(b.length).removeClass("hide");0===b.length&&g.addClass("hide");g=0;for(var n=b.length;g<n;g++)c+='<option data-type="'+b[g].value_type+'" data-id="'+b[g].id+'">'+b[g].namespace+"."+b[g].key+"</option>",k.metafields[b[g].id]={namespace:b[g].namespace,value:b[g].value,key:b[g].key},"backups"==b[g].namespace&&!1===h("hasbackup")&&($("#restorebackup").show(),h("hasbackup",!0),N()),"seo"===b[g].namespace&&
...
function(){$("#advanced_meta").eq(0).toggleClass("hide");return!1});$("#adv_clear_cache").off("click").on("click",function(){$("#advanced_meta").find("select").remove().end().find("a").show();h("products",!1);h("collections",!1);return!1});$("#adv_get_products").off("click").on("click",function(){var b=$(this),a=function(a){for(var c="",d=$("<select />").change(function(){var a=$(this);$("#metafield_value").val(a.val())}).html('<option value="">Add product handle as value</option>'),e=0,q=a.products.length;e<
q;e++)c+='<option value="'+a.products[e].handle+'">'+a.products[e].title+"</option>";d.append(c);b.after(d).hide()};if(h("products")){var c=h("products");a(c)}else $.ajax({type:"GET",url:"/admin/products.json?limit=250",dataType:"json",success:function(b){b.products.length&&(h("products",b),a(b))},fail:function(){f("Failed to load products",!0)}});return!1});$("#adv_get_collections").off("click").on("click",function(){var b=$(this),a=function(a){for(var c="",d=$("<select />",{}).change(function(){var a=
$(this);$("#metafield_value").val(a.val())}).html('<option value="">Add collection handle as value</option>'),e=0,q=a.collections.length;e<q;e++)c+='<option value="'+a.collections[e].handle+'">'+a.collections[e].title+"</option>";d.append(c);b.after(d).hide()};if(h("collections")){var c=h("collections");a(c)}else $.ajax({type:"GET",url:"/admin/collections.json?limit=250",dataType:"json",success:function(b){b.collections.length&&(h("collections",b),a(b))},error:function(){f("Failed to load collections",
...
a=$("#metafield_id").val()||!1;if(!a)return f("Object ID Missing",!0),!1;a=y(a);-1<a.indexOf("?show_all_images")||-1<a.indexOf("products.json")||$.ajax({type:"DELETE",url:a,success:function(a){f(p.metafield_deleted);t()},error:function(a){f("Failed to delete",!0)}})});$(".metafield-content a.savemymeta").off("click").on("click",function(){var a="string";$(this).hasClass("int")&&(a="integer");var b=$("#metafield_namespace").val(),c=$("#metafield_key").val(),d=$("#metafield_value").val();var e=$("#metafield_id").val();
...
(b+="Value "+D(a.errors.value[0])+". ");f("Metafield failed to save: "+b,!0)}}));return!1})})},ca=function(){var a=$("iframe:first").contents().find("#tinymce:first");if(!a.length)return!1;var c=["href","target","class","src"];a.find("*").each(function(a,d){for(a=d.attributes.length-1;0<=a;a--)0>c.indexOf(d.attributes[a].name)&&d.removeAttribute(d.attributes[a].name)})},P=function(){$(".metafield-next-label").text(p.add_new_metafield);$("#metafield_namespace").val("").prop("disabled",!1);$("#metafield_key").val("").prop("disabled",
!1);$("#metafield_value").val("");$("#metafield_id").val("");$("#shopifyjs_deletemetafield").addClass("hide")},H=function(a){a=document.getElementsByClassName(".action-bar__top-links".replace(".",""));if(a.length&&!document.getElementsByClassName("view-json-endpoint-link").length){var c=document.createElement("a");c.innerHTML="View JSON";c.target="_blank";c.classList.add("btn","action-bar__link","btn--link");c.href=["//",location.host,location.pathname].join("")+".json";a[0].appendChild(c)}},ea=function(){if(function(){var a=
document.createElement("div");return"draggable"in a||"ondragstart"in a&&"ondrop"in a}()){v("has dnd");var a=document.documentElement;a.ondragover=function(){this.className="dragit";return!1};a.ondragleave=function(){this.className="";return!1};a.ondragend=function(){this.className="";return!1};a.ondrop=function(a){a.preventDefault&&a.preventDefault();var b=a.dataTransfer.files,c=b.length,e=0,l=new FileReader,m={};l.onload=function(a){v("load");a=a.target.result.split(",")[1];m[e]={name:b[e].name,
data:a};e++;e<c?(f("Reading file ["+(e+1)+"] contents..."),l.readAsDataURL(b[e])):da(m)};c&&(document.documentElement.className="dragit",f("Reading file ["+(e+1)+"] contents..."),l.readAsDataURL(b[e]));return!1}}},da=function(a){var c=k.data.themeId;if(!c||isNaN(c))return f("Theme ID not found",!0),!1;var b=Object.keys(a).length,d=0;"themes"==h("alpha")&&(c=h("omega"));"settings"!=h("omega")||isNaN(h("alpha"))||(c=h("alpha"));var e=function(){$.ajax({type:"PUT",url:"/admin/themes/"+c+"/assets.json",
data:{asset:{key:"assets/"+a[d].name,attachment:a[d].data}},success:function(){f(a[d].name+" uploaded ("+(d+1)+"/"+b+")");d++;d<b?e():document.documentElement.className=""},error:function(){f("File upload failed",!0)}})};e()},Q=function(a,c,b){if("undefined"===typeof a)return!1;f("Updating Variant "+(c+1)+"/"+a.length+"...");"undefined"===typeof c&&(c=0);"undefined"===typeof b&&(b=!1);$.ajax({type:"PUT",url:"/admin/variants/"+a[c].variant.id,dataType:"json",data:a[c],success:function(d){++c;c<a.length?
Q(a,c,b):(f("Variants updated"),"function"===typeof b&&b())},error:function(){f("Update failed",!0)}})},R=function(a,c,b,d,e,l){l="undefined"!==typeof l?"integer":"string";var m="post",h="/admin/variants/"+a+"/metafields.json";c={metafield:{namespace:c,key:b,value:d,value_type:l}};if(e.length){if(isNaN(e))return!1;c={metafield:{id:e,value:d,value_type:l}};h="/admin/variants/"+a+"/metafields/"+e+".json";m="put"}$.ajax({type:m,url:h,data:c,success:function(b){v(b);w(a);f("Metafield saved")},error:function(b){w(a);
f("Error Saving",!0)}})},fa=function(a,c){var b="/admin/variants/"+a+"/metafields/"+c+".json";if(-1<b.indexOf("?")||-1<b.indexOf("products.json"))return!1;$.ajax({type:"DELETE",url:b,success:function(b){v(b);w(a);f(p.metafield_deleted)},error:function(b){w(a);f("Failed to delete",!0)}})},w=function(a){if("undefined"===typeof a||isNaN(a)||!a)return f("Could not find ID",!0),!1;$("#mv_namespace").val("").prop("disabled",!1);$("#mv_key").val("").prop("disabled",!1);$("#mv_value").val("");h("current_vid",
"");var c=function(a){return'<option class="meta" value="'+a.id+'">'+a.namespace+"."+a.key+"</option>"};$.ajax({type:"GET",url:"/admin/variants/"+a+"/metafields.json",success:function(b){$("#vrow option.meta").remove();if(b=b.metafields)h("vm",b),b.length?$("#vrow select").addClass("active"):$("#vrow select").removeClass("active");for(var d=0,e=b.length;d<e;d++)$("#vrow select").append(c(b[d]));$("#vrow .save").off("click").on("click",function(){h("current_vid")||h("current_vid","");R(a,$("#mv_namespace").val(),
$("#mv_key").val(),$("#mv_value").val(),h("current_vid"));return!1});$("#vrow .saveinteger").off("click").on("click",function(){h("current_vid")||h("current_vid","");R(a,$("#mv_namespace").val(),$("#mv_key").val(),$("#mv_value").val(),h("current_vid"),!0);return!1});$("#vrow .delete").addClass("hidden").off("click").on("click",function(){fa(a,h("current_vid"));return!1});$("#vrow select").eq(0).off("change").change(function(){var a=$(this).val();h("current_vid",a);v(h("vm"));if(a.length){$("#mv_namespace").prop("disabled",
...
!0)}});window.dispatchEvent(new Event("resize"))},ha=function(){$("td.vid input").on("change",function(){var a=$(this);a.val(a.attr("data-val"))}).on("click",function(){$(this).select()});var a=$(".edit-variant-metafield");a.on("click",function(c){c.preventDefault();var b=$(this);$("#vrow").remove();if(b.hasClass("active"))b.removeClass("active");else{a.removeClass("active");b.addClass("active");c=b.attr("data-val");h("currentvrow",c);$("tr.variant.active").removeClass("active");b=b.parent().parent().parent();
var d=b.find("td").length+1;b.addClass("active").after('<tr id="vrow"><td colspan="'+d+'">'+K+"</td></tr>");w(c)}})},ia=function(a){if("product"!==a||null!==document.getElementById("removealltags"))return!0;a=$("ul.js-tag-list").eq(0).parent();a.length?(a.append('<a style="margin-top:.75em" id="removealltags" href="#" class="fd-btn btn btn-destroy">Remove all tags</a>'),$("#removealltags").on("click",function(a){a.preventDefault();$("ul.next-token-list").eq(0).find("a").click()})):f("ShopifyFD error : btn_removealltags : target html not found",
!0)},v=function(a){h("debug")&&console.log(a)},z=function(a,c,b,d){v("fdmodal");var e=$("#fdmodal");if(a){e.length&&e.remove();a=$('<div id="fdmodal" class="modalWindow"><div class="main content"><header></header></div></div>');b&&a.find("header").html("<h2>"+b+"</h2>");c&&(c=$("<div/>",{}).append(c),a.find("div.main.content").append(c));if(d)d=$('<a href="#" class="close-modal"></a>'),d.on("click",function(){z(!1);return!1}),a.find("header").prepend(d).end().fadeIn();else a.fadeIn().on("click",function(){z(!1)});
$("body").append(a)}else e.off("click").remove()},ja=function(){var a=$(".ui-title-bar .ui-title-bar__heading-group");if(!a.length)return f("ShopifyFD error : setup_discounts : target html not found",!0),!1;var c=$("<ul/>",{"class":"segmented",id:"discount_buttons"}),b=$("<li/>"),d=$("<a/>",{"class":"btn btn-separate disabled",href:"#"}).html("Bulk create").on("click",function(a){a.preventDefault()});b.append(d);c.append(b);a.after(c)},ka=function(){var a=$(".ui-layout__section--secondary .ui-layout__item:last"),
c=$(".action-bar__top-links");if(a.length){var b=$('<div class="ui-layout__item"><div class="next-card"></div></div>');b.find(".next-card").append('<div class="next-card-metafield next-card next-card--aside fadein"><section class="next-card__section"><h3 class="next-heading">Metafields <svg class="next-icon next-icon--size-16 metafield-fullscreen-btn"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#next-website"></use></svg><span id="metacount" class="hide">0</span></h3><div class="metafield-content content"><i class="ico ico-20 ico-20-loading"></i></div></section></div>');
a.after(b);a=$("div.metafield-content");u(a)}else f("ShopifyFD error : setup_single_article : Metafield target HTML not found",!0);c.length?(a=$("<button/>",{"class":"btn action-bar__link btn--link",href:"#"}).html("Duplicate").on("click",function(a){a.preventDefault();$(this);$.getJSON(["//",location.host,location.pathname].join("")+".json",function(a){$.ajax({type:"POST",url:"/admin/blogs/"+a.article.blog_id+"/articles.json",dataType:"json",data:{article:{author:a.article.author,blog_id:a.article.blog_id,
...
C())},N=function(){$("#restorebackup").show().on("click",function(a){a.preventDefault();a:{h("omega");a=$("iframe:first").contents().find("#tinymce:first");var c=h("m");if(c)for(var b=0,d=c.length;b<d;b++){if("backups"===c[b].namespace){a.html(c[b].value);f("Backup restored");break a}}else f("Error, nothing to restore",!0)}})},C=function(){var a=$("#restorebackup");a.length&&(h("hasbackup")?N():a.hide());$("#clearformatting").on("click",function(a){a.preventDefault();a=$("iframe:first").contents().find("#tinymce:first");
if(a.length){var b=document.createElement("div");b.innerHTML=a.html();a.text(b.textContent||b.innerText||"")}});$("#clear-html-attributes").on("click",function(a){a.preventDefault();ca()});$("#createbackup").on("click",function(a){a.preventDefault();M(h("omega"))});$("#save_images_to_meta").on("click",function(a){a.preventDefault();la()});a=$("#rte-show-html");if(a.length){var c=$('<button name="" type="button" class="btn rte-tools__source-btn btn-slim fullscreen-rte-btn"><svg class="next-icon next-icon--color-slate next-icon--size-12"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#next-website"></use></svg></button>');
c.on("click",function(a){a.preventDefault();a=document.querySelectorAll('[data-context="descriptionRte"]');a.length&&a[0].classList.toggle("fullscreen-rte")});a.before(c)}},la=function(){var a=$("iframe:first").contents().find("#tinymce:first").find("img");if(a&&a.length){var c="";a.each(function(b){var d=$(this).prop("src").replace(/https:/i,"");c+=d;b<a.length-1&&(c+=",")});var b={metafield:{namespace:"helpers",key:"images",value:c,value_type:"string"}},d=[location.protocol,"//",location.host,location.pathname,
"/metafields.json"].join("");"articles"===h("alpha")&&(d="/admin/articles/"+h("omega")+"/metafields.json");$.ajax({type:"POST",url:d,dataType:"json",data:b,success:function(a){t();f("Images saved to metafield")},error:function(a){f("Error saving",!0)}})}else f("No images found",!0)},F=function(a){a=a.concat();for(var c=0;c<a.length;++c)for(var b=c+1;b<a.length;++b)a[c]===a[b]&&a.splice(b--,1);return a},S=function(){if(!document.getElementsByClassName("sku-count-cell").length){var a=$(".next-tab__container:first");
if(!a.length)return!1;var c=$("<div />",{"class":"row s-none sku-count-cell"});$.ajax({type:"GET",url:"/admin/settings/general.json",dataType:"json",success:function(b){var d=!1;try{h("shop_settings",b.shop_settings),d=b.shop_settings.total_skus,c.html(e)}catch(l){}if(d){var e='<div style="background: #e3e7ea;"class="header-notice">You are using %1 skus</div>'.replace("%1",d);c.html(e);a.before(c)}}})}},ma=function(){S();var a=$(".action-bar__top-links");if(!a.length)return f("Error : setup_products_list : html not found",
...
d=function(){$.ajax({type:"GET",url:"/admin/products/vendors.json",dataType:"json",success:function(a){for(var b=$.param({utf8:"\u2713","link_list[handle]":"all-vendors","link_list[title]":"All Vendors"}),c=[],d=0,f=a.vendors.length;d<f;++d){var q={position:d+1,title:a.vendors[d],link_type:"http",subject:"/collections/vendors?q="+encodeURIComponent(a.vendors[d].toLowerCase()).replace(/%20/g,"+")},g={};g["link_list[links][][position]"]=d+1;g["link_list[links][][title]"]=a.vendors[d];g["link_list[links][][link_type]"]=
"http";g["link_list[links][][subject]"]="/collections/vendors?q="+encodeURIComponent(a.vendors[d].toLowerCase()).replace(/%20/g,"+");b+="&"+$.param(g);c.push(q)}e(b)}})},e=function(a,b){"undefined"===typeof b&&(b=1);"undefined"!==typeof a&&$.ajax({type:"POST",url:"/admin/link_lists",data:a,success:function(a,b,c){(b=c.getResponseHeader("X-XHR-Redirected-To"))?(a=b.split("/").pop(),isNaN(a)?f("Error creating linklist - ID not returned",!0):(f("Link list added"),r("/admin/link_lists/"+a))):(a=$(a).find("form").eq(0).attr("action").split("/").pop(),
isNaN(a)||(f("Link list added"),r("/admin/link_lists/"+a)))},error:function(){f("Error creating linklist",!0)}})},l=$("<a/>",{href:"#","class":"btn btn-slim has-loading",style:"margin-right:1.5em"}).html("Copy").on("click",function(a){a.preventDefault();a=$(this);var b=a.parent().parent().find('a[href^="/admin/link_lists"]:first');if(b.length){if(a.addClass("is-loading"),b=b.attr("href").split("/").pop(),!isNaN(b)){b=parseInt(b);var c=h("link_lists");a=!1;for(var d=0;d<c.length;d++)if(b===c[d].id){a=
c[d];break}if(a){b=e;var g=g+"utf8=\u2713"+("&link_list[title]="+a.title+" [COPY]");g+="&link_list[handle]="+a.handle+"-copy";for(c=0;c<a.links.length;c++)g+="&link_list[links][][title]="+a.links[c].title,g+="&link_list[links][][link_type]="+a.links[c].link_type,g+="&link_list[links][][subject_params]="+(a.links[c].subject_params||""),g+="&link_list[links][][subject_id]="+(a.links[c].subject_id||""),g+="&link_list[links][][subject]="+a.links[c].subject;b(g)}}}else f("Can not copy this linklist. ID was not found",
...
"http"!==d[1].substring(0,4)&&(d[1]="/"+d[1]),b.push({redirect:{path:d[0],target:d[1]}}))}b.length&&(h.val("").parent().removeClass("hide"),J(b))}});a.prepend(c)}},pa=function(){S();H(!0);h("collections",!1);var a=$(".ui-title-bar .ui-title-bar__heading-group");if(a.length){var c=$("<ul/>",{"class":"segmented"}),b=$("<li/>"),d=$("<a/>",{"class":"btn fd-btn",style:"margin-left:.5em",href:"#"}).text("Show Product Count").on("click",function(a){a.preventDefault();$.ajax({type:"GET",url:"/admin/collections.json?limit=250",
...
url:"/admin/products/"+f+".json",data:g,dataType:"json",success:function(c){++b;b<a.products.length?q(a,b,d,e):"function"===typeof e&&e()}})},k=function(a,b,d,e){if(a.products[b].tags){var f=d.replace(/, /g,",").split(","),g=a.products[b].tags.replace(/, /g,",").split(",");g=$(g).not(f).get()+"";f=a.products[b].id;g={product:{id:f,tags:g}};c.text(b+1+"/"+a.products.length);$.ajax({type:"PUT",url:"/admin/products/"+f+".json",data:g,dataType:"json",success:function(c){++b;b<a.products.length?k(a,b,
d,e):"function"===typeof e&&e()}})}else++b,b<a.products.length?k(a,b,d,e):"function"===typeof e&&e()},O=function(a,b,d,e){var f=d.replace(/, /g,",").split(","),g=a.products[b].tags.split(",");g=F(f.concat(g))+"";f=a.products[b].id;g={product:{id:f,tags:g}};c.text(b+1+"/"+a.products.length);$.ajax({type:"PUT",url:"/admin/products/"+f+".json",data:g,dataType:"json",success:function(c){++b;b<a.products.length?O(a,b,d,e):e()}})};c.on("click",function(){d.val().length?("add"===b.val()&&e.val().length&&
...
f;e++)c+='<option value="'+a.collections[e].id+'">'+a.collections[e].title+"</option>";d.append(c).find("option:eq(0)").text("Select a collection");b.show()}}});return!1});b.append(e,d);c.append(b);a.after(c)}else f("ShopifyFD error : setup_collections : target html not found")},ba=function(){if(L()){var a=$('<div class="metafield-copy-paste sst"><a class="fd-btn btn btn-slim" id="fd_copymetafields">Copy All Metafields</a> <a class="fd-btn btn btn-slim" id="fd_pastemetafields">Paste Metafields</a> <a class="btn btn-slim tooltip tooltip-bottom" href="#" id="fd_whatmetafields"><span class="tooltip-container"><span class="tooltip-label">View what is in the clipboard</span></span>?</a></div>'),
...
C());var b=$(".action-bar__top-links");b.length?$.ajax({type:"GET",url:"/admin/pages.json?limit=250&fields=id,title",dataType:"json",success:function(a){if(a){a=a.pages;for(var c="",d=0,f=a.length;d<f;d++)h("omega")!==a[d].id.toString()&&(c+='<option value="'+a[d].id+'">'+a[d].title+"</option>");a=$("<select />",{id:"shopifyjs_llselect","class":"header-select"}).append("<option selected>Edit other Page</option>",c).change(function(){var a=$(this).val();a&&r("/admin/pages/"+a)});a.find("option").sort(Z).appendTo(a);
b.after(a)}},error:function(a){f("Error loading page data",!0)}}):f("ShopifyFD error : setup_pages : Page switcher target HTML not found",!0)},V=function(a){try{JSON.parse(a)}catch(c){return!1}return!0},ua=function(){var a=function(){for(var a=["price","weight"],c=0;c<a.length;c++)V(localStorage["rates_"+a[c]])&&($('button.paste-rates[data-type="'+a[c]+'"]')[0].disabled=!1)},c=function(a,c){for(var b=0;b<k.data.shipping_zones.length;b++)if(k.data.shipping_zones[b].id===parseInt(a))return"undefined"===
typeof c?k.data.shipping_zones[b]:k.data.shipping_zones[b][c+"_based_shipping_rates"];return!1};(function(a){$.ajax({type:"GET",dataType:"json",url:"/admin/settings/shipping_zones.json",success:function(b){k.data.shipping_zones=b.shipping_zones;"function"===typeof a&&a(b)},error:function(a){f("Error getting JSON rates",!0)}})})(function(b){if(L()){b=["price","weight"];for(var d={},e={},f={price:'<input type="hidden" name="shipping_zone[rates][][min_order_subtotal]" value="%min_order_subtotal%""><input type="hidden" name="shipping_zone[rates][][max_order_subtotal]" value="%max_order_subtotal%">',
...
'BasedShippingRatesViewer.hasRates()"]');c.length&&c[0].classList.add("hide");for(c=0;c<b.length;c++)e[a].append(g(b[c],a));$(".btn-remove-paste").off("click").on("click",function(a){a.preventDefault();$(this).parents(".pasted-rate").remove()});k.length&&(k[0].disabled=!1,k[0].classList.remove("disabled"))}});a()}})},va=function(){var a=$(".ui-layout__section--secondary .ui-layout__item:last"),c=$(".ui-title-bar");a.length?(a.prepend('<div class="next-card-metafield next-card next-card--aside fadein"><section class="next-card__section"><h3 class="next-heading">Metafields <svg class="next-icon next-icon--size-16 metafield-fullscreen-btn"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#next-website"></use></svg><span id="metacount" class="hide">0</span></h3><div class="metafield-content content"><i class="ico ico-20 ico-20-loading"></i></div></section></div>'),
a=$("div.metafield-content"),u(a),0===$("#rte_extra").length&&($("#collection-description_iframecontainer").eq(0).after('<div class="sst" id="rte_extra"><a class="btn btn-slim fd-btn tooltip btn-destroy tooltip-bottom" id="clearformatting" href="#"><span class="tooltip-container"><span class="tooltip-label">Will remove all HTML on click</span></span>Purge HTML</a> <a class="btn btn-slim fd-btn tooltip tooltip-bottom" id="clear-html-attributes" href="#"><span class="tooltip-container"><span class="tooltip-label">Removes HTML attributes except for <br>target,class,href & src</span></span>Clean HTML</a> <a class="btn btn-slim fd-btn tooltip tooltip-bottom" id="createbackup" href="#"><span class="tooltip-container"><span class="tooltip-label">Save contents as metafield</span></span>Backup</a> <a class="btn btn-slim fd-btn" style="display:none;" id="restorebackup" href="#">Restore Backup</a> <a class="btn btn-slim fd-btn" id="save_images_to_meta" href="#">Images to Metafields</a></div>'),
C())):f("ShopifyFD error : setup_custom_collections : target html not found",!0);if(c.length){a=$("<ul/>",{"class":"segmented",id:"copy-object"});var b=$("<li/>"),d=$("<a/>",{"class":"fd-btn btn btn-separate",href:"#"}).html("Duplicate").on("click",function(a){a.preventDefault();$(this).addClass("disabled is-loading");$.getJSON(["//",location.host,location.pathname].join("")+".json",function(a){delete a.collection.disjunctive;delete a.collection.handle;delete a.collection.id;delete a.collection.products_count;
...
a[Object.keys(a)[0]].id;"undefined"!==b&&r("/admin/collections/"+b)}catch(za){}},error:function(){f("Error duplicating.",!0)}});else{var e=0,h=window.location.pathname.split("/").pop(),k=function(a,d,e,g){"undefined"!==typeof a&&"undefined"!==typeof d&&("undefined"===typeof e&&(e=1),"undefined"===typeof g&&(g=[]),f("Duplicating collection, please wait..."),$.ajax({type:"GET",url:"/admin/collects.json?limit=250&fields=product_id&page="+e+"&collection_id="+a,success:function(h){g=g.concat(h.collects);
250*e>d?(b.custom_collection.collects=g,$.ajax({type:"POST",url:c,contentType:"application/json;charset=utf-8",data:JSON.stringify(b),success:function(a){try{var b=a[Object.keys(a)[0]].id;"undefined"!==b&&r("/admin/collections/"+b)}catch(Aa){}},error:function(){f("Error duplicating.",!0)}})):k(a,d,++e,g)}}))};(function(){$.ajax({type:"GET",url:"/admin/collects/count.json?collection_id="+h,success:function(a){e=a.count;0<e&&k(h,e,1)}})})()}})});b.append(d);a.append(b);c.prepend(a)}else f("ShopifyFD error : setup_single_article : Header button missing",
!0)},wa=function(){var a=$(".ui-title-bar .ui-title-bar__heading-group");if(a.length){var c=$("<ul/>",{"class":"segmented",id:"get_all_images"}),b=$("<li/>"),d=$("<a/>",{"class":"btn",href:"#",style:"margin-left:1em"}).html("Download file list").on("click",function(){var a=$(this);(function(){var b=[];a.addClass("is-loading").attr("style","margin-left:1em;text-indent: -9999px;");var c=function(d){"undefined"===typeof d&&(d="/admin/settings/files");$.ajax({url:d,success:function(d){d=$(d);for(var e=
...
100)},function(){clearTimeout(c);$(this).find("div.bubble").addClass("hide")})},E=function(a){"undefined"!==typeof a?$(".seo-hide-button").addClass("active").attr("data-id",a).text("Show in Sitemap"):$(".seo-hide-button").removeClass("active").removeAttr("data-id").text(p.hide_from_sitemap)},t=function(){var a=y();$.getJSON(a,function(a){var b="";a=a.metafields;E();if(a.length){h("m",a);$("#metacount").text(a.length).removeClass("hide");for(var c=0,e=a.length;c<e;c++)b+='<option data-type="'+a[c].value_type+
'" data-id="'+a[c].id+'">'+a[c].namespace+"."+a[c].key+"</option>",k.metafields[a[c].id]={namespace:a[c].namespace,value:a[c].value,key:a[c].key},"backups"===a[c].namespace&&$("#restorebackup").show(),"seo"===a[c].namespace&&"hidden"===a[c].key&&1===a[c].value&&E(a[c].id);b=x+b}else $("#metacount").text("0").addClass("hide"),h("m",!1),$("#restorebackup").hide(),b=x;$("#metafieldselect").html(b);P()})},ya=function(){if(!$("#toggleBigMode").length){var a=$(".ui-app-frame__main");if(a.length){var c=
$("<a/>",{id:"toggleBigMode",title:"Toggle navigation"}).on("click",function(){$("body").toggleClass("big-view");return!1});c[0].innerHTML="&lt;";a.append(c)}}};(function(){document.getElementsByTagName("html")[0].className+=" shopifyfd-loaded";ea();aa();var a=document.querySelectorAll('a[href="/admin/products"]');a.length&&(a[0].href="/admin/products?limit=250");a=document.querySelectorAll('a[href="'+[location.protocol,"//",location.host].join("")+'/admin/apps"]');a.length&&(a[0].href="/admin/apps/installed");
setInterval(function(){k.cache.content=document.getElementById("content");if(!k.cache.content.classList.contains("loading")){ya();if(!document.getElementById("shopifyfdnav")){var a=document.querySelectorAll(".ui-nav .ui-nav__group")[0];if(a){var b=document.createElement("div");b.innerHTML='<ul id="shopifyfdnav" class="fadein ui-nav__group ui-nav__group--parent"><li class="ui-nav__item ui-nav__item--parent"><a href="https://freakdesign.com.au/pages/shopifyfd" target="_blank" class="ui-nav__link ui-nav__link--parent" style="color: #21c2a8;"><svg class="next-icon next-icon--size-20 next-icon--no-nudge" style="fill:#27c3aa"> <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#next-settings"></use> </svg><span class="ui-nav__label ui-nav__label--parent">ShopifyFD</span></a></li></ul>';
a.parentNode.insertBefore(b,a.nextSibling)}}var d=A();a=!1;b=d[0];var e=d[1];d=d[2];"next"===e||"prev"===e||b===h("alpha")&&e===h("omega")?"next"!==e&&"prev"!==e&&d!=k.queryString&&("products"!==b||isNaN(e)?"admin"===b&&"products"===e?a=!0:"admin"===b&&"redirects"===e&&(a=!0):a=!0):a=!0;if(a)if(k.alpha=b,k.omega=e,k.queryString=d,"customers"===b&&!isNaN(e))a=$(".ui-layout__section--secondary .ui-layout__item:last"),a.length?(b=$('<div class="ui-layout__item"><div class="next-card"></div></div>'),
b.find(".next-card").append('<div class="next-card-metafield next-card next-card--aside fadein"><section class="next-card__section"><h3 class="next-heading">Metafields <svg class="next-icon next-icon--size-16 metafield-fullscreen-btn"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#next-website"></use></svg><span id="metacount" class="hide">0</span></h3><div class="metafield-content content"><i class="ico ico-20 ico-20-loading"></i></div></section></div>'),a.after(b),a=$("div.metafield-content"),
u(a)):f("ShopifyFD error : setup_customers : target HTML not found");else if("articles"===b&&!isNaN(e))ka();else if("blogs"===b&&!isNaN(e))targetHTML=$(".ui-layout__section--secondary .ui-layout__item:last"),targetHTML.length?(targetHTML.prepend('<div class="next-card-metafield next-card next-card--aside fadein"><section class="next-card__section"><h3 class="next-heading">Metafields <svg class="next-icon next-icon--size-16 metafield-fullscreen-btn"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#next-website"></use></svg><span id="metacount" class="hide">0</span></h3><div class="metafield-content content"><i class="ico ico-20 ico-20-loading"></i></div></section></div>'),
a=$("div.metafield-content"),u(a)):f("ShopifyFD error : setup_blogs : target html not found",!0);else if("collections"===b&&!isNaN(e))va();else if("menus"===b&&!isNaN(e))na();else if("orders"===b&&!isNaN(e))W();else if("draft_orders"===b&&!isNaN(e))W("drafts");else if("pages"===b&&!isNaN(e))ta();else if("products"===b&&!isNaN(e))sa();else if("variants"===b&&!isNaN(e))H(!0),a=$("#variant-edit-card"),a.length&&(a.after('<div class="next-card-metafield next-card next-card--aside fadein"><section class="next-card__section"><h3 class="next-heading">Metafields <svg class="next-icon next-icon--size-16 metafield-fullscreen-btn"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#next-website"></use></svg><span id="metacount" class="hide">0</span></h3><div class="metafield-content content"><i class="ico ico-20 ico-20-loading"></i></div></section></div>'),
u($("div.metafield-content")));else if(!("admin"===b&&"articles"===e||"admin"===b&&"apps"===e||"admin"===b&&"bulk"===e||"admin"===b&&"channels"===e))if("admin"===b&&"collections"===e)pa();else if("admin"===b&&"discounts"===e)ja();else if("admin"!==b||"draft_orders"!==e)if("admin"!==b||"gift_cards"!==e)if("admin"===b&&"menus"===e)I();else if("admin"===b&&"links"===e)I();else if("admin"===b&&"link_lists"===e)I();else if("admin"===b&&"orders"===e)xa();else if("admin"===b&&"products"===e)ma();else if("admin"===
b&&"redirects"===e)oa();else if("admin"!==b||"reports"!==e)if("admin"===b&&"themes"===e)T();else if("admin"!==b||"transfers"!==e)if("online_store"!==b||"preferences"!==e)"settings"===b&&"account"===e?$(".ui-annotated-section:last").after('<section class="ui-annotated-section"><div class="ui-annotated-section__annotation"><div class="ui-annotated-section__title"><h2 class="next-heading next-heading--no-margin">Purge / Delete all site content</h2></div><div class="ui-annotated-section__description"><p>Delete all content on the store to start fresh</p></div></div><div class="ui-annotated-section__content"><div class="next-card"><div class="next-card__section"><p>Coming soon...</p></div></div></div></section>'):
"settings"===b&&"files"===e?wa():"settings"===b&&"general"===e?(a=$("#settings-general section:first"),a.length&&(b=$("<section />",{"class":"ui-annotated-section"}),e=$("<div>",{"class":"ui-annotated-section__annotation"}),d=$("<div>",{"class":"ui-annotated-section__content"}),e.html('<div class="ui-annotated-section__title"><h2 class="next-heading next-heading--no-margin">Store Metafields</h2></div><div class="ui-annotated-section__description"><p>Edit your shop level metafields here. Review the <a target="_blank" href="http://docs.shopify.com/themes/liquid-documentation/objects/metafield">Shopify documentation</a> for more info on Metafields.</p></div>'),
