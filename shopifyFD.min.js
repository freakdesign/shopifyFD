...
'">'+c.collections[e].title+"</option>";f.append(d);a.after(f).hide()}else $.ajax({type:"GET",url:"/admin/collections.json?limit=250",dataType:"json",success:function(c){if(c.collections.length){b.data("collections",c);for(var d="",e=$("<select />",{}).change(function(){var b=$(this);$("#metafield_value").val(b.val())}).html('<option value="">Add collection handle as value</option>'),f=0,u=c.collections.length;f<u;f++)d+='<option value="'+c.collections[f].handle+'">'+c.collections[f].title+"</option>";
e.append(d);a.after(e).hide()}},fail:function(){b.notice("Failed to load collections",!0)}});return!1});$("#metafieldselect").change(function(){var a=$(this).find(":selected");if(a.attr("data-id")){var d=c.metafields[a.attr("data-id")];a.attr("data-type");$("#metafield_namespace").val(d.namespace).prop("disabled",!0);$("#metafield_key").val(d.key).prop("disabled",!0);$("#metafield_value").val(d.value);$("#metafield_id").val(a.attr("data-id"));$("#shopifyjs_deletemetafield").removeClass("hidden")}else b.clearmetaform()});
...
c=a.find("a.create"),d=a.find("a.createint");a.find("a.update");a.find("a.delete");var e=a.find("#bulk_namespace"),f=a.find("#bulk_key"),h=a.find("#bulk_value"),g=a.find("textarea.debug"),n=function(){return 1<e.val().length&&1<f.val().length&&1<h.val().length?!0:!1};c.off("click").on("click",function(){if(n){var a={metafield:{namespace:e.val(),key:f.val(),value:h.val(),value_type:"string"}};b.bulk_save_metafield_queue(a,0,g)}else b.notice("No empty fields allowed")});d.off("click").on("click",function(){if(n)if(isNaN(h.val()))b.notice("Value not an integer",
...
!0);document.documentElement.className=""}})};f()}else b.notice("Theme ID not found",!0)}},save_variant_metafield:function(a,c,d,e,f,h){b.flog(a,c,d,e,f,h);var g="string";h&&(g="integer");f.length?(c={metafield:{id:f,value:e,value_type:g}},$.ajax({type:"PUT",url:"/admin/variants/"+a+"/metafields/"+f+".json",data:c,success:function(c){b.flog(c);b.setup_vrow(a);b.notice("Metafield updated")},error:function(c){b.setup_vrow(a);b.notice("Error saving",!0)}})):(c={metafield:{namespace:c,key:d,value:e,value_type:g}},
$.ajax({type:"POST",url:"/admin/variants/"+a+"/metafields.json",data:c,success:function(c){b.flog(c);b.setup_vrow(a);b.notice("Metafield saved")},error:function(c){b.setup_vrow(a);b.notice("Error Saving",!0)}}))},delete_variant_metafield:function(a,c){$.ajax({type:"DELETE",url:"/admin/variants/"+a+"/metafields/"+c+".json",success:function(c){b.flog(c);b.setup_vrow(a);b.notice("Metafield deleted")},error:function(c){b.setup_vrow(a);b.notice("Failed to delete",!0)}})},variant_fillfields:function(a){for(var c=
0,d=b.data("vm").length;c<d;c++)if(o=b.data("vm")[c],parseInt(o.id)==parseInt(a))return o;return!1},setup_vrow:function(a){$("#mv_namespace").val("").prop("disabled",!1);$("#mv_key").val("").prop("disabled",!1);$("#mv_value").val("");b.data("current_vid","");var c=function(b){return'<option class="meta" value="'+b.id+'">'+b.namespace+"."+b.key+"</option>"};a?$.ajax({type:"GET",url:"/admin/variants/"+a+"/metafields.json",success:function(d){$("#vrow option.meta").remove();if(m=d.metafields)b.data("vm",
m),m.length?$("#vrow select").addClass("active"):$("#vrow select").removeClass("active");d=0;for(var e=m.length;d<e;d++)$("#vrow select").append(c(m[d]));$("#vrow .delete").hide();$("#vrow .save").off("click").on("click",function(){b.data("current_vid")||b.data("current_vid","");b.save_variant_metafield(a,$("#mv_namespace").val(),$("#mv_key").val(),$("#mv_value").val(),b.data("current_vid"));return!1});$("#vrow .saveinteger").off("click").on("click",function(){b.data("current_vid")||b.data("current_vid",
"");b.save_variant_metafield(a,$("#mv_namespace").val(),$("#mv_key").val(),$("#mv_value").val(),b.data("current_vid"),!0);return!1});$("#vrow .delete").off("click").on("click",function(){b.delete_variant_metafield(a,b.data("current_vid"));return!1});$("#vrow select").eq(0).off("change").change(function(){var a=$(this).val();b.data("current_vid",a);b.flog(b.data("vm"));if(a.length){if($("#mv_namespace").prop("disabled",!0),$("#mv_key").prop("disabled",!0),$("#vrow .delete").show(),a=b.variant_fillfields(a))$("#mv_namespace").val(a.namespace),
$("#mv_key").val(a.key),$("#mv_value").val(a.value)}else $("#mv_namespace").prop("disabled",!1),$("#mv_key").prop("disabled",!1),$("#vrow .delete").hide()});$("#vrow .mybuttons").fadeIn()},error:function(a){b.notice("Error grabbing metafields",!0)}}):b.notice("Could not find ID",!0)},panel_editvariantmeta:function(){$(".row.section.inventory .section-summary p").eq(0).after('<p class="box notice">To edit metafields for the variant click in the variant ID number field.</p>');var a=$("td.vid input");
a.on("change",function(){var b=$(this);b.val(b.attr("data-val"))});a.on("click",function(){$("#vrow").remove();var a=$(this),d=a.attr("data-val");a.select();b.flog(d);b.data("currentvrow",d);$("tr.variant.active").removeClass("active");a=a.parent().parent();tp_td=a.find("td").length+1;a.addClass("active").after('<tr id="vrow"><td colspan="'+tp_td+'"><div class="vbox"><fieldset><select><option value="">Select or create a metafield</option></select><input id="mv_namespace" placeholder="namespace" /><input id="mv_key" placeholder="key" /><input id="mv_value" placeholder="value" /></fieldset><span class="mybuttons"><a class="save btn btn-slim" href="#">Save</a> <a class="btn btn-slim saveinteger" href="#">Save as Integer</a> <a title="Delete" class="delete ico ico-16 ico-delete" href="#">delete</a></span></div></td></tr>');
...
b.setup_rte())},get_files:function(a,c){var d=$("#settings-general table");b.notice("Loading files...");$.ajax({type:"GET",url:"/admin/files.json?limit=50&direction=next&page="+a,success:function(a,f,h){if(a){$("");f=0;for(h=a.files.length;f<h;f++){var g=$("<tr />",{"class":"file_row"}),n=$("<td />"),l=$("<td />"),k=$("<td />"),s=$("<td />",{"class":"tr"}),p=$("<td />"),v=$("<a />",{href:"#","data-src":a.files[f].public_url.replace("http:","")});if(-1<a.files[f].content_type.indexOf("image")){v.on("click",
function(){var a=$(this);b.fd_modal(!0,'<img src="'+a.attr("data-src")+'" />',"Image Preview",!0);return!1}).text(a.files[f].key.replace("files/",""));var t=a.files[f].public_url.replace(/(\.[^\.]+)$/,"_thumb$1").replace("http:","");n.html('<img src="'+t+'" />');l.append(v);k.html('<input class="select-all-on-focus" value="'+a.files[f].public_url+'">')}else v.attr("href",a.files[f].public_url).attr("target","_blank").text(a.files[f].key.replace("files/",""));s.html(Math.floor(a.files[f].size/1024)+
" kB");g.append(n,l,k,s,p);d.append(g)}f>=c?(b.notice("All loaded"),$(".header-right .segmented").hide()):(++f,b.get_files(f,c))}}})},setup_files:function(){var a=$("<ul/>",{"class":"segmented",id:"get_all_images"}),c=$("<li/>"),d=$("<a/>",{"class":"btn",href:"#",style:"margin-left:1em"}).html("Show all files").on("click",function(){var a=$(this);a.addClass("is-loading").attr("style","margin-left:1em;text-indent: -9999px;");$.ajax({type:"GET",url:"/admin/files.json?limit=2&fields=id",success:function(c,
d,g){c&&(c=g.getResponseHeader("X-Total-Results"),50<c?(c=Math.ceil(c/50),b.get_files(2,c)):(b.notice("There are no more to load",!0),a.removeClass("is-loading").attr("style","margin-left:1em")))},error:function(){a.removeClass("is-loading").attr("style","margin-left:1em");b.notice("Error loading files",!0)}});return!1});c.append(d);a.append(c);$(".header-right .segmented").eq(0).after(a);$("div.info-message").prepend('<p class="box notice"><b>Bulk file deletion is bring considered. Is this a feature you want to see in ShopifyFD?</b></p>')},
...
init:function(){b.get_theme_data();b.data("debug")||b.readCookie("shopifyfd")||(b.flash_notification(),b.createCookie("shopifyfd","loaded",3));$("html").addClass("shopifyJSoverride");setInterval(function(){if(!b.data("content").hasClass("loading")){var a=p.URL.split("#")[0].split("?")[0].split("/"),a=a[a.length-2],c=p.URL.split("/").pop();if(a!==b.data("alpha")||c!==b.data("omega"))b.data("alpha",a),b.data("omega",c),b.flog(b.data("alpha")+","+b.data("omega")),"customers"!=b.data("alpha")||isNaN(b.data("omega"))?
