(function(){if("undefined"!==typeof Shopify)if("undefined"!==typeof jQuery)if($("#shopifyjs").length)"function"===typeof Shopify.Flash.error&&Shopify.Flash.error("Error. ShopifyFD already loaded!");else{var l=document;if(1<l.URL.indexOf("myshopify.com/admin")){var u=$("<div />",{"class":"box error animated fadein"}).html('Warning - Some ShopifyFD features do not currently work on this view. See this <a target="_blank" href="https://ecommerce.shopify.com/c/shopify-apis-and-technology/t/dashboard-endpoints-failing-link-lists-shipping-files-etc-212161">related post</a>.'),
b=function(){var n={debug:!1,drag_on:!1,alpha:!1,omega:!1,countries:!1,wait:1E3,api_count:0,api_limit:250,metafields:{},autosave:!1,content:$("#content"),body:$("body")};return{escape:function(b){return b.replace(/[\\]/g,"\\\\").replace(/[\"]/g,'\\"').replace(/[\/]/g,"\\/").replace(/[\b]/g,"\\b").replace(/[\f]/g,"\\f").replace(/[\n]/g,"\\n").replace(/[\r]/g,"\\r").replace(/[\t]/g,"\\t")},redirect:function(b){if("undefined"!==typeof b&&"object"===typeof Turbolinks)try{Turbolinks.visit(b)}catch(c){return!1}},
selectSort:function(b,c){return b.getAttribute("value")?c.getAttribute("value")?b.innerHTML>c.innerHTML?1:-1:1:-1},stripHTML:function(b){var c=document.createElement("div");c.innerHTML=b;return c.textContent||c.innerText},supportsHTML5Storage:function(){try{return"localStorage"in window&&null!==window.localStorage}catch(b){return!1}},createCookie:function(b,c,d){if(d){var e=new Date;e.setTime(e.getTime()+864E5*d);d="; expires="+e.toGMTString()}else d="";document.cookie=b+"="+c+d+"; path=/"},readCookie:function(b){b+=
...
"About this tool",!0);return!1},createbackup:function(a){if(a){var c=$("iframe").contents().find("#tinymce").html();$.ajax({type:"POST",url:l.URL+"/metafields.json",dataType:"json",data:{metafield:{namespace:"backups",key:a,value:c,value_type:"string"}},success:function(a){b.updatedropdown();b.notice("Backup saved")},error:function(a){a=JSON.parse(a.responseText);b.notice(a.errors.value[0],!0)}})}},loadmeta:function(a,c){var d="/admin/"+b.data("alpha")+"/"+b.data("omega")+"/metafields.json";"general"===
b.data("omega")&&(d="/admin/metafields.json");"articles"===b.data("alpha")&&(d="/admin/articles/"+b.data("omega")+"/metafields.json");$.getJSON(d,function(d){var f="";if(d=d.metafields){b.data("m",d);var g=b.data("datalistNamespace")||["global"],k=b.data("datalistKey")||[];"products"!==b.data("alpha")&&"collections"!==b.data("alpha")&&"pages"!==b.data("alpha")||b.setup_copypaste();var h=$("#metacount");h.text(d.length).addClass("active");0===d.length?h.removeClass("active"):h.addClass("active");for(var h=
0,r=d.length;h<r;h++)f+='<option data-type="'+d[h].value_type+'" data-id="'+d[h].id+'">'+d[h].namespace+"."+d[h].key+"</option>",c.metafields[d[h].id]={namespace:d[h].namespace,value:d[h].value,key:d[h].key},"backups"==d[h].namespace&&(b.flog("hasbackup!"),$("#restorebackup").show(),b.data("hasbackup",!0)),g.push(d[h].namespace),k.push(d[h].key);g=b.array_unique(g);k=b.array_unique(k);b.data("datalistNamespace",g);b.data("datalistKey",k);f='<select id="metafieldselect"><option value="">Select or create a metafield</option>'+
...
for(h=0;h<g.length;h++)f=$("<option />",{value:g[h]}),$("#fd-dl-namespace").append(f);for(h=0;h<k.length;h++)f=$("<option />",{value:k[h]}),$("#fd-dl-key").append(f);$("#advanced_meta_features").off("click").on("click",function(){$("#advanced_meta").eq(0).toggleClass("hidden");return!1});$("#adv_clear_cache").off("click").on("click",function(){$("#advanced_meta").find("select").remove().end().find("a").show();b.data("products",!1);b.data("collections",!1);return!1});$("#adv_get_products").off("click").on("click",
function(){var a=$(this);if(b.data("products")){for(var c=b.data("products"),d="",e=$("<select />",{}).change(function(){var b=$(this);$("#metafield_value").val(b.val())}).html('<option value="">Add product handle as value</option>'),f=0,h=c.products.length;f<h;f++)d+='<option value="'+c.products[f].handle+'">'+c.products[f].title+"</option>";e.append(d);a.after(e).hide()}else $.ajax({type:"GET",url:"/admin/products.json?limit=250",dataType:"json",success:function(c){if(c.products.length){b.data("products",
...
d="",e=$("<select />",{}).change(function(){var b=$(this);$("#metafield_value").val(b.val())}).html('<option value="">Add collection handle as value</option>'),f=0,h=c.collections.length;f<h;f++)d+='<option value="'+c.collections[f].handle+'">'+c.collections[f].title+"</option>";e.append(d);a.after(e).hide()}else $.ajax({type:"GET",url:"/admin/collections.json?limit=250",dataType:"json",success:function(c){if(c.collections.length){b.data("collections",c);for(var d="",e=$("<select />",{}).change(function(){var b=
...
c=a.find("a.create"),d=a.find("a.createint");a.find("a.update");a.find("a.delete");var e=a.find("#bulk_namespace"),f=a.find("#bulk_key"),g=a.find("#bulk_value"),k=a.find("textarea.debug"),h=function(){return 1<e.val().length&&1<f.val().length&&1<g.val().length?!0:!1};c.off("click").on("click",function(){if(h){var a={metafield:{namespace:e.val(),key:f.val(),value:g.val(),value_type:"string"}};b.bulk_save_metafield_queue(a,0,k)}else b.notice("No empty fields allowed")});d.off("click").on("click",function(){if(h)if(isNaN(g.val()))b.notice("Value not an integer",
!0);else{k.val(b.data("products"));var a={metafield:{namespace:e.val(),key:f.val(),value:g.val(),value_type:"integer"}};b.bulk_save_metafield_queue(a,0,k)}else b.notice("No empty fields allowed",!0)});$.ajax({type:"GET",url:"/admin/products.json?limit=250&fields=id,title",dataType:"json",success:function(c){c.products&&(c.products.length?(b.data("products",c.products),b.fd_modal(!0,a,"Bulk Metafield editing (for "+c.products.length+" products)",!0)):b.notice("No products found",!0))},error:function(a){b.notice("Error getting products",
...
"";return!1};a.ondragend=function(){this.className="";return!1};a.ondrop=function(a){a.preventDefault&&a.preventDefault();var d=a.dataTransfer.files,e=d.length,f=0,g=new FileReader,k={};g.onload=function(a){b.flog("load");a=a.target.result.split(",")[1];k[f]={name:d[f].name,data:a};f++;f<e?(b.notice("Reading file ["+(f+1)+"] contents..."),g.readAsDataURL(d[f])):b.do_upload(k)};e&&(document.documentElement.className="dragit",b.notice("Reading file ["+(f+1)+"] contents..."),g.readAsDataURL(d[f]));return!1}}},
...
c,d,e,f,g){b.flog(a,c,d,e,f,g);var k="string";g&&(k="integer");f.length?(c={metafield:{id:f,value:e,value_type:k}},$.ajax({type:"PUT",url:"/admin/variants/"+a+"/metafields/"+f+".json",data:c,success:function(c){b.flog(c);b.setup_vrow(a);b.notice("Metafield updated")},error:function(c){b.setup_vrow(a);b.notice("Error saving",!0)}})):(c={metafield:{namespace:c,key:d,value:e,value_type:k}},$.ajax({type:"POST",url:"/admin/variants/"+a+"/metafields.json",data:c,success:function(c){b.flog(c);b.setup_vrow(a);
...
"+")});f(a)}})},f=function(a){$.ajax({type:"POST",url:"/admin/link_lists.json",data:JSON.stringify(a),contentType:"application/json;charset=utf-8",dataType:"json",success:function(a){b.notice("Link list added");b.redirect("/admin/link_lists/"+a.link_list.id)},error:function(){b.notice("Error creating linklist",!0)}})},g=$("<a/>",{href:"#","class":"tooltip-bottom tooltip",style:"margin-right:1.5em"}).html('<span class="tooltip-container"><span class="tooltip-label">Make a copy of this linklist</span></span>Copy').on("click",
function(a){a.preventDefault();a=$(this).parent().find('a[href^="/admin/link_lists"]').eq(0);a.length?(href=a.attr("href").split("/").pop(),isNaN(href)||$.ajax({type:"GET",url:"/admin/link_lists/"+href+".json",dataType:"json",success:function(b){delete b.link_list.id;delete b.link_list["default"];b.link_list.title+=" COPY";b.link_list.handle+="-copy";f(b)},error:function(){b.notice("Error creating linklist",!0)}})):b.notice("Can not copy this linklist. ID was not found",!0)});a.prepend(g);var a=$(".section-summary").eq(0),
g=$("<a/>",{"class":"btn tooltip-bottom tooltip",style:"margin-top:2em",href:"#"}).html('<span class="tooltip-container"><span class="tooltip-label">Create a linklist with every collection</span></span>Create Collections linklist').on("click",function(){c();return!1}),k=$("<a/>",{"class":"btn tooltip-bottom tooltip",href:"#"}).html('<span class="tooltip-container"><span class="tooltip-label">Create a linklist with every page</span></span>Create Pages linklist').on("click",function(){d();return!1}),
h=$("<a/>",{"class":"btn tooltip-bottom tooltip",href:"#"}).html('<span class="tooltip-container"><span class="tooltip-label">Create a linklist with all vendors</span></span>Create Vendor linklist').on("click",function(){e();return!1});a&&a.append("<br>",g,"<br>",k,"<br>",h);$(".section.link-lists").eq(0).prepend(u)},setup_collections:function(){b.data("collections",!1);var a=$(".header-right").eq(0);if(a.length){var c=$("<ul/>",{"class":"segmented"}),d=$("<li/>"),e=$("<a/>",{"class":"btn",style:"margin-left:.5em",
...
"Edit tags for all products in a collection",!0);var a=$("#fdmodal"),c=a.find('select[data-action="action"]'),d=a.find("a").eq(1),e=a.find('select[data-action="collection"]'),f=a.find("input").eq(0);c.change(function(b){"purge"==c.val()||"set"==c.val()?("purge"==c.val()&&f.val("").attr("disabled","disabled"),d.addClass("delete")):(f.removeAttr("disabled"),d.removeClass("delete"))});var q=function(b,a,c,e){var f=b.products[a].id,g={product:{id:f,tags:c}};d.text(a+1+"/"+b.products.length);$.ajax({type:"PUT",
url:"/admin/products/"+f+".json",data:g,dataType:"json",success:function(d){++a;a<b.products.length?q(b,a,c,e):"function"===typeof e&&e()}})},v=function(b,a,c,e){if(b.products[a].tags){var f=c.replace(/, /g,",").split(","),g=b.products[a].tags.replace(/, /g,",").split(","),g=$(g).not(f).get()+"",f=b.products[a].id,g={product:{id:f,tags:g}};d.text(a+1+"/"+b.products.length);$.ajax({type:"PUT",url:"/admin/products/"+f+".json",data:g,dataType:"json",success:function(d){++a;a<b.products.length?v(b,a,
c,e):"function"===typeof e&&e()}})}else++a,a<b.products.length?v(b,a,c,e):"function"===typeof e&&e()},s=function(a,c,e,f){var g=e.replace(/, /g,",").split(","),q=a.products[c].tags.split(","),q=b.array_unique(g.concat(q))+"",g=a.products[c].id,q={product:{id:g,tags:q}};d.text(c+1+"/"+a.products.length);$.ajax({type:"PUT",url:"/admin/products/"+g+".json",data:q,dataType:"json",success:function(b){++c;c<a.products.length?s(a,c,e,f):f()}})};d.on("click",function(){e.val().length?("add"==c.val()&&f.val().length&&
$.ajax({type:"GET",url:"/admin/products.json?collection_id="+e.val()+"&fields=id,tags",dataType:"json",success:function(a){d.addClass("disabled");s(a,0,f.val(),function(){b.notice("Done. Tags have been added");d.text("Update tags").removeClass("disabled")})}}),"purge"!=c.val()&&"set"!=c.val()||$.ajax({type:"GET",url:"/admin/products.json?collection_id="+e.val()+"&fields=id",dataType:"json",success:function(a){d.addClass("disabled");q(a,0,f.val(),function(){b.notice("Done.");d.text("Update tags").removeClass("disabled")})}}),
...
setInterval(function(){a.length?a.click():(clearInterval(b.data("autosave")),a=null,b.notice("Autosave disabled"))},3E4)));$(this).toggleClass("rte-command-active");return!1}));b.btn_removealltags();var a=$("h1.header-main"),e={};a.length&&(d=$("<a />",{href:d,target:"_blank",style:"display: inline-block;vertical-align: top;",title:"View in Store"}),d.append('<i class="ico ico-20-svg ico-sidebar-bottom-website"></i>'),a.append(d));d=$(".section.inventory .section-summary").eq(0);if(d.length){var f=
d.find("a.btn"),g=$("<div />",{"class":"box notice hidden fadein",style:"margin-top: 1em;"}),k=$("<a />",{"class":"btn",style:"margin-left:1em"}).text("Bulk Edits");k.on("click",function(b){b.preventDefault();g.toggleClass("hidden")});g.html('<h3>Edit all variants</h3><p style="margin: .5em 0 1em;font-size: 12px;border-bottom: 1px solid #ccc;padding-bottom: .5em;">Bulk Editing comes with risks.</p><label style="margin-top:1.5em">Set Compare at Price<br><small>0 will clear the compare at price</small></label><input type="number" style="width:50%" value="0"> <a class="bulk-compare-save tooltip tooltip-bottom btn btn-slim"><span class="tooltip-container"><span class="tooltip-label">Save Compare at Price for all variants</span></span>Save</a>');
...
g;for(g in e){var h=e[g],k;for(k in h)h.hasOwnProperty(k)&&f.push({variant:{id:h[k],compare_at_price:d}})}f.length&&b.updateVariant(f,0,a)}else b.notice("Unexpected variant found.",!0);else b.notice("You only have 1 variant. No need to bulk edit",!0)});d.append(g)}else b.notice("ShopifyFD error : setup_products : Inventory target HTML not found",!0);$("#product-inner-variants th:last-child").length?($("#product-inner-variants th:last-child").before("<th>Variant ID</th>"),$("th.inventory.tc").text("#").prop("title",
...
d<e.length?f(d,e):(b.notice("Weight updated"),a.removeClass("is-loading").text("Save"))}})};a.addClass("is-loading").text("");f(0,e)}else b.notice("Did you set a weight?",!0);return!1});return!1});$("<span/>",{"class":"hidden"});a.append(h);$('tr.variant input[type="checkbox"]').on("change",function(){1<$('tr.variant input[type="checkbox"]:checked').length?h.removeClass("hidden"):h.addClass("hidden")})}else b.notice("ShopifyFD error : setup_products : unable to add bulk weight editor");d.length&&
"object"===typeof e&&1<Object.keys(e).length&&f.after(k)},setup_pages:function(){var a=$(".section.description .section-summary").eq(0);if(a.length){var c=a.find("a").eq(0).attr("href");a.after('<div class="sub_section-summary fadein"><h1>Metafields <span id="metacount" class="animated bounce">0</span></h1><div class="metafield-content content"><i class="ico ico-20 ico-20-loading"></i></div></div>').remove();a=$("div.metafield-content");b.loadmeta(a,n)}else b.notice("ShopifyFD error : setup_pages : Metafield target HTML not found",
...
save_new_rates:function(a,c,d){if("undefined"!==typeof a[c]){var e=a[c],f={},g=e.type,k="";delete e.type;"string"===typeof g?("weight"===g?(f={weight_based_shipping_rate:{}},f.weight_based_shipping_rate=e,k="/admin/weight_based_shipping_rates.json"):"price"===g?(f={price_based_shipping_rate:{}},f.price_based_shipping_rate=e,k="/admin/price_based_shipping_rates.json"):"carrier"===g&&(f={carrier_shipping_rate_provider:{}},f.carrier_shipping_rate_provider=e,k="/admin/carrier_shipping_rate_providers.json"),
$.ajax({type:"POST",url:k,dataType:"json",data:f,success:function(e){d.parent().parent().find("table").append('<tbody><tr style="background:#efefef"><td>'+a[c].name+"</td><td>New rate pasted.</td><td>"+a[c].price+"</td></tr></tbody>");c===a.length-1?b.notice("Paste complete"):(c++,b.save_new_rates(a,c,d))},error:function(){b.notice("Error pasting.",!0)}})):b.notice("missing type: "+g,!0)}else b.notice("save_new_rates error - length",!0)},setup_shipping:function(a){if("undefined"!==typeof a){$(".section.shipping-rates").eq(0).prepend(u);
a=$("#settings-shipping header").eq(0);if(a.length){var c=$('<div class="header-right animated fadein"><div class="header-action"><a class="btn btn-separate tooltip-bottom tooltip bulk-options" href="#"><span class="tooltip-container"><span class="tooltip-label">Show bulk delete options</span></span>Bulk Delete Options</a> <a class="btn btn-separate tooltip-bottom tooltip export-as-json" href="#"><span class="tooltip-container"><span class="tooltip-label">Export countries</span></span>Export JSON</a></div></div>');
c.find("a.export-as-json").on("click",function(a){a.preventDefault();b.fd_modal(!0,'<textarea readonly style="min-height:300px">'+JSON.stringify(b.data("countries").countries)+'</textarea><p><br><a href="/admin/countries.json" target="_blank">View original JSON object in new window</a></p>',"Export all countries",!0)});c.find("a.bulk-options").on("click",function(){var a=$('<p class="warning">This will delete ALL of your countries. There is no undo. Proceed at own risk!</p><div><div class="span1"><a href="#" class="btn delete_all delete">Delete</a></div><div class="span2"><p>The page may need to be reloaded to see the changes.</p></div></div>');
...
b.data("countries").countries.length){var d=[],e=[],f=[],g=function(a,c,d){if(c.length){var e=[];$.ajax({type:"GET",url:"/admin/countries/"+a+".json",dataType:"json",success:function(a){var f=a.country.weight_based_shipping_rates,g=a.country.price_based_shipping_rates,k=a.country.carrier_shipping_rate_providers;a=0;for(var t=f.length;a<t;a++)e.push([f[a].id,"weight"]);a=0;for(t=g.length;a<t;a++)e.push([g[a].id,"price"]);a=0;for(t=k.length;a<t;a++)e.push([k[a].id,"carrier"]);a=0;for(t=e.length;a<t;a++)f=
"","weight"===e[a][1]?f="/admin/weight_based_shipping_rates/":"price"===e[a][1]?f="/admin/price_based_shipping_rates/":"carrier"===e[a][1]&&(f="/admin/carrier_shipping_rate_providers/"),$.ajax({type:"DELETE",url:f+e[a][0]+".json",dataType:"json",success:function(b){},error:function(a){b.notice("Failed to replace rate",!0)}});b.save_new_rates(c,0,d)},fail:function(){b.notice("I failed to get the country.json",!0)}})}else b.notice("Missing items to add",!0)};$("div.shipping-rate-table").each(function(a){var c=
$(this),r=$("<a/>",{href:"#","data-country":b.data("countries").countries[a].name,"data-cid":b.data("countries").countries[a].id,"data-index":a,"class":"fadein btn btn-slim copyrates tooltip tooltip-bottom",style:"float:right;margin-right:.5em"}).html('<span class="tooltip-container"><span class="tooltip-label">Copy Rates to Memory</span></span>Copy rates').on("click",function(){var a=$(this);a.attr("data-index");var c=a.attr("data-country"),g=a.attr("data-cid");$("a.copyrates").removeClass("btn-primary");
a.addClass("btn-primary");$("a.bulkpaste").removeClass("hidden").addClass("disabled");$.ajax({type:"GET",url:"/admin/countries/"+g+".json",dataType:"json",success:function(a){d=a.country.weight_based_shipping_rates;e=a.country.price_based_shipping_rates;f=a.country.carrier_shipping_rate_providers;b.notice("Ready to paste "+c+".");$("a.bulkpaste").removeClass("disabled")},error:function(){b.notice("Error copying rates",!0)}});return!1});a=$("<a/>",{href:"#","data-country":b.data("countries").countries[a].name,
"data-cid":b.data("countries").countries[a].id,"data-index":a,"class":"hidden fadein bulkpaste btn btn-slim",style:"float:right;margin-right:.5em"}).text("Paste rates").on("click",function(){var a=$(this),b=a.attr("data-cid"),c=d,h=e,k=f,r=[],l=0;a.parent().parent().find("tbody").remove();a.parent().find("a").addClass("hidden");for(var p=0,n=c.length;p<n;p++)c[p].country_id=b,delete c[p].id,c[p].type="weight",r[l]=c[p],l++;p=0;for(n=h.length;p<n;p++)h[p].country_id=b,delete h[p].id,h[p].type="price",
r[l]=h[p],l++;p=0;for(n=k.length;p<n;p++)k[p].country_id=b,delete k[p].id,k[p].type="carrier",r[l]=k[p],l++;g(b,r,a);return!1});c=c.find('a[bind-event-click="addShippingRateModal.show()"]');if(c.length)c.after(r,a);else return b.notice("Error. Unable to add copy button.",!0),!1})}else b.notice("Mismatch in country count. Reload this page.",!0)}else b.notice("Loading current country list"),$.ajax({type:"GET",url:"/admin/countries.json",dataType:"json",success:function(a){a.countries.length&&(b.data("countries",
a),b.notice(a.countries.length+" countries loaded"),b.setup_shipping(!0))},error:function(){b.notice("Loading failed",!0)}})},setup_custom_collections:function(){var a=$("div.section.products").eq(0);a.length?(a.after('<div class="section metafields"><div class="next-grid"><div class="next-grid__cell next-grid__cell--quarter"><div class="section-summary"><h1>Metafields</h1><p>Manage the metafields that belong to this collection.</p></div></div><div class="next-grid__cell"><div class="next-card"><div class="section-content" id="collection-metafields"><div class="next-card__section"><div class="sub_section-summary fadein"><h1>Metafields <span id="metacount" class="animated bounce">0</span></h1><div class="metafield-content content"><i class="ico ico-20 ico-20-loading"></i></div></div></div></div></div></div></div></div>'),
a=$("div.metafield-content"),b.loadmeta(a,n),0===$("#rte_extra").length&&($("#collection-description_iframecontainer").eq(0).after('<div id="rte_extra"><a class="btn btn-slim tooltip tooltip-bottom" id="clearformatting" href="#"><span class="tooltip-container"><span class="tooltip-label">Careful, this method is brutal...</span></span>Purge html</a> <a class="btn btn-slim tooltip tooltip-bottom" id="createbackup" href="#"><span class="tooltip-container"><span class="tooltip-label">Save contents as metafield</span></span>Create Backup</a> <a class="btn btn-slim" style="display:none;" id="restorebackup" href="#">Restore Backup</a> <a class="btn btn-slim tooltip tooltip-bottom" id="save_images_to_meta" href="#"><span class="tooltip-container"><span class="tooltip-label">Add image paths to a metafield</span></span>Images to Metafields</a></div>'),
b.setup_rte())):b.notice("ShopifyFD error : setup_custom_collections : target html not found",!0)},get_files:function(a,c){var d=$("#settings-general table");b.notice("Loading files...");$.ajax({type:"GET",url:"/admin/files.json?limit=50&direction=next&page="+a,success:function(a,f,g){if(a){$("");f=0;for(g=a.files.length;f<g;f++){var k=$("<tr />",{"class":"file_row"}),h=$("<td />"),r=$("<td />"),l=$("<td />"),q=$("<td />",{"class":"tr"}),n=$("<td />"),s=$("<a />",{href:"#","data-src":a.files[f].public_url.replace("http:",
"")});if(-1<a.files[f].content_type.indexOf("image")){s.on("click",function(){var a=$(this);b.fd_modal(!0,'<img src="'+a.attr("data-src")+'" />',"Image Preview",!0);return!1}).text(a.files[f].key.replace("files/",""));var u=a.files[f].public_url.replace(/(\.[^\.]+)$/,"_thumb$1").replace("http:","");h.html('<img src="'+u+'" />');r.append(s);l.html('<input class="select-all-on-focus" value="'+a.files[f].public_url+'">')}else s.attr("href",a.files[f].public_url).attr("target","_blank").text(a.files[f].key.replace("files/",
""));q.html(Math.floor(a.files[f].size/1024)+" kB");k.append(h,r,l,q,n);d.append(k)}f>=c?(b.notice("All loaded"),$(".header-right .segmented").hide()):(++f,b.get_files(f,c))}}})},setup_files:function(){$("#pages-index .header-row").eq(0).after(u);var a=$(".header-row .header-right").eq(0);if(a.length){var c=$("<ul/>",{"class":"segmented",id:"get_all_images"}),d=$("<li/>"),e=$("<a/>",{"class":"btn",href:"#",style:"margin-left:1em"}).html("Show all files").on("click",function(){var a=$(this);a.addClass("is-loading").attr("style",
"margin-left:1em;text-indent: -9999px;");$.ajax({type:"GET",url:"/admin/files.json?limit=2&fields=id",success:function(c,d,e){c&&(c=e.getResponseHeader("X-Total-Results"),50<c?(c=Math.ceil(c/50),b.get_files(2,c)):(b.notice("There are no more to load",!0),a.removeClass("is-loading").attr("style","margin-left:1em")))},error:function(){a.removeClass("is-loading").attr("style","margin-left:1em");b.notice("Error loading files",!0)}});return!1});d.append(e);c.append(d);a.prepend(c)}},setup_settings_general:function(){var a=
...
c.find(".span18"),k=$("<div />",{"class":"box box-details"}),h=$("<ol />",{"class":"content-index content-index-img-icons"});$.ajax({type:"GET",url:"https://freakdesign-us.s3.amazonaws.com/shopify/shopifyFD/s/announcements.json",dataType:"json",cache:!1,xhrFields:{withCredentials:!0},crossDomain:!0,success:function(b){for(var d=0;d<b.announcements.length;d++){var l=$("<li />",{"class":"content-index__item"}).html("<small>"+b.announcements[d].date+"</small><br><strong>"+b.announcements[d].title+"</strong><p>"+
b.announcements[d].description+"</p>");h.append(l)}e.text("ShopifyFD updates");f.text("Keep up to date with the latest edits and notes.");c.removeClass("first-section").addClass("fadein");g.html("").append(k);k.append(h);a.after(c)},error:function(a,c,d){b.notice(d,!0)}})}},init:function(){b.data("drag_on")&&b.set_drag_drop();$("html").addClass("shopifyJSoverride");b.get_theme_data();setInterval(function(){b.data("content",$("#content"));if(!b.data("content").hasClass("loading")){b.add_ui();var a=
l.URL.split("#")[0].split("?")[0].split("/"),a=a[a.length-2],c=l.URL.split("/").pop();"next"===c||"prev"===c||a===b.data("alpha")&&c===b.data("omega")||(b.data("alpha",a),b.data("omega",c),b.flog(b.data("alpha")+","+b.data("omega")),"customers"!=b.data("alpha")||isNaN(b.data("omega"))?"articles"!=b.data("alpha")||isNaN(b.data("omega"))?"pages"!=b.data("alpha")||isNaN(b.data("omega"))?"smart_collections"!==b.data("alpha")||isNaN(b.data("omega"))?"custom_collections"!==b.data("alpha")||isNaN(b.data("omega"))?
