...
f=0,s=c.products.length;f<s;f++)d+='<option value="'+c.products[f].handle+'">'+c.products[f].title+"</option>";e.append(d);a.after(e).hide()}else $.ajax({type:"GET",url:"/admin/products.json?limit=250",dataType:"json",success:function(c){if(c.products.length){b.data("products",c);for(var d="",f=$("<select />",{}).change(function(){var b=$(this);$("#metafield_value").val(b.val())}).html('<option value="">Add product handle as value</option>'),e=0,p=c.products.length;e<p;e++)d+='<option value="'+c.products[e].handle+
'">'+c.products[e].title+"</option>";f.append(d);a.after(f).hide()}},fail:function(){b.notice("Failed to load products",!0)}});return!1});$("#adv_get_collections").off("click").on("click",function(){var a=$(this);if(b.data("collections")){for(var c=b.data("collections"),d="",e=$("<select />",{}).change(function(){var b=$(this);$("#metafield_value").val(b.val())}).html('<option value="">Add collection handle as value</option>'),f=0,s=c.collections.length;f<s;f++)d+='<option value="'+c.collections[f].handle+
...
url:"/admin/products/"+a[e]+".json?fields=variants",dataType:"json",success:function(l){var t=l.product.variants[0].sku;l=l.product.variants[0].id;var p="";if(t||l)t&&(p='<span title="SKU" class="sku label">'+t+"</span>"),c.eq(e).before(p+'<span title="VariantID" class="variant label">'+l+"</span>");e+1<a.length?d(a,e+1):b.fd_modal(!1)}})};b.fd_modal(!0,"Loading SKUs and Variant IDs, please wait...","Loading",!0);d(a,0)}return!1});c.append(d);a.append(c);$(".header-right .segmented").eq(1).after(a)}},
setup_themes:function(){for(var b=$(".published-theme-title"),c=$(".btn.btn-primary").eq(1).attr("href"),d=$("div.unpublished-box"),e=0;e<d.length;e++){var f=d[e].id.split("_").pop(),g=d.eq(e).find(".box-content"),f=$("<div />",{style:"color: #ccc;font-family: monospace;"}).text(f);g.append(f)}-1<c.indexOf("/admin/themes")&&(c=$("<span />",{style:"margin:0 1em;color:#479ccf;font-family: monospace;"}).text(c.split("/")[3]),b.append(c))},setup_link_lists_edit:function(){$.ajax({type:"GET",url:"/admin/link_lists.json",
dataType:"json",success:function(a){if(a){link_lists=a.link_lists;a=0;for(var c=link_lists.length;a<c;a++)b.data("omega")}},error:function(a){b.notice("Error loading linklist data",!0)}})},setup_link_lists:function(){var a=$("div.linklist-container .box-footer"),c=function(){$.ajax({type:"GET",url:"/admin/collections.json?limit=250",dataType:"json",success:function(b){for(var a={link_list:{handle:"all-collections",title:"All Collections",links:[]}},c=0,d=b.collections.length;c<d;++c)a.link_list.links.push({position:c+
1,title:b.collections[c].title,link_type:"collection",subject_id:b.collections[c].id});f(a)},error:function(){b.notice("Error! Are you sure you have access to collections?",!0)}});return!1},d=function(){$.ajax({type:"GET",url:"/admin/pages.json?limit=250",dataType:"json",success:function(b){for(var a={link_list:{handle:"all-pages",title:"All Pages",links:[]}},c=0,d=b.pages.length;c<d;++c)a.link_list.links.push({position:c+1,title:b.pages[c].title,link_type:"page",subject_id:b.pages[c].id});f(a)},
error:function(){b.notice("Error! Are you sure you have access to pages?",!0)}});return!1},e=function(){$.ajax({type:"GET",url:"/admin/products/vendors.json",dataType:"json",success:function(b){for(var a={link_list:{handle:"all-vendors",title:"All Vendors",links:[]}},c=0,d=b.vendors.length;c<d;++c)a.link_list.links.push({position:c+1,title:b.vendors[c],link_type:"http",subject:"/collections/vendors?q="+encodeURIComponent(b.vendors[c].toLowerCase()).replace(/%20/g,"+")});f(a)}})},f=function(a){$.ajax({type:"POST",
url:"/admin/link_lists.json",data:JSON.stringify(a),contentType:"application/json;charset=utf-8",dataType:"json",success:function(a){b.notice("Link list added")}})},g=$("<a/>",{href:"#","class":"btn btn-slim fr",style:"margin-right:.5em"}).text("Copy").on("click",function(){var b=$(this).parent().find('a[data-route="link_list"]').eq(0);b.length&&(href=b.attr("href").split("/").pop(),isNaN(href)||$.ajax({type:"GET",url:"/admin/link_lists/"+href+".json",dataType:"json",success:function(b){delete b.link_list.id;
delete b.link_list["default"];b.link_list.title+=" COPY";b.link_list.handle+="-copy";f(b)}}));return!1});a.append(g);var a=$(".span6.section-summary").eq(0),g=$("<a/>",{"class":"btn",href:"#",title:"Create a linklist with every collection"}).text("Create Collections linklist").on("click",function(){c();return!1}),h=$("<a/>",{"class":"btn",href:"#",title:"Create a linklist with every page"}).text("Create Pages linklist").on("click",function(){d();return!1}),r=$("<a/>",{"class":"btn",href:"#",title:"Create a linklist with all vendors"}).text("Create Vendor linklist").on("click",
function(){e();return!1}),l=$("<p/>",{"class":"box warning",style:"margin-top:1em"}).text("If you use the trash can button to remove a linklist some ShopifyFD features will not reload. Navigate away from the page, and back again.");a&&a.append("<br><br>",g,"<br><br>",h,"<br><br>",r).find("p:eq(0)").append(l)},setup_collections:function(){b.data("collections",!1);var a=$("<ul/>",{"class":"segmented"}),c=$("<li/>"),d=$("<a/>",{"class":"btn",style:"margin-left:.5em",href:"#"}).text("Show Product Count").on("click",
function(a){a.preventDefault();$.ajax({type:"GET",url:"/admin/collections.json?limit=250",dataType:"json",success:function(a){if(a.collections.length){b.data("collections",a);for(var c=a.collections.length-1;0<=c;c--){var d=$("#collections-results").find('a[href="/admin/collections/'+a.collections[c].id+'"]');0===d.find("span").length&&d.append('<span class="sku label">'+a.collections[c].products_count+"</span>")}}}})}),e=$("<a/>",{"class":"btn",href:"#",title:"Add tags to entire collection"}).html("Bulk edit tags").on("click",
...
save_metafield_queue:function(a,c){"undefined"!==typeof a&&"undefined"!==typeof c&&(b.notice("Please wait whilst we paste the metafields"),$.ajax({type:"POST",url:n.URL+"/metafields.json",dataType:"json",data:{metafield:{namespace:a[c].namespace,key:a[c].key,value:a[c].value,value_type:a[c].value_type}},success:function(d){c+1<a.length?b.save_metafield_queue(a,++c):(b.updatedropdown(),b.notice("All metafields pasted!"))}}))},setup_products:function(){clearInterval(b.data("autosave"));var a=$("div.span6.section-summary").eq(0),
...
"data-cid":b.data("countries").countries[a].id,"data-index":a,"class":"bulkpaste btn btn-slim",style:"float:right;margin-right:.5em"}).text("Paste rates").on("click",function(){var b=$(this),a=b.attr("data-cid"),c=d,h=e,l=f,r=[],k=0;b.parent().parent().find("tbody").remove();b.parent().find("a.copyrates").remove();for(var q=0,n=c.length;q<n;q++)c[q].country_id=a,delete c[q].id,c[q].type="weight",r[k]=c[q],k++;q=0;for(n=h.length;q<n;q++)h[q].country_id=a,delete h[q].id,h[q].type="price",r[k]=h[q],
k++;q=0;for(n=l.length;q<n;q++)l[q].country_id=a,delete l[q].id,l[q].type="carrier",r[k]=l[q],k++;g(a,r,b);return!1}).hide();c.find('a[data-event-click="setupNewShippingRateForm"]').after(a,l)})}else b.notice("Mismatch in country count. Reload this page.",!0)}else $.ajax({type:"GET",url:"/admin/countries.json",dataType:"json",success:function(a){a.countries.length&&(b.data("countries",a),b.notice(a.countries.length+" countries loaded"),b.setup_shipping(!0))}})},setup_custom_collections:function(){$("div.row.section.visibility").eq(0).after('<div class="row section" id="customer_meta_box"><div class="span12 section-summary"><div class="sub_section-summary fadein"><h1><strong>Metafields</strong> <span id="metacount">0</span></h1><div class="content"><i class="ico ico-20 ico-20-loading"></i></div></div></div></div>');
var a=$("div.sub_section-summary .content");b.loadmeta(a,k);0===$("#rte_extra").length&&($("#collection-description_iframecontainer").eq(0).after('<div id="rte_extra"><a class="btn btn-slim tooltip tooltip-bottom" id="clearformatting" href="#"><span class="tooltip-container"><span class="tooltip-label">Careful, this method is brutal...</span></span>Purge html</a> <a class="btn btn-slim tooltip tooltip-bottom" id="createbackup" href="#"><span class="tooltip-container"><span class="tooltip-label">Save contents as metafield</span></span>Create Backup</a> <a class="btn btn-slim" style="display:none;" id="restorebackup" href="#">Restore Backup</a> <a class="btn btn-slim tooltip tooltip-bottom" id="save_images_to_meta" href="#"><span class="tooltip-container"><span class="tooltip-label">Add image paths to a metafield</span></span>Images to Metafields</a></div>'),
b.setup_rte())},get_files:function(a,c){var d=$("#settings-general table");b.notice("Loading files...");$.ajax({type:"GET",url:"/admin/files.json?limit=50&direction=next&page="+a,success:function(a,f,g){if(a){$("");f=0;for(g=a.files.length;f<g;f++){var h=$("<tr />",{"class":"file_row"}),r=$("<td />"),l=$("<td />"),k=$("<td />"),p=$("<td />",{"class":"tr"}),n=$("<td />"),s=$("<a />",{href:"#","data-src":a.files[f].public_url.replace("http:","")});if(-1<a.files[f].content_type.indexOf("image")){s.on("click",
function(){var a=$(this);b.fd_modal(!0,'<img src="'+a.attr("data-src")+'" />',"Image Preview",!0);return!1}).text(a.files[f].key.replace("files/",""));var u=a.files[f].public_url.replace(/(\.[^\.]+)$/,"_thumb$1").replace("http:","");r.html('<img src="'+u+'" />');l.append(s);k.html('<input class="select-all-on-focus" value="'+a.files[f].public_url+'">')}else s.attr("href",a.files[f].public_url).attr("target","_blank").text(a.files[f].key.replace("files/",""));p.html(Math.floor(a.files[f].size/1024)+
" kB");h.append(r,l,k,p,n);d.append(h)}f>=c?(b.notice("All loaded"),$(".header-right .segmented").hide()):(++f,b.get_files(f,c))}}})},setup_files:function(){var a=$("<ul/>",{"class":"segmented",id:"get_all_images"}),c=$("<li/>"),d=$("<a/>",{"class":"btn",href:"#",style:"margin-left:1em"}).html("Show all files").on("click",function(){var a=$(this);a.addClass("is-loading").attr("style","margin-left:1em;text-indent: -9999px;");$.ajax({type:"GET",url:"/admin/files.json?limit=2&fields=id",success:function(c,
...
b.clearmetaform()})},load_css:function(){var a=document.createElement("link");a.type="text/css";a.rel="stylesheet";a.id="shopifyjs";a.href="//rawgithub.com/freakdesign/shopifyFD/master/shopifyFD.css";document.body.appendChild(a)},get_theme_data:function(){b.data("themeID")||$.ajax({type:"GET",url:"/admin/themes.json",success:function(a){if(a)for(var c=0,d=a.themes.length;c<d;c++)"main"===a.themes[c].role&&(b.flog(a.themes[c].id),b.data("themeID",a.themes[c].id),b.data("themeName",a.themes[c].name))}})},
init:function(){b.get_theme_data();b.data("debug")||b.readCookie("shopifyfd")||(b.flash_notification(),b.createCookie("shopifyfd","loaded",3));$("html").addClass("shopifyJSoverride");setInterval(function(){if(!b.data("content").hasClass("loading")){var a=n.URL.split("#")[0].split("?")[0].split("/"),a=a[a.length-2],c=n.URL.split("/").pop();if(a!==b.data("alpha")||c!==b.data("omega"))b.data("alpha",a),b.data("omega",c),b.flog(b.data("alpha")+","+b.data("omega")),"customers"!=b.data("alpha")||isNaN(b.data("omega"))?
"articles"!=b.data("alpha")||isNaN(b.data("omega"))?"pages"!=b.data("alpha")||isNaN(b.data("omega"))?"smart_collections"!==b.data("alpha")||isNaN(b.data("omega"))?"custom_collections"!==b.data("alpha")||isNaN(b.data("omega"))?"collections"!==b.data("alpha")||isNaN(b.data("omega"))?"blogs"!=b.data("alpha")||isNaN(b.data("omega"))?"products"==b.data("alpha")?b.setup_products():"admin"==b.data("alpha")&&"products"==b.data("omega")?b.setup_products_list():"orders"!=b.data("alpha")||isNaN(b.data("omega"))?
"admin"==b.data("alpha")&&"orders"==b.data("omega")?b.setup_orders():"admin"==b.data("alpha")&&"collections"==b.data("omega")?b.setup_collections():"admin"==b.data("alpha")&&"link_lists"==b.data("omega")?b.setup_link_lists():"admin"==b.data("alpha")&&"links"==b.data("omega")?b.setup_link_lists():"admin"==b.data("alpha")&&"themes"==b.data("omega")?b.setup_themes():"link_lists"!=b.data("alpha")||isNaN(b.data("omega"))?"admin"==b.data("alpha")&&"discounts"==b.data("omega")?b.setup_discounts():"settings"==
b.data("alpha")&&"general"==b.data("omega")?b.setup_settings_general():"settings"==b.data("alpha")&&"files"==b.data("omega")?b.setup_files():"settings"==b.data("alpha")&&"shipping"==b.data("omega")?b.setup_shipping():"settings"==b.data("alpha")&&b.data("omega"):b.setup_link_lists_edit():b.setup_single_order():b.setup_blogs():b.setup_custom_collections():b.setup_custom_collections():b.setup_custom_collections():b.setup_pages():b.setup_articles():b.setup_customers()}},b.data("wait"))},data:function(a,
b){if("undefined"===typeof b)return k[a];k[a]=b},toggleStyle:function(){$("html").toggleClass("shopifyJSoverride")},isloading:function(){return b.data("content").hasClass("loading")}}}();b.load_css();var y=$("body"),u=$("<div>",{id:"shopifyJSbar","class":"loading noprint fadein"}),x=$("<div>",{"class":"wrapper clearfix"}),v=$("<ul>",{id:"shopifyJSnav"});v.html('<li><a title="About this tool" id="aboutapp" href="javascript:void(0)">About ShopifyFD</a></li><li><a title="View recent news" id="getnotifications" href="javascript:void(0)"><i style="background-size: contain;" class="ico ico-16 ico-sidebar-bottom-announcements-inactive"></i></a></li><li><a id="togglestyle" href="javascript:void(0)">Toggle CSS</a></li>\x3c!--<li><a id="themesettings" href="javascript:void(0)">Theme Settings</a></li><li><a id="manageinventory" href="javascript:void(0)">Manage Inventory</a></li>--\x3e<li><a id="bulkmetafields" href="javascript:void(0)">Bulk Metafields</a></li><li><a href="//freakdesign-us.s3.amazonaws.com/shopify/shopifyFD/freakdesign-shopifyfd-for-shopify-guide.pdf" target="_blank">Help</a></li><li><a title="This tool is free, consider leaving a tip" href="http://shopify.freakdesign.com.au/#donate" target="_blank">Use this free tool? Tip me! ($)</a></li>');
v.find("a").on("click",function(){if(b.isloading())b.notice("We better wait for this page to load first...",!0);else{var k=$(this),a=k.prop("id");if(a)"bulkmetafields"==a?b.bulkmetafields():"togglestyle"==a?(b.toggleStyle(),k.toggleClass("active")):"aboutapp"==a?b.about_app():"getnotifications"==a&&b.show_notification();else return!0}return!1});x.append(v);u.append(x);y.append(u);u.removeClass("loading");b.notice("ShopifyFD loaded");b.init()}else alert("Error. This should be run within the Shopify Admin page.")}else alert("Error. jQuery not found.")})();