...
data:a,success:function(b){t();"undefined"===typeof c?f("Backup saved"):$("#autosave").removeClass("is-loading").addClass("active")},error:function(b){b=JSON.parse(b.responseText);f(b.errors.value[0],!0)}});return!0},y=function(b,c){"undefined"===typeof c&&(c=[location.protocol,"//",location.host,location.pathname].join(""));var a="/metafields.json",d=B(c),e=d[0];d=d[1];"undefined"===typeof b||isNaN(b)||(a="/metafields/"+b+".json");return"general"===d?"/admin"+a:c=[location.protocol,"//",location.host,
"/admin/",e,"/",d,a].join("")},u=function(b,c){var a=y()+"?limit=250",d=$("body");k.cache.fullscreenMetafield=$(".metafield-fullscreen-btn");if(k.cache.fullscreenMetafield.length)k.cache.fullscreenMetafield.on("click",function(){d.hasClass("fullscreen-metafield")?d.removeClass("fullscreen-metafield"):d.addClass("fullscreen-metafield")});$.getJSON(a,function(a){var c="",d=g("datalistNamespace")||["global","test","theme"],e=g("datalistKey")||[];if(a=a.metafields){g("m",a);g("hasbackup",!1);$("#restorebackup").hide();
...
"hidden"===a[h].key&&1===a[h].value&&F(a[h].id),d.push(a[h].namespace),e.push(a[h].key);d=G(d);e=G(e);g("datalistNamespace",d);g("datalistKey",e);c='<select id="metafieldselect" class="ssb">'+x+c+"</select>"}else c='<select id="metafieldselect" class="ssb">'+x+"</select>";b.html(c).append(X);for(h=0;h<d.length;h++)c=$("<option />",{value:d[h]}),$("#fd-dl-namespace").append(c);for(h=0;h<e.length;h++)c=$("<option />",{value:e[h]}),$("#fd-dl-key").append(c);$("#advanced_meta_features").off("click").on("click",
...
b={metafield:{namespace:b,key:c,value:d,value_type:a}};a={metafield:{id:e,value:d,value_type:a}};5<e.length?(e=y(e),$.ajax({type:"PUT",url:e,dataType:"json",data:a,success:function(a){t();v(a);f("Metafield updated")}})):(e=y(),$.ajax({type:"POST",url:e,dataType:"json",data:b,success:function(a){t();f("Metafield saved")},error:function(a){a=JSON.parse(a.responseText);var b="";a.errors.namespace&&(b+="Namespace "+E(a.errors.namespace[0])+". ");a.errors.key&&(b+="Key "+E(a.errors.key[0])+". ");a.errors.value&&
...
Q(b,c,a):(f("Variants updated"),"function"===typeof a&&a())},error:function(){f("Update failed",!0)}})},R=function(b,c,a,d,e,l){l="undefined"!==typeof l?"integer":"string";var m="post",g="/admin/variants/"+b+"/metafields.json";c={metafield:{namespace:c,key:a,value:d,value_type:l}};if(e.length){if(isNaN(e))return!1;c={metafield:{id:e,value:d,value_type:l}};g="/admin/variants/"+b+"/metafields/"+e+".json";m="put"}$.ajax({type:m,url:g,data:c,success:function(a){v(a);w(b);f("Metafield saved")},error:function(a){w(b);
f("Error Saving",!0)}})},fa=function(b,c){var a="/admin/variants/"+b+"/metafields/"+c+".json";if(-1<a.indexOf("?")||-1<a.indexOf("products.json"))return!1;$.ajax({type:"DELETE",url:a,success:function(a){v(a);w(b);f(p.metafield_deleted)},error:function(a){w(b);f("Failed to delete",!0)}})},w=function(b){if("undefined"===typeof b||isNaN(b)||!b)return f("Could not find ID",!0),!1;$("#mv_namespace").val("").prop("disabled",!1);$("#mv_key").val("").prop("disabled",!1);$("#mv_value").val("");g("current_vid",
...
var d=a.find("td").length+1;a.addClass("active").after('<tr id="vrow"><td colspan="'+d+'">'+L+"</td></tr>");w(c)}})},ia=function(b){if("product"!==b||null!==document.getElementById("removealltags"))return!0;b=$("ul.js-tag-list").eq(0).parent();b.length?(b.append('<a style="margin-top:.75em" id="removealltags" href="#" class="fd-btn btn btn-destroy">Remove all tags</a>'),$("#removealltags").on("click",function(b){b.preventDefault();$("ul.next-token-list").eq(0).find("a").click()})):f("ShopifyFD error : btn_removealltags : target html not found",
!0)},v=function(b){g("debug")&&console.log(b)},A=function(b,c,a,d){v("fdmodal");var e=$("#fdmodal");if(b){e.length&&e.remove();b=$('<div id="fdmodal" class="modalWindow"><div class="main content"><header></header></div></div>');a&&b.find("header").html("<h2>"+a+"</h2>");c&&(c=$("<div/>",{}).append(c),b.find("div.main.content").append(c));if(d)d=$('<a href="#" class="close-modal"></a>'),d.on("click",function(){A(!1);return!1}),b.find("header").prepend(d).end().fadeIn();else b.fadeIn().on("click",function(){A(!1)});
...
d,e):"function"===typeof e&&e()}})}else++b,b<a.products.length?k(a,b,d,e):"function"===typeof e&&e()},z=function(a,b,d,e){var f=d.replace(/, /g,",").split(","),h=a.products[b].tags.split(",");h=G(f.concat(h))+"";f=a.products[b].id;h={product:{id:f,tags:h}};c.text(b+1+"/"+a.products.length);$.ajax({type:"PUT",url:"/admin/products/"+f+".json",data:h,dataType:"json",success:function(c){++b;b<a.products.length?z(a,b,d,e):e()}})};c.on("click",function(){d.val().length?("add"===b.val()&&e.val().length&&
$.ajax({type:"GET",url:"/admin/products.json?collection_id="+d.val()+"&fields=id,tags",dataType:"json",success:function(a){c.addClass("disabled");z(a,0,e.val(),function(){f("Done. Tags have been added");c.text("Update tags").removeClass("disabled")})}}),"purge"!==b.val()&&"set"!==b.val()||$.ajax({type:"GET",url:"/admin/products.json?collection_id="+d.val()+"&fields=id",dataType:"json",success:function(a){c.addClass("disabled");q(a,0,e.val(),function(){f("Done.");c.text("Update tags").removeClass("disabled")})}}),
...
d=$("button.paste-rates");a.on("click",function(a){a.preventDefault();var d=$(this);a=d.data("type");d.blur();d=B();localStorage["rates_"+a]=JSON.stringify(c(d[1],a));b()});d.on("click",function(a){a.preventDefault();var b=$(this);a=b.data("type");b.blur();if(V(localStorage["rates_"+a])&&"undefined"!==typeof e[a]&&(b=JSON.parse(localStorage["rates_"+a]),b.length)){B();$('div[data-bind-show="'+a+'BasedShippingRatesViewer.hasRates()"]')[0].classList.remove("hide");var c=$('div[data-bind-show="!'+a+
...
a[Object.keys(a)[0]].id;"undefined"!==b&&r("/admin/collections/"+b)}catch(za){}},error:function(){f("Error duplicating.",!0)}});else{var e=0,g=window.location.pathname.split("/").pop(),k=function(a,d,e,h){"undefined"!==typeof a&&"undefined"!==typeof d&&("undefined"===typeof e&&(e=1),"undefined"===typeof h&&(h=[]),f("Duplicating collection, please wait..."),$.ajax({type:"GET",url:"/admin/collects.json?limit=250&fields=product_id&page="+e+"&collection_id="+a,success:function(g){h=h.concat(g.collects);
250*e>d?(b.custom_collection.collects=h,$.ajax({type:"POST",url:c,contentType:"application/json;charset=utf-8",data:JSON.stringify(b),success:function(a){try{var b=a[Object.keys(a)[0]].id;"undefined"!==b&&r("/admin/collections/"+b)}catch(Aa){}},error:function(){f("Error duplicating.",!0)}})):k(a,d,++e,h)}}))};(function(){$.ajax({type:"GET",url:"/admin/collects/count.json?collection_id="+g,success:function(a){e=a.count;0<e&&k(g,e,1)}})})()}})});a.append(d);b.append(a);c.prepend(b)}else f("ShopifyFD error : setup_single_article : Header button missing",
...
d.find(".next-input.next-input--readonly"),h=0;h<e.length;h++)b.push(e[h].value);d=d.find("#assets-table").next(".next-card__section").find("a:last");d=d.length?d[0].href:"";-1<d.indexOf("direction=next")?c(d):(a.removeClass("is-loading").removeAttr("style"),b.length?(d="files-list-"+Math.floor(Date.now()/1E3)+".txt","undefined"===typeof d&&(d="blob-"+Math.floor(Date.now()/1E3)+".txt"),e=document.createElement("a"),document.body.appendChild(e),e.style="display: none",h=new Blob(["\ufeff",b],{type:"text/plain"}),
h=window.URL.createObjectURL(h),e.href=h,e.download=d,e.click(),window.URL.revokeObjectURL(h)):f("No files exist. Nothing to list.",!0))}})};c()})();return!1});a.append(d);c.append(a);b.after(c)}},W=function(b){b=$(".ui-layout__section--secondary .ui-layout__item:last");if(b.length){var c=$('<div class="ui-layout__item"><div class="next-card"></div></div>');c.find(".next-card").append('<div class="next-card-metafield next-card next-card--aside fadein"><section class="next-card__section"><h3 class="next-heading">Metafields <svg class="next-icon next-icon--size-16 metafield-fullscreen-btn"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#next-website"></use></svg><span id="metacount" class="hide">0</span></h3><div class="metafield-content content"><i class="ico ico-20 ico-20-loading"></i></div></section></div>');
...
100)},function(){clearTimeout(c);$(this).find("div.bubble").addClass("hide")})},F=function(b){"undefined"!==typeof b?$(".seo-hide-button").addClass("active").attr("data-id",b).text("Show in Sitemap"):$(".seo-hide-button").removeClass("active").removeAttr("data-id").text(p.hide_from_sitemap)},t=function(){var b=y();$.getJSON(b,function(b){var a="";b=b.metafields;F();if(b.length){g("m",b);$("#metacount").text(b.length).removeClass("hide");for(var c=0,e=b.length;c<e;c++)a+='<option data-type="'+b[c].value_type+
'" data-id="'+b[c].id+'">'+b[c].namespace+"."+b[c].key+"</option>",k.metafields[b[c].id]={namespace:b[c].namespace,value:b[c].value,key:b[c].key},"backups"===b[c].namespace&&$("#restorebackup").show(),"seo"===b[c].namespace&&"hidden"===b[c].key&&1===b[c].value&&F(b[c].id);a=x+a}else $("#metacount").text("0").addClass("hide"),g("m",!1),$("#restorebackup").hide(),a=x;$("#metafieldselect").html(a);P()})},ya=function(){if(!$("#toggleBigMode").length){var b=$(".ui-app-frame__main");if(b.length){var c=
...
b.parentNode.insertBefore(a,b.nextSibling)}}var d=B();b=!1;a=d[0];var e=d[1];d=d[2];"next"===e||"prev"===e||a===g("alpha")&&e===g("omega")?"next"!==e&&"prev"!==e&&d!=k.queryString&&("products"!==a||isNaN(e)?"admin"===a&&"products"===e?b=!0:"admin"===a&&"redirects"===e&&(b=!0):b=!0):b=!0;if(b)if(k.alpha=a,k.omega=e,k.queryString=d,"customers"===a&&!isNaN(e))b=$(".ui-layout__section--secondary .ui-layout__item:last"),b.length?(a=$('<div class="ui-layout__item"><div class="next-card"></div></div>'),
