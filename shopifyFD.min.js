(function(){if("undefined"!==typeof Shopify)if("undefined"!==typeof jQuery)if($("#shopifyjs").length)"function"===typeof Shopify.Flash.error&&Shopify.Flash.error("Error. ShopifyFD already loaded!");else{var n=document;if(1<n.URL.indexOf("myshopify.com/admin")){var b=function(){var s={debug:!1,drag_on:!1,alpha:!1,omega:!1,countries:!1,wait:1E3,api_count:0,api_limit:250,metafields:{},autosave:!1,content:$("#content"),body:$("body")};return{escape:function(b){return b.replace(/[\\]/g,"\\\\").replace(/[\"]/g,
...
c);for(var d="",e=$("<select />",{}).change(function(){var b=$(this);$("#metafield_value").val(b.val())}).html('<option value="">Add product handle as value</option>'),f=0,r=c.products.length;f<r;f++)d+='<option value="'+c.products[f].handle+'">'+c.products[f].title+"</option>";e.append(d);a.after(e).hide()}},fail:function(){b.notice("Failed to load products",!0)}});return!1});$("#adv_get_collections").off("click").on("click",function(){var a=$(this);if(b.data("collections")){for(var c=b.data("collections"),
...
$(this);$("#metafield_value").val(b.val())}).html('<option value="">Add collection handle as value</option>'),f=0,r=c.collections.length;f<r;f++)d+='<option value="'+c.collections[f].handle+'">'+c.collections[f].title+"</option>";e.append(d);a.after(e).hide()}},error:function(){b.notice("Failed to load collections",!0)}});return!1});$("#metafieldselect").change(function(){var a=$(this).find(":selected");if(a.attr("data-id")){var d=c.metafields[a.attr("data-id")];a.attr("data-type");$("#metafield_namespace").val(d.namespace).prop("disabled",
!0);$("#metafield_key").val(d.key).prop("disabled",!0);$("#metafield_value").val(d.value);$("#metafield_id").val(a.attr("data-id"));$("#shopifyjs_deletemetafield").removeClass("hidden")}else b.clearmetaform()});$("#shopifyjs_deletemetafield").on("click",function(){var a=$("#metafield_id").val(),c=n.URL+"/metafields/"+a+".json";"general"===b.data("omega")&&(c="/admin/metafields/"+a+".json");"articles"===b.data("alpha")&&(c="/admin/articles/"+b.data("omega")+"/metafields/"+a+".json");a&&$.ajax({type:"DELETE",
...
function(a){a.preventDefault();a=$(this).parent().find('a[href^="/admin/link_lists"]').eq(0);a.length?(href=a.attr("href").split("/").pop(),isNaN(href)||$.ajax({type:"GET",url:"/admin/link_lists/"+href,success:function(b){var a=$(b).find("#edit_link_list_"+href);a.length&&(a.find('input[name="_method"]').remove(),a.find('input[name="authenticity_token"]').remove(),b=a.find('input[name="link_list[title]"]'),b.val(b.val()+" [COPY]"),a.find('select[name="link_list[links][][link_type]"]').each(function(b){var c=
...
a.find('div[context="productPicker'+b+'"]').eq(0),c=b.attr("define").split(","),"undefined"!==typeof c[2]&&(c=parseInt(c[2].replace(/\D/g,"")),b.after('<input name="link_list[links][][subject_id]" value="'+c+'" />')))}),f(a.serialize()))},error:function(a,c,d){b.notice(d,!0)}})):b.notice("Can not copy this linklist. ID was not found",!0)}),k=$("<a />",{href:"#","class":"tooltip-bottom tooltip delete",style:"margin-right:1.5em"}).html('<span class="tooltip-container"><span class="tooltip-label">Delete Linklist on click</span></span><i class="ico ico-14-svg ico-delete"></i>').on("click",
function(b){b.preventDefault();var a=$(this);b=a.parent().find('a[href^="/admin/link_lists"]').eq(0);b.length&&(href=b.attr("href").split("/").pop(),isNaN(href)||$.ajax({type:"POST",url:"/admin/link_lists/"+href,data:{utf8:"\u2713",_method:"delete"},success:function(b){a.closest(".next-grid__cell.next-grid__cell--half").addClass("disable").css({opacity:".2","pointer-events":"none"})}}))});1<a.length?a.prepend(k,g):a.prepend(g);var a=$(".section-summary").eq(0),g=$("<a/>",{"class":"btn tooltip-bottom tooltip",
style:"margin-bottom:.5em",href:"#"}).html('<span class="tooltip-container"><span class="tooltip-label">Create a linklist with every collection</span></span>Create Collections linklist').on("click",function(){c();return!1}),k=$("<a/>",{"class":"btn tooltip-bottom tooltip",style:"margin-bottom:.5em",href:"#"}).html('<span class="tooltip-container"><span class="tooltip-label">Create a linklist with every page</span></span>Create Pages linklist').on("click",function(){d();return!1}),h=$("<a/>",{"class":"btn tooltip-bottom tooltip",
style:"margin-bottom:.5em",href:"#"}).html('<span class="tooltip-container"><span class="tooltip-label">Create a linklist with all vendors</span></span>Create Vendor linklist').on("click",function(){e();return!1});a.length&&a.append("<br>",g,"<br>",k,"<br>",h);a=$('.section-summary a[href="/admin/link_lists/new"]');if(a.length&&(g=$("#link_lists .next-grid__cell header a:last-child"),g.length)){var l="";2<g.length&&(g.each(function(){var b=$(this),a=b.parent().parent().find("h3").text(),b=b.attr("href");
a.length&&b.length&&(l+='<option value="'+b+'">'+a+"</option>")}),l.length&&(g=$("<select />",{style:"margin-top:1em;border-radius:3px;border-color: #D3D3D3;color: #479ccf;width: 100%"}).on("change",function(){var a=$(this).val();a.length&&b.redirect(a)}).html('<option value="">Jump to linklist</option>'+l),k=$("<div />"),k.append(g,'<small style="display: block;background: #fff;padding: .5em;">Select a linklist to quickly jump to edit view. Useful for when you have many linklists...</small>'),a.after(k)))}},
setup_collections:function(){b.data("collections",!1);var a=$(".header-right").eq(0);if(a.length){var c=$("<ul/>",{"class":"segmented"}),d=$("<li/>"),e=$("<a/>",{"class":"btn",style:"margin-left:.5em",href:"#"}).text("Show Product Count").on("click",function(a){a.preventDefault();$.ajax({type:"GET",url:"/admin/collections.json?limit=250",dataType:"json",success:function(a){if(a.collections.length){b.data("collections",a);for(var c=a.collections.length-1;0<=c;c--){var d=$("#collections-results").find('a[href="/admin/collections/'+
...
c,e):"function"===typeof e&&e()}})}else++a,a<b.products.length?v(b,a,c,e):"function"===typeof e&&e()},u=function(a,c,e,f){var g=e.replace(/, /g,",").split(","),r=a.products[c].tags.split(","),r=b.array_unique(g.concat(r))+"",g=a.products[c].id,r={product:{id:g,tags:r}};d.text(c+1+"/"+a.products.length);$.ajax({type:"PUT",url:"/admin/products/"+g+".json",data:r,dataType:"json",success:function(b){++c;c<a.products.length?u(a,c,e,f):f()}})};d.on("click",function(){e.val().length?("add"===c.val()&&f.val().length&&
...
!0)):b.notice("Nothing to paste",!0)});"undefined"===typeof localStorage.metafieldCopy&&(c.hide(),d.hide());$("div.sub_section-summary").after(a)}},save_metafield_queue:function(a,c){"undefined"!==typeof a&&"undefined"!==typeof c&&(b.notice("Please wait whilst we paste the metafields"),$.ajax({type:"POST",url:n.URL+"/metafields.json",dataType:"json",data:{metafield:{namespace:a[c].namespace,key:a[c].key,value:a[c].value,value_type:a[c].value_type}},success:function(d){c+1<a.length?b.save_metafield_queue(a,
...
f;for(f in g){var h=g[f],k;for(k in h)h.hasOwnProperty(k)&&e.push({variant:{id:h[k],compare_at_price:d}})}e.length&&b.updateVariant(e,0,a)}else b.notice("Unexpected variant found.",!0);else b.notice("You only have 1 variant. No need to bulk edit",!0)});d.append(h)}else b.notice("ShopifyFD error : setup_products : Inventory target HTML not found",!0);$("#product-inner-variants th:last-child").length?($("#product-inner-variants th:last-child").before("<th>Variant ID</th>"),$("th.inventory.tc").text("#").prop("title",
...
d<e.length?f(d,e):(b.notice("Weight updated"),a.removeClass("is-loading").text("Save"))}})};a.addClass("is-loading").text("");f(0,e)}else b.notice("Did you set a weight?",!0);return!1});return!1});$("<span/>",{"class":"hidden"});a.append(p);$('tr.variant input[type="checkbox"]').on("change",function(){1<$('tr.variant input[type="checkbox"]:checked').length?p.removeClass("hidden"):p.addClass("hidden")})}else b.notice("ShopifyFD error : setup_products : unable to add bulk weight editor");d.length&&
"object"===typeof g&&1<Object.keys(g).length&&k.after(l)},setup_pages:function(){var a=$(".section.description .section-summary").eq(0);if(a.length){var c=a.find("a").eq(0).attr("href");a.after('<div class="sub_section-summary fadein"><h1>Metafields <span id="metacount" class="animated bounce">0</span></h1><div class="metafield-content content"><i class="ico ico-20 ico-20-loading"></i></div></div>').remove();a=$("div.metafield-content");b.loadmeta(a,s)}else b.notice("ShopifyFD error : setup_pages : Metafield target HTML not found",
...
f.price_based_shipping_rate=e,k="/admin/price_based_shipping_rates.json"):"carrier"===g&&(f={carrier_shipping_rate_provider:{}},f.carrier_shipping_rate_provider=e,k="/admin/carrier_shipping_rate_providers.json"),$.ajax({type:"POST",url:k,dataType:"json",data:f,success:function(e){d.parent().parent().find("table").append('<tbody><tr style="background:#efefef"><td>'+a[c].name+"</td><td>New rate pasted.</td><td>"+a[c].price+"</td></tr></tbody>");c===a.length-1?b.notice("Paste complete"):(c++,b.save_new_rates(a,
...
b.data("countries").countries.length){var d=[],e=[],f=[],g=function(a,c,d){if(c.length){var e=[];$.ajax({type:"GET",url:"/admin/countries/"+a+".json",dataType:"json",success:function(a){var f=a.country.weight_based_shipping_rates,g=a.country.price_based_shipping_rates;a=a.country.carrier_shipping_rate_providers;for(var k=0,t=f.length;k<t;k++)e.push([f[k].id,"weight_based"]);k=0;for(t=g.length;k<t;k++)e.push([g[k].id,"price_based"]);k=0;for(t=a.length;k<t;k++)e.push([a[k].id,"carrier_based"]);k=0;
for(t=e.length;k<t;k++)$.ajax({type:"POST",url:"/admin/shipping_rates/"+e[k][0],data:{utf8:"\u2713",_method:"delete",shipping_rate:{type:e[k][1]}},success:function(b){},error:function(a){b.notice("Failed to replace rate",!0)}});b.save_new_rates_FIX(c,0,d)},fail:function(){b.notice("I failed to get the country.json",!0)}})}else b.notice("Missing items to add",!0)};$("div.shipping-rate-table").each(function(a){var c=$(this),l=$("<a/>",{href:"#","data-country":b.data("countries").countries[a].name,"data-cid":b.data("countries").countries[a].id,
...
style:"float:right;margin-right:.5em"}).html('<span class="tooltip-container"><span class="tooltip-label">Will replace ALL existing rates.</span></span>Paste rates (replace)').on("click",function(){var a=$(this),b=a.attr("data-cid"),c=d,k=e,h=f,l=[],p=0;a.parent().parent().find("tbody").remove();a.parent().find("a").addClass("hidden");for(var q=0,n=c.length;q<n;q++)c[q].country_id=b,delete c[q].id,c[q].type="weight",l[p]=c[q],p++;q=0;for(n=k.length;q<n;q++)k[q].country_id=b,delete k[q].id,k[q].type=
"price",l[p]=k[q],p++;q=0;for(n=h.length;q<n;q++)h[q].country_id=b,delete h[q].id,h[q].type="carrier",l[p]=h[q],p++;g(b,l,a);return!1});c=c.find('a[bind-event-click="addShippingRateModal.show()"]');if(c.length)c.after(l,a,p);else return b.notice("Error. Unable to add copy button.",!0),!1})}else b.notice("Mismatch in country count. Reload this page.",!0)}else b.notice("Loading current country list"),$.ajax({type:"GET",url:"/admin/countries.json",dataType:"json",success:function(a){a.countries.length&&
...
b.setup_rte())):b.notice("ShopifyFD error : setup_custom_collections : target html not found",!0)},get_files:function(a,c){var d=$("#settings-general table");d.length&&(b.notice("Loading files..."),$.ajax({type:"GET",url:"/admin/files.json?limit=50&direction=next&page="+a,success:function(a,f,g){if(a){$("");f=0;for(g=a.files.length;f<g;f++){var k=$("<tr />",{"class":"file_row"}),h=$("<td />"),l=$("<td />"),p=$("<td />"),r=$("<td />",{"class":"tr"}),n=$("<td />"),s=$("<a />",{href:"#","data-src":a.files[f].public_url.replace("http:",
"")});if(-1<a.files[f].content_type.indexOf("image")){s.on("click",function(){var a=$(this);b.fd_modal(!0,'<img src="'+a.attr("data-src")+'" />',"Image Preview",!0);return!1}).text(a.files[f].key.replace("files/",""));var w=a.files[f].public_url.replace(/(\.[^\.]+)$/,"_thumb$1").replace("http:","");h.html('<img src="'+w+'" />');l.append(s);p.html('<input class="select-all-on-focus" value="'+a.files[f].public_url+'">')}else s.attr("href",a.files[f].public_url).attr("target","_blank").text(a.files[f].key.replace("files/",
""));r.html(Math.floor(a.files[f].size/1024)+" kB");k.append(h,l,p,r,n);d.append(k)}f>=c?(b.notice("All loaded"),$(".header-right .segmented").hide()):(++f,b.get_files(f,c))}}}))},setup_files:function(){var a=$(".header-row .header-right").eq(0);if(a.length){var c=$("<ul/>",{"class":"segmented",id:"get_all_images"}),d=$("<li/>"),e=$("<a/>",{"class":"btn",href:"#",style:"margin-left:1em"}).html("Show all files").on("click",function(){var a=$(this);a.addClass("is-loading").attr("style","margin-left:1em;text-indent: -9999px;");
...
c.find(".span18"),k=$("<div />",{"class":"box box-details"}),h=$("<ol />",{"class":"content-index content-index-img-icons"});$.ajax({type:"GET",url:"https://freakdesign-us.s3.amazonaws.com/shopify/shopifyFD/s/announcements.json",dataType:"json",cache:!1,xhrFields:{withCredentials:!0},crossDomain:!0,success:function(b){for(var d=0;d<b.announcements.length;d++){var r=$("<li />",{"class":"content-index__item"}).html("<small>"+b.announcements[d].date+"</small><br><strong>"+b.announcements[d].title+"</strong><p>"+
b.announcements[d].description+"</p>");h.append(r)}e.text("ShopifyFD updates");f.text("Keep up to date with the latest edits and notes.");c.removeClass("first-section").addClass("fadein");g.html("").append(k);k.append(h);a.after(c)},error:function(a,c,d){b.notice(d,!0)}})}},init:function(){b.data("drag_on")&&b.set_drag_drop();$("html").addClass("shopifyJSoverride");b.get_theme_data();setInterval(function(){b.data("content",$("#content"));if(!b.data("content").hasClass("loading")){b.add_ui();var a=
n.URL.split("#")[0].split("?")[0].split("/"),a=a[a.length-2],c=n.URL.split("/").pop();if("next"!==c&&"prev"!==c&&(a!==b.data("alpha")||c!==b.data("omega")))if(b.data("alpha",a),b.data("omega",c),b.flog(b.data("alpha")+","+b.data("omega")),"customers"==b.data("alpha")&&!isNaN(b.data("omega")))b.setup_customers();else if("articles"==b.data("alpha")&&!isNaN(b.data("omega")))b.setup_articles();else if("pages"==b.data("alpha")&&!isNaN(b.data("omega")))b.setup_pages();else if("smart_collections"===b.data("alpha")&&
