(function(){if("undefined"!==typeof Shopify)if("undefined"!==typeof jQuery)if($("#shopifyjs").length)"function"===typeof Shopify.Flash.error&&Shopify.Flash.error("Error. ShopifyFD already loaded!");else{var l=document;if(1<l.URL.indexOf("myshopify.com/admin")){var b=function(){var r={debug:!1,drag_on:!1,alpha:!1,omega:!1,countries:!1,wait:1E3,api_count:0,api_limit:250,metafields:{},autosave:!1,content:$("#content"),body:$("body")};return{escape:function(b){return b.replace(/[\\]/g,"\\\\").replace(/[\"]/g,
...
"About this tool",!0);return!1},createbackup:function(a){if("undefined"!==typeof a&&a){var c=$("iframe").contents().find("#tinymce").html();"undefined"!==typeof c&&$.ajax({type:"POST",url:l.URL+"/metafields.json",dataType:"json",data:{metafield:{namespace:"backups",key:a,value:c,value_type:"string"}},success:function(a){b.updatedropdown();b.notice("Backup saved")},error:function(a){a=JSON.parse(a.responseText);b.notice(a.errors.value[0],!0)}})}},loadmeta:function(a,c){var d="/admin/"+b.data("alpha")+
"/"+b.data("omega")+"/metafields.json?limit=250";"general"===b.data("omega")&&(d="/admin/metafields.json?limit=250");"articles"===b.data("alpha")&&(d="/admin/articles/"+b.data("omega")+"/metafields.json?limit=250");$.getJSON(d,function(d){var f="",h=b.data("datalistNamespace")||["global"],g=b.data("datalistKey")||[];if(m=d.metafields){b.data("m",m);b.data("hasbackup",!1);$("#restorebackup").hide();"products"!==b.data("alpha")&&"collections"!==b.data("alpha")&&"pages"!==b.data("alpha")||b.setup_copypaste();
d=$("#metacount");d.text(m.length).addClass("active");0===m.length?d.removeClass("active"):d.addClass("active");d=0;for(var k=m.length;d<k;d++)f+='<option data-type="'+m[d].value_type+'" data-id="'+m[d].id+'">'+m[d].namespace+"."+m[d].key+"</option>",c.metafields[m[d].id]={namespace:m[d].namespace,value:m[d].value,key:m[d].key},"backups"==m[d].namespace&&!1===b.data("hasbackup")&&($("#restorebackup").show(),b.data("hasbackup",!0),b.setupRteBackupBtn()),h.push(m[d].namespace),g.push(m[d].key);h=b.array_unique(h);
g=b.array_unique(g);b.data("datalistNamespace",h);b.data("datalistKey",g);f='<select id="metafieldselect"><option value="">Select or create a metafield</option>'+f+"</select>"}else f='<select id="metafieldselect"><option value="">Select or create a metafield</option></select>';a.html(f).append('<label style="margin-top:1em">Add New Metafield</label><input class="ssb" maxlength="20" type="text" id="metafield_namespace" placeholder="namespace" list="fd-dl-namespace"><datalist id="fd-dl-namespace"></datalist><input class="ssb" maxlength="30" type="text" id="metafield_key" placeholder="key" list="fd-dl-key"><datalist id="fd-dl-key"></datalist><textarea class="ssb" id="metafield_value" placeholder="value"></textarea><input type="hidden" id="metafield_id"><a class="btn btn-slim savemymeta" id="shopifyjs_savemetafield">Save</a> <a class="int btn btn-slim savemymeta" id="shopifyjs_savemetafield_int">Save as Integer</a> <a id="shopifyjs_copymetafield" class="btn btn-slim hidden btn-primary tooltip tooltip-bottom"><span class="tooltip-container"><span class="tooltip-label">Copy Metafield to Virtual Clipboard</span></span>Copy</a> <a class="btn btn-slim hidden delete tooltip tooltip-bottom" id="shopifyjs_deletemetafield"><span class="tooltip-container"><span class="tooltip-label">There is no undo. Be careful...</span></span>Delete</a><p style="margin-top:1em;line-height:1"><small><a id="advanced_meta_features" href="#">Toggle advanced features</a><br>Please note: Using the save button top right will NOT save these metafields. Be sure to click Save above.</small></p><div id="advanced_meta" class="hidden"><p style="border-bottom: 1px solid #ccc;">Handle Helper <a id="adv_clear_cache" style="float:right" href="#">Clear cache</a></p><p><a id="adv_get_collections" class="btn btn-slim" href="">Get collections</a></p><p><a id="adv_get_products" class="btn btn-slim" href="">Get products</a> <small>not suitable for large stores</small></p></div>');
for(d=0;d<h.length;d++)f=$("<option />",{value:h[d]}),$("#fd-dl-namespace").append(f);for(d=0;d<g.length;d++)f=$("<option />",{value:g[d]}),$("#fd-dl-key").append(f);$("#advanced_meta_features").off("click").on("click",function(){$("#advanced_meta").eq(0).toggleClass("hidden");return!1});$("#adv_clear_cache").off("click").on("click",function(){$("#advanced_meta").find("select").remove().end().find("a").show();b.data("products",!1);b.data("collections",!1);return!1});$("#adv_get_products").off("click").on("click",
function(){var a=$(this);if(b.data("products")){for(var c=b.data("products"),d="",e=$("<select />",{}).change(function(){var b=$(this);$("#metafield_value").val(b.val())}).html('<option value="">Add product handle as value</option>'),f=0,t=c.products.length;f<t;f++)d+='<option value="'+c.products[f].handle+'">'+c.products[f].title+"</option>";e.append(d);a.after(e).hide()}else $.ajax({type:"GET",url:"/admin/products.json?limit=250",dataType:"json",success:function(c){if(c.products.length){b.data("products",
c);for(var d="",e=$("<select />",{}).change(function(){var b=$(this);$("#metafield_value").val(b.val())}).html('<option value="">Add product handle as value</option>'),t=0,f=c.products.length;t<f;t++)d+='<option value="'+c.products[t].handle+'">'+c.products[t].title+"</option>";e.append(d);a.after(e).hide()}},fail:function(){b.notice("Failed to load products",!0)}});return!1});$("#adv_get_collections").off("click").on("click",function(){var a=$(this);if(b.data("collections")){for(var c=b.data("collections"),
d="",e=$("<select />",{}).change(function(){var b=$(this);$("#metafield_value").val(b.val())}).html('<option value="">Add collection handle as value</option>'),f=0,t=c.collections.length;f<t;f++)d+='<option value="'+c.collections[f].handle+'">'+c.collections[f].title+"</option>";e.append(d);a.after(e).hide()}else $.ajax({type:"GET",url:"/admin/collections.json?limit=250",dataType:"json",success:function(c){if(c.collections.length){b.data("collections",c);for(var d="",e=$("<select />",{}).change(function(){var b=
$(this);$("#metafield_value").val(b.val())}).html('<option value="">Add collection handle as value</option>'),t=0,f=c.collections.length;t<f;t++)d+='<option value="'+c.collections[t].handle+'">'+c.collections[t].title+"</option>";e.append(d);a.after(e).hide()}},error:function(){b.notice("Failed to load collections",!0)}});return!1});$("#metafieldselect").change(function(){var a=$(this).find(":selected");if(a.attr("data-id")){var d=c.metafields[a.attr("data-id")];a.attr("data-type");$("#metafield_namespace").val(d.namespace).prop("disabled",
!0);$("#metafield_key").val(d.key).prop("disabled",!0);$("#metafield_value").val(d.value);$("#metafield_id").val(a.attr("data-id"));$("#shopifyjs_deletemetafield").removeClass("hidden")}else b.clearmetaform()});$("#shopifyjs_deletemetafield").on("click",function(){var a=$("#metafield_id").val(),c=l.URL+"/metafields/"+a+".json";"general"===b.data("omega")&&(c="/admin/metafields/"+a+".json");"articles"===b.data("alpha")&&(c="/admin/articles/"+b.data("omega")+"/metafields/"+a+".json");a&&$.ajax({type:"DELETE",
...
c=a.find("a.create"),d=a.find("a.createint");a.find("a.update");a.find("a.delete");var e=a.find("#bulk_namespace"),f=a.find("#bulk_key"),h=a.find("#bulk_value"),g=a.find("textarea.debug"),k=function(){return 1<e.val().length&&1<f.val().length&&1<h.val().length?!0:!1};c.off("click").on("click",function(){if(k){var a={metafield:{namespace:e.val(),key:f.val(),value:h.val(),value_type:"string"}};b.bulk_save_metafield_queue(a,0,g)}else b.notice("No empty fields allowed")});d.off("click").on("click",function(){if(k)if(isNaN(h.val()))b.notice("Value not an integer",
...
return!1}),a.find("header").prepend(e).end().fadeIn();else a.fadeIn().on("click",function(){b.fd_modal(!1)});$("body").append(a)}else f.off("click").remove()},restorebackup:function(a){a=$("iframe").contents().find("#tinymce");var c=b.data("m");if(c)for(var d=0,e=c.length;d<e;d++){if("backups"==c[d].namespace){a.html(c[d].value);b.notice("Backup restored");break}}else b.notice("Error, nothing to restore",!0)},setup_discounts:function(){var a=$(".header-row .header-right").eq(0);if(a.length){var c=
...
a=$("div.metafield-content");b.loadmeta(a,r);a=$("h1.header-main");a.length&&(d=$("<a />",{href:d,target:"_blank",style:"display: inline-block;vertical-align: top;",title:"View in Store"}),d.append('<i class="next-icon next-icon--20 next-icon--header next-icon--website-slate-lightest"></i>'),a.append(d))}else b.notice("ShopifyFD error : setup_articles : Metafield target HTML not found",!0);if(c.length){var d=$("<ul/>",{"class":"segmented",id:"copy-object"}),a=$("<li/>"),e=$("<a/>",{"class":"btn btn-separate",
href:"#"}).html("Duplicate").on("click",function(a){a.preventDefault();$(this);$.getJSON(l.URL+".json",function(a){$.ajax({type:"POST",url:"/admin/blogs/"+a.article.blog_id+"/articles.json",dataType:"json",data:{article:{author:a.article.author,blog_id:a.article.blog_id,body_html:a.article.body_html,summary_html:a.article.summary_html,tags:a.article.tags,template_suffix:a.article.template_suffix,title:a.article.title+" [copy]",published:!1}},success:function(a){b.redirect("/admin/blogs/"+a.article.blog_id+
"/articles/"+a.article.id)},error:function(a){b.notice("Error saving",!0)}})})});a.append(e);d.append(a);c.prepend(d)}else b.notice("ShopifyFD error : setup_articles : Header button missing",!0)},setup_blogs:function(){var a=$("div.section.description");a.length?(a.after('<div class="section metafields"><div class="next-grid"><div class="next-grid__cell next-grid__cell--quarter"><div class="section-summary"><h1>Metafields</h1><p>Manage the metafields that belong to this collection.</p></div></div><div class="next-grid__cell"><div class="next-card"><div class="section-content" id="collection-metafields"><div class="next-card__section"><div class="sub_section-summary fadein"><h1>Metafields <span id="metacount" class="animated bounce">0</span></h1><div class="metafield-content content"><i class="ico ico-20 ico-20-loading"></i></div></div></div></div></div></div></div></div>'),
a=$("div.metafield-content"),b.loadmeta(a,r)):b.notice("ShopifyFD error : setup_blogs : target html not found",!0)},setupRteBackupBtn:function(){$("#restorebackup").show().on("click",function(a){a.preventDefault();b.restorebackup(b.data("omega"))})},setup_rte:function(){var a=$("#restorebackup");a.length&&(b.data("hasbackup")?b.setupRteBackupBtn():a.hide());$("#clearformatting").on("click",function(){b.clearformatting();return!1});$("#createbackup").on("click",function(){b.createbackup(b.data("omega"));
return!1});$("#save_images_to_meta").on("click",function(){b.save_images_to_meta();return!1})},save_images_to_meta:function(){var a=$("iframe").contents().find("#tinymce").find("img");if(a&&a.length){var c="";a.each(function(b){var e=$(this).prop("src").replace(/https:/i,"");c+=e;b<a.length-1&&(c+=",")});$.ajax({type:"POST",url:l.URL+"/metafields.json",dataType:"json",data:{metafield:{namespace:"helpers",key:"images",value:c,value_type:"string"}},success:function(a){b.updatedropdown();b.notice("Images saved to metafield")},
error:function(a){b.notice("Error saving",!0)}})}else b.notice("No images found",!0)},array_unique:function(b){b=b.concat();for(var c=0;c<b.length;++c)for(var d=c+1;d<b.length;++d)b[c]===b[d]&&b.splice(d--,1);return b},setup_products_list:function(){var a=$(".header-right .segmented").eq(0);if(a.length){if(!$("#showsku").length){var c=$("<ul/>",{"class":"segmented",id:"showsku"}),d=$("<li/>"),e=$("<a/>",{"class":"btn animated fadein",href:"#",title:"Show SKU and Variant IDs"}).html("Show SKUs & ID").on("click",
function(a){a.preventDefault();var c=[],d=$("#all-products td.name a");d.each(function(){c.push($(this).attr("href").split(/[/]+/).pop())});if(c.length){var e=function(a,c){$.ajax({type:"GET",url:"/admin/products/"+a[c]+".json?fields=variants",dataType:"json",success:function(f){var h=f.product.variants[0].sku;f=f.product.variants[0].id;var u="";if(h||f)h&&(u='<span title="SKU" class="sku label animated fadein">'+h+"</span>"),d.eq(c).before(u+'<span title="VariantID" class="variant label animated fadein">'+
f+"</span>");c+1<a.length?e(a,c+1):b.notice("SKUs and Variant IDs Loaded")}})};b.notice("Loading SKUs and Variant IDs, please wait...");e(c,0)}});d.append(e);c.append(d);a.after(c)}}else b.notice("Error : setup_products_list : html not found",!0)},setup_themes:function(){$(".theme-store-cta-section").remove();for(var b=$(".published-theme-title"),c=$(".btn.btn-primary").eq(0).attr("href"),d=$("div.unpublished-box"),e=0;e<d.length;e++){var f=d[e].id.split("_").pop(),h=d.eq(e).find(".next-card__section.tc"),
f=$("<div />",{"class":"theme-id"}).html('<span class="tooltip-bottom tooltip"><span class="tooltip-container"><span class="tooltip-label">Theme ID</span></span>'+f+"</span>");h.append(f)}b.length&&"undefined"!==typeof c&&-1<c.indexOf("/admin/themes")&&(c=$("<span />",{"class":"theme-id published"}).text(c.split("/")[3]),b.append(c))},setup_link_lists_single:function(){var a=$(".header-row .header-right");a.length&&$.ajax({type:"GET",url:"/admin/link_lists.json",dataType:"json",success:function(c){if(c){link_lists=
...
d,e){c.removeClass("btn is-loading no-btn");b.notice(e,!0)}})):b.notice("Can not copy this linklist. ID was not found",!0)}),g=$("<a />",{href:"#","class":"tooltip-bottom tooltip",style:"margin-right:1.5em"}).html('<span class="tooltip-container"><span class="tooltip-label">Delete Linklist on click</span></span><i class="ico ico-14-svg ico-delete"></i>').on("click",function(b){b.preventDefault();var a=$(this);b=a.parent().find('a[href^="/admin/link_lists"]').eq(0);b.length&&(a.addClass("btn is-loading no-btn"),
href=b.attr("href").split("/").pop(),isNaN(href)||$.ajax({type:"POST",url:"/admin/link_lists/"+href,data:{utf8:"\u2713",_method:"delete"},success:function(b){a.removeClass("btn is-loading no-btn").closest(".next-grid__cell.next-grid__cell--half").addClass("disable").css({opacity:".2","pointer-events":"none"})}}))});1<a.length?(a.prepend(g,h),$.ajax({type:"GET",url:"/admin/link_lists.json",dataType:"json",success:function(c){c&&(b.data("link_lists",c),link_lists=c.link_lists,a.each(function(b){$(this).parent().find("h3").append('<span class="fadein" style="color:#ccc;display: block;font-size: 11px;font-family: monospace;">'+
c.link_lists[b].handle+"</span>")}))}})):a.prepend(h);var h=$(".section-summary").eq(0),g=$("<a/>",{"class":"btn tooltip-bottom tooltip",style:"margin-bottom:.5em",href:"#"}).html('<span class="tooltip-container"><span class="tooltip-label">Create a linklist with every collection</span></span>Create Collections linklist').on("click",function(){$(this).addClass("is-loading disabled");c();return!1}),k=$("<a/>",{"class":"btn tooltip-bottom tooltip",style:"margin-bottom:.5em",href:"#"}).html('<span class="tooltip-container"><span class="tooltip-label">Create a linklist with every page</span></span>Create Pages linklist').on("click",
function(){$(this).addClass("is-loading disabled");d();return!1}),p=$("<a/>",{"class":"btn tooltip-bottom tooltip",style:"margin-bottom:.5em",href:"#"}).html('<span class="tooltip-container"><span class="tooltip-label">Create a linklist with all vendors</span></span>Create Vendor linklist').on("click",function(){$(this).addClass("is-loading disabled");e();return!1});h.length&&h.append("<br>",g,"<br>",k,"<br>",p);h=$('.section-summary a[href="/admin/link_lists/new"]');if(h.length&&(g=$("#link_lists .next-grid__cell header a:last-child"),
g.length)){var n="";2<g.length&&(g.each(function(){var b=$(this),a=b.parent().parent().find("h3").text(),b=b.attr("href");a.length&&b.length&&(n+='<option value="'+b+'">'+a+"</option>")}),n.length&&(g=$("<select />",{style:"margin-top:1em;border-radius:3px;border-color: #D3D3D3;color: #479ccf;width: 100%"}).on("change",function(){var a=$(this).val();a.length&&b.redirect(a)}).html('<option value="">Jump to linklist</option>'+n),k=$("<div />"),k.append(g,'<small style="display: block;background: #fff;padding: .5em;">Select a linklist to quickly jump to edit view. Useful for when you have many linklists...</small>'),
h.after(k)))}},setup_collections:function(){b.data("collections",!1);var a=$(".header-right").eq(0);if(a.length){var c=$("<ul/>",{"class":"segmented"}),d=$("<li/>"),e=$("<a/>",{"class":"btn",style:"margin-left:.5em",href:"#"}).text("Show Product Count").on("click",function(a){a.preventDefault();$.ajax({type:"GET",url:"/admin/collections.json?limit=250",dataType:"json",success:function(a){if(a.collections.length){b.data("collections",a);for(var c=a.collections.length-1;0<=c;c--){var d=$("#collections-results").find('a[href="/admin/collections/'+
a.collections[c].id+'"]');0===d.find("span").length&&d.append('<span class="sku label">'+a.collections[c].products_count+"</span>")}}}})}),f=$("<a/>",{"class":"btn",href:"#",title:"Add tags to entire collection"}).html("Bulk edit tags").on("click",function(){b.fd_modal(!0,'<div><div class="clearfix em"><div class="half">Choose a collection</div><div class="half"><select data-action="collection"><option value="">Loading, please wait...</option></select></div></div><div class="clearfix em"><div class="half">Choose an action</div><div class="half"><select data-action="action"><option value="add">Add</option><option value="set">Set</option><option value="remove">Remove</option><option disabled value="toggle">Toggle</option><option value="purge" style="background:red;color:#fff">DELETE ALL</option></select></div></div><div class="clearfix em"><div class="half">Set the tag</div><div class="half"><input /></div></div><div class="half"><a class="btn" data-action="update_tags">Update tags</a></div><div class="half"><small>Add: Adds tags to the existing ones<br>Set: Replaces tags with new ones<br>Remove: Removes matching tags<br>Toggle: Future Use, disabled...</small></div></div>',
"Edit tags for all products in a collection",!0);var a=$("#fdmodal"),c=a.find('select[data-action="action"]'),d=a.find("a").eq(1),e=a.find('select[data-action="collection"]'),f=a.find("input").eq(0);c.change(function(b){"purge"==c.val()||"set"==c.val()?("purge"==c.val()&&f.val("").attr("disabled","disabled"),d.addClass("delete")):(f.removeAttr("disabled"),d.removeClass("delete"))});var w=function(b,a,c,e){var f=b.products[a].id,h={product:{id:f,tags:c}};d.text(a+1+"/"+b.products.length);$.ajax({type:"PUT",
url:"/admin/products/"+f+".json",data:h,dataType:"json",success:function(d){++a;a<b.products.length?w(b,a,c,e):"function"===typeof e&&e()}})},x=function(b,a,c,e){if(b.products[a].tags){var f=c.replace(/, /g,",").split(","),h=b.products[a].tags.replace(/, /g,",").split(","),h=$(h).not(f).get()+"",f=b.products[a].id,h={product:{id:f,tags:h}};d.text(a+1+"/"+b.products.length);$.ajax({type:"PUT",url:"/admin/products/"+f+".json",data:h,dataType:"json",success:function(d){++a;a<b.products.length?x(b,a,
c,e):"function"===typeof e&&e()}})}else++a,a<b.products.length?x(b,a,c,e):"function"===typeof e&&e()},u=function(a,c,e,f){var h=e.replace(/, /g,",").split(","),g=a.products[c].tags.split(","),g=b.array_unique(h.concat(g))+"",h=a.products[c].id,g={product:{id:h,tags:g}};d.text(c+1+"/"+a.products.length);$.ajax({type:"PUT",url:"/admin/products/"+h+".json",data:g,dataType:"json",success:function(b){++c;c<a.products.length?u(a,c,e,f):f()}})};d.on("click",function(){e.val().length?("add"===c.val()&&f.val().length&&
$.ajax({type:"GET",url:"/admin/products.json?collection_id="+e.val()+"&fields=id,tags",dataType:"json",success:function(a){d.addClass("disabled");u(a,0,f.val(),function(){b.notice("Done. Tags have been added");d.text("Update tags").removeClass("disabled")})}}),"purge"!==c.val()&&"set"!==c.val()||$.ajax({type:"GET",url:"/admin/products.json?collection_id="+e.val()+"&fields=id",dataType:"json",success:function(a){d.addClass("disabled");w(a,0,f.val(),function(){b.notice("Done.");d.text("Update tags").removeClass("disabled")})}}),
"remove"===c.val()&&$.ajax({type:"GET",url:"/admin/products.json?collection_id="+e.val()+"&fields=id,tags",dataType:"json",success:function(a){d.addClass("disabled");x(a,0,f.val(),function(){b.notice("Matched tags have been removed.");d.text("Update tags").removeClass("disabled")})}})):b.notice("Choose a collection",!0);return!1});c.hide();$.ajax({type:"GET",url:"/admin/collections.json?limit=250",dataType:"json",success:function(a){if(a.collections.length){b.data("collections",a);for(var d="",f=
0,h=a.collections.length;f<h;f++)d+='<option value="'+a.collections[f].id+'">'+a.collections[f].title+"</option>";e.append(d).find("option:eq(0)").text("Select a collection");c.show()}}});return!1});d.append(f,e);c.append(d);a.prepend(c)}else b.notice("ShopifyFD error : setup_collections : target html not found")},setup_copypaste:function(){if(b.supportsHTML5Storage()){var a=$('<div><a class="btn btn-slim" id="fd_copymetafields">Copy All Metafields</a> <a class="btn btn-slim" id="fd_pastemetafields">Paste Metafields</a> <a class="btn btn-slim tooltip tooltip-bottom" href="#" id="fd_whatmetafields"><span class="tooltip-container"><span class="tooltip-label">View what is in the clipboard</span></span>?</a></div>'),
...
d<e.length?f(d,e):(b.notice("Weight updated"),a.removeClass("is-loading").text("Save"))}})};a.addClass("is-loading").text("");f(0,e)}else b.notice("Did you set a weight?",!0);return!1});return!1});$("<span/>",{"class":"hidden"});e.append(w);$('tr.variant input[type="checkbox"]').on("change",function(){1<$('tr.variant input[type="checkbox"]:checked').length?w.removeClass("hidden"):w.addClass("hidden")})}else b.notice("ShopifyFD error : setup_products : unable to add bulk weight editor");d.length&&
"object"===typeof g&&1<Object.keys(g).length&&k.after(n)},setup_pages:function(){var a=$(".section.description .section-summary").eq(0);if(a.length){var c=a.find("a").eq(0).clone(!0),d=c.attr("href");a.after('<div class="sub_section-summary fadein"><h1>Metafields <span id="metacount" class="animated bounce">0</span></h1><div class="metafield-content content"><i class="ico ico-20 ico-20-loading"></i></div></div>').remove();a=$("div.metafield-content");b.loadmeta(a,r)}else b.notice("ShopifyFD error : setup_pages : Metafield target HTML not found",
!0);a=$("h1.header-main");a.length&&("undefined"!==typeof d&&(c=$("<a />",{href:d,target:"_blank",style:"display: inline-block;vertical-align: top;",title:"View in Store"}),c.append('<i class="next-icon next-icon--20 next-icon--header next-icon--website-slate-lightest"></i>')),a.append(c));0===$("#rte_extra").length&&($("#page-content_ifr").eq(0).after('<div id="rte_extra"><a class="btn btn-slim tooltip tooltip-bottom" id="clearformatting" href="#"><span class="tooltip-container"><span class="tooltip-label">Careful, this method is brutal...</span></span>Purge html</a> <a class="btn btn-slim tooltip tooltip-bottom" id="createbackup" href="#"><span class="tooltip-container"><span class="tooltip-label">Save contents as metafield</span></span>Create Backup</a> <a class="btn btn-slim" style="display:none;" id="restorebackup" href="#">Restore Backup</a> <a class="btn btn-slim tooltip tooltip-bottom" id="save_images_to_meta" href="#"><span class="tooltip-container"><span class="tooltip-label">Add image paths to a metafield</span></span>Images to Metafields</a></div>'),
...
save_new_rates_FIX:function(a,c,d){if("undefined"!==typeof c&&"undefined"!==typeof a[c]&&"undefined"!==typeof d){var e=d.data("cid"),f=a[c],h=f.type;"weight"==h?f.type="weight_based":"price"==h?f.type="price_based":(h="carrier",f.type="carrier_based");f.country_id=e;f.new_type=f.type;e={utf8:"\u2713",shipping_rate:f};b.notice('Pasting "'+f.name+'"...');$.ajax({type:"POST",url:"/admin/shipping_rates",data:e,success:function(e,f,h){d.parent().parent().find("table").append('<tbody><tr style="background:#efefef"><td>'+
a[c].name+"</td><td>New rate pasted.</td><td>"+a[c].price+"</td></tr></tbody>");c===a.length-1?b.notice("Paste complete"):(c++,b.save_new_rates_FIX(a,c,d))},error:function(a,c,d){b.notice("Error pasting. "+d,!0)}})}},save_new_rates:function(a,c,d){if("undefined"!==typeof a[c]){var e=a[c],f={},h=e.type,g="";delete e.type;"string"===typeof h?("weight"===h?(f={weight_based_shipping_rate:{}},f.weight_based_shipping_rate=e,g="/admin/weight_based_shipping_rates.json"):"price"===h?(f={price_based_shipping_rate:{}},
f.price_based_shipping_rate=e,g="/admin/price_based_shipping_rates.json"):"carrier"===h&&(f={carrier_shipping_rate_provider:{}},f.carrier_shipping_rate_provider=e,g="/admin/carrier_shipping_rate_providers.json"),$.ajax({type:"POST",url:g,dataType:"json",data:f,success:function(e){d.parent().parent().find("table").append('<tbody><tr style="background:#efefef"><td>'+a[c].name+"</td><td>New rate pasted.</td><td>"+a[c].price+"</td></tr></tbody>");c===a.length-1?b.notice("Paste complete"):(c++,b.save_new_rates(a,
c,d))},error:function(){b.notice("Error pasting.",!0)}})):b.notice("missing type: "+h,!0)}else b.notice("save_new_rates error - length",!0)},setup_shipping:function(a){if("undefined"!==typeof a){a=$("<div />",{"class":"box error animated fadein"}).html('Warning - The way that shipping rates are copied and pasted has recently changed. It has NOT been thoroughly tested. Be sure to test this feature BEFORE making bulk edits. See this <a target="_blank" href="https://ecommerce.shopify.com/c/shopify-apis-and-technology/t/dashboard-endpoints-failing-link-lists-shipping-files-etc-212161">related post</a>.');
...
a.find("a.delete_all").on("click",function(){$.ajax({type:"GET",url:"/admin/countries.json",dataType:"json",success:function(a){a.countries.length&&(r.countries=a.countries,b.notice(a.countries.length+" countries returned"),b.shipping_remove_all(a.countries.length-1,a.countries))},error:function(){b.notice("Error removing country. Process stopped.",!0)}});return!1});b.fd_modal(!0,a,"Delete all countries",!0);return!1});a.append(c)}else b.notice("ShopifyFD error : setup_shipping");if($("div.shipping-rate-table").length===
b.data("countries").countries.length){var d=[],e=[],f=[],h=function(a,c,d){if(c.length){var e=[];$.ajax({type:"GET",url:"/admin/countries/"+a+".json",dataType:"json",success:function(a){var f=a.country.weight_based_shipping_rates,h=a.country.price_based_shipping_rates;a=a.country.carrier_shipping_rate_providers;for(var g=0,v=f.length;g<v;g++)e.push([f[g].id,"weight_based"]);g=0;for(v=h.length;g<v;g++)e.push([h[g].id,"price_based"]);g=0;for(v=a.length;g<v;g++)e.push([a[g].id,"carrier_based"]);g=0;
for(v=e.length;g<v;g++)$.ajax({type:"POST",url:"/admin/shipping_rates/"+e[g][0],data:{utf8:"\u2713",_method:"delete",shipping_rate:{type:e[g][1]}},success:function(b){},error:function(a){b.notice("Failed to replace rate",!0)}});b.save_new_rates_FIX(c,0,d)},fail:function(){b.notice("I failed to get the country.json",!0)}})}else b.notice("Missing items to add",!0)};$("div.shipping-rate-table").each(function(a){var c=$(this),p=$("<a/>",{href:"#","data-country":b.data("countries").countries[a].name,"data-cid":b.data("countries").countries[a].id,
"data-index":a,"class":"fadein btn btn-slim copyrates tooltip tooltip-bottom",style:"float:right;margin-right:.5em"}).html('<span class="tooltip-container"><span class="tooltip-label">Copy Rates to Memory</span></span>Copy rates').on("click",function(){var a=$(this);a.attr("data-index");var c=a.attr("data-country"),h=a.attr("data-cid");$("a.copyrates").removeClass("btn-primary");a.addClass("btn-primary");$.ajax({type:"GET",url:"/admin/countries/"+h+".json",dataType:"json",success:function(a){d=a.country.weight_based_shipping_rates;
e=a.country.price_based_shipping_rates;f=a.country.carrier_shipping_rate_providers;b.notice("Ready to paste "+c+".");$("a.bulkpaste, input.paste-checkbox").removeClass("hidden")},error:function(){b.notice("Error copying rates",!0)}});return!1}),n=$("<input />",{type:"checkbox",style:"float:right","class":"hidden paste-checkbox"});a=$("<a/>",{href:"#","data-country":b.data("countries").countries[a].name,"data-cid":b.data("countries").countries[a].id,"data-index":a,"class":"hidden fadein bulkpaste btn btn-slim tooltip tooltip-bottom",
style:"float:right;margin-right:.5em"}).html('<span class="tooltip-container"><span class="tooltip-label">Will replace ALL existing rates.</span></span>Paste rates (replace)').on("click",function(){var a=$(this),b=a.attr("data-cid"),c=d,g=e,k=f,p=[],n=0;a.parent().parent().find("tbody").remove();a.parent().find("a").addClass("hidden");for(var q=0,l=c.length;q<l;q++)c[q].country_id=b,delete c[q].id,c[q].type="weight",p[n]=c[q],n++;q=0;for(l=g.length;q<l;q++)g[q].country_id=b,delete g[q].id,g[q].type=
"price",p[n]=g[q],n++;q=0;for(l=k.length;q<l;q++)k[q].country_id=b,delete k[q].id,k[q].type="carrier",p[n]=k[q],n++;h(b,p,a);return!1});c=c.find('a[bind-event-click="addShippingRateModal.show()"]');if(c.length)c.after(p,a,n);else return b.notice("Error. Unable to add copy button.",!0),!1})}else b.notice("Mismatch in country count. Reload this page.",!0)}else b.notice("Loading current country list"),$.ajax({type:"GET",url:"/admin/countries.json",dataType:"json",success:function(a){a.countries.length&&
(b.data("countries",a),b.notice(a.countries.length+" countries loaded"),b.setup_shipping(!0))},error:function(){b.notice("Loading failed",!0)}})},setup_custom_collections:function(){var a=$("div.section.products").eq(0),c=$(".header-row .header-right").eq(0);a.length?(a.after('<div class="section metafields"><div class="next-grid"><div class="next-grid__cell next-grid__cell--quarter"><div class="section-summary"><h1>Metafields</h1><p>Manage the metafields that belong to this collection.</p></div></div><div class="next-grid__cell"><div class="next-card"><div class="section-content" id="collection-metafields"><div class="next-card__section"><div class="sub_section-summary fadein"><h1>Metafields <span id="metacount" class="animated bounce">0</span></h1><div class="metafield-content content"><i class="ico ico-20 ico-20-loading"></i></div></div></div></div></div></div></div></div>'),
a=$("div.metafield-content"),b.loadmeta(a,r),0===$("#rte_extra").length&&($("#collection-description_iframecontainer").eq(0).after('<div id="rte_extra"><a class="btn btn-slim tooltip tooltip-bottom" id="clearformatting" href="#"><span class="tooltip-container"><span class="tooltip-label">Careful, this method is brutal...</span></span>Purge html</a> <a class="btn btn-slim tooltip tooltip-bottom" id="createbackup" href="#"><span class="tooltip-container"><span class="tooltip-label">Save contents as metafield</span></span>Create Backup</a> <a class="btn btn-slim" style="display:none;" id="restorebackup" href="#">Restore Backup</a> <a class="btn btn-slim tooltip tooltip-bottom" id="save_images_to_meta" href="#"><span class="tooltip-container"><span class="tooltip-label">Add image paths to a metafield</span></span>Images to Metafields</a></div>'),
b.setup_rte())):b.notice("ShopifyFD error : setup_custom_collections : target html not found",!0);if(c.length){var a=$("<ul/>",{"class":"segmented",id:"copy-object"}),d=$("<li/>"),e=$("<a/>",{"class":"btn btn-separate",href:"#"}).html("Duplicate").on("click",function(a){a.preventDefault();$(this).addClass("disabled is-loading");$.getJSON(l.URL+".json",function(a){delete a.collection.disjunctive;delete a.collection.handle;delete a.collection.id;delete a.collection.products_count;delete a.collection.published_at;
...
"undefined"!==c&&b.redirect("/admin/collections/"+c)}catch(d){}},error:function(){b.notice("Error duplicating.",!0)}});else{var f=0,l=document.URL.split("/").pop(),r=function(a,e,f,h){"undefined"!==typeof a&&"undefined"!==typeof e&&("undefined"===typeof f&&(f=1),"undefined"===typeof h&&(h=[]),b.notice("Duplicating collection, please wait..."),$.ajax({type:"GET",url:"/admin/collects.json?limit=250&fields=product_id&page="+f+"&collection_id="+a,success:function(n){h=h.concat(n.collects);250*f>e?(c.custom_collection.collects=
h,$.ajax({type:"POST",url:d,contentType:"application/json;charset=utf-8",data:JSON.stringify(c),success:function(a){try{var c=a[Object.keys(a)[0]].id;"undefined"!==c&&b.redirect("/admin/collections/"+c)}catch(d){}},error:function(){b.notice("Error duplicating.",!0)}})):r(a,e,++f,h)}}))};(function(){$.ajax({type:"GET",url:"/admin/collects/count.json?collection_id="+l,success:function(a){f=a.count;0<f&&r(l,f,1)}})})()}})});d.append(e);a.append(d);c.prepend(a)}else b.notice("ShopifyFD error : setup_articles : Header button missing",
!0)},get_files:function(a,c){var d=$("#settings-general table");d.length&&(b.notice("Loading files..."),$.ajax({type:"GET",url:"/admin/files.json?limit=250&direction=next&page="+a,success:function(a,f,h){if(a){$("");f=0;for(h=a.files.length;f<h;f++){var g=$("<tr />",{"class":"file_row"}),k=$("<td />"),p=$("<td />"),n=$("<td />"),l=$("<td />",{"class":"tr"}),r=$("<td />"),u=$("<a />",{href:"#","data-src":a.files[f].public_url.replace("http:","")});if(-1<a.files[f].content_type.indexOf("image")){u.on("click",
function(){var a=$(this);b.fd_modal(!0,'<img src="'+a.attr("data-src")+'" />',"Image Preview",!0);return!1}).text(a.files[f].key.replace("files/",""));var t=a.files[f].public_url.replace(/(\.[^\.]+)$/,"_thumb$1").replace("http:","");k.html('<img src="'+t+'" />');p.append(u);n.html('<input class="select-all-on-focus" value="'+a.files[f].public_url+'">')}else u.attr("href",a.files[f].public_url).attr("target","_blank").text(a.files[f].key.replace("files/",""));l.html(Math.floor(a.files[f].size/1024)+
" kB");g.append(k,p,n,l,r);d.append(g)}f>=c?(b.notice("All loaded"),$(".header-right .segmented").hide()):(++f,b.get_files(f,c))}}}))},setup_files:function(){var a=$(".header-row .header-right").eq(0);if(a.length){var c=$("<ul/>",{"class":"segmented",id:"get_all_images"}),d=$("<li/>"),e=$("<a/>",{"class":"btn",href:"#",style:"margin-left:1em"}).html("Show all files").on("click",function(){var a=$(this);a.addClass("is-loading").attr("style","margin-left:1em;text-indent: -9999px;");$.ajax({type:"GET",
...
b.setup_announcements()}},b.data("wait"));b.notice("ShopifyFD loaded")},data:function(a,b){if("undefined"===typeof b)return r[a];r[a]=b},toggleStyle:function(){$("html").toggleClass("shopifyJSoverride")},isloading:function(){return b.data("content").hasClass("loading")}}}();b.load_css();b.init()}else alert("Error. This should be run within the Shopify Admin page.")}else alert("Error. jQuery not found.")})();