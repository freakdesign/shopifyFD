...
$("body").append(a)}else e.off("click").remove()},ia=function(){var a=$(".ui-title-bar .ui-title-bar__heading-group");if(!a.length)return f("ShopifyFD error : setup_discounts : target html not found",!0),!1;var c=$("<ul/>",{"class":"segmented",id:"discount_buttons"}),b=$("<li/>"),d=$("<a/>",{"class":"btn btn-separate disabled",href:"#"}).html("Bulk create").on("click",function(a){a.preventDefault()});b.append(d);c.append(b);a.after(c)},ja=function(){var a=$(".ui-layout__section--secondary .ui-layout__item:last"),
...
if(a.length){var b=document.createElement("div");b.innerHTML=a.html();a.text(b.textContent||b.innerText||"")}});$("#clear-html-attributes").on("click",function(a){a.preventDefault();ca()});$("#createbackup").on("click",function(a){a.preventDefault();M(h("omega"))});$("#save_images_to_meta").on("click",function(a){a.preventDefault();ka()});a=$("#rte-show-html");if(a.length){var c=$('<button name="" type="button" class="btn rte-tools__source-btn btn-slim fullscreen-rte-btn"><svg class="next-icon next-icon--color-slate next-icon--size-12"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#next-website"></use></svg></button>');
c.on("click",function(a){a.preventDefault();a=document.querySelectorAll('[data-context="descriptionRte"]');a.length&&a[0].classList.toggle("fullscreen-rte")});a.before(c)}},ka=function(){var a=$("iframe:first").contents().find("#tinymce:first").find("img");if(a&&a.length){var c="";a.each(function(b){var d=$(this).prop("src").replace(/https:/i,"");c+=d;b<a.length-1&&(c+=",")});var b={metafield:{namespace:"helpers",key:"images",value:c,value_type:"string"}},d=[location.protocol,"//",location.host,location.pathname,
...
data:{_method:"post"},url:"/admin/themes/"+d[a]+"/export"});f(d.length+" export request"+(1<d.length?"s":"")+" sent. Check your inbox")}),a.after(c)))}},ma=function(a){var c=$(".header .header__primary-actions:first");if(!c.length)return!1;$.ajax({type:"GET",url:"/admin/link_lists.json",dataType:"json",success:function(a){if(a){a=a.link_lists;for(var b="",e=0,f=a.length;e<f;e++)h("omega")!==a[e].id.toString()&&(b+='<option value="'+a[e].id+'">'+a[e].title+"</option>");a=$("<select />",{"class":"header-select fadein"}).append("<option>Edit other Menu</option>",
...
isNaN(a)||(f("Link list added"),r("/admin/link_lists/"+a)))},error:function(){f("Error creating linklist",!0)}})},l=$("<a/>",{href:"#","class":"btn btn-slim has-loading",style:"margin-right:1.5em"}).html("Copy").on("click",function(a){a.preventDefault();a=$(this);var b=a.parent().parent().find('a[href^="/admin/link_lists"]:first');if(b.length){if(a.addClass("is-loading"),b=b.attr("href").split("/").pop(),!isNaN(b)){var b=parseInt(b),c=h("link_lists");a=!1;for(var d=0;d<c.length;d++)if(b===c[d].id){a=
...
"http"!==d[1].substring(0,4)&&(d[1]="/"+d[1]),b.push({redirect:{path:d[0],target:d[1]}}))}b.length&&(h.val("").parent().removeClass("hide"),J(b))}});a.prepend(c)}},oa=function(){S();H(!0);h("collections",!1);var a=$(".ui-title-bar .ui-title-bar__heading-group");if(a.length){var c=$("<ul/>",{"class":"segmented"}),b=$("<li/>"),d=$("<a/>",{"class":"btn fd-btn",style:"margin-left:.5em",href:"#"}).text("Show Product Count").on("click",function(a){a.preventDefault();$.ajax({type:"GET",url:"/admin/collections.json?limit=250",
...
a[Object.keys(a)[0]].id;"undefined"!==b&&r("/admin/collections/"+b)}catch(ya){}},error:function(){f("Error duplicating.",!0)}});else{var e=0,h=window.location.pathname.split("/").pop(),k=function(a,d,e,g){"undefined"!==typeof a&&"undefined"!==typeof d&&("undefined"===typeof e&&(e=1),"undefined"===typeof g&&(g=[]),f("Duplicating collection, please wait..."),$.ajax({type:"GET",url:"/admin/collects.json?limit=250&fields=product_id&page="+e+"&collection_id="+a,success:function(h){g=g.concat(h.collects);
250*e>d?(b.custom_collection.collects=g,$.ajax({type:"POST",url:c,contentType:"application/json;charset=utf-8",data:JSON.stringify(b),success:function(a){try{var b=a[Object.keys(a)[0]].id;"undefined"!==b&&r("/admin/collections/"+b)}catch(za){}},error:function(){f("Error duplicating.",!0)}})):k(a,d,++e,g)}}))};(function(){$.ajax({type:"GET",url:"/admin/collects/count.json?collection_id="+h,success:function(a){e=a.count;0<e&&k(h,e,1)}})})()}})});b.append(d);a.append(b);c.prepend(a)}else f("ShopifyFD error : setup_single_article : Header button missing",
!0)},va=function(){var a=$(".ui-title-bar .ui-title-bar__heading-group");if(a.length){var c=$("<ul/>",{"class":"segmented",id:"get_all_images"}),b=$("<li/>"),d=$("<a/>",{"class":"btn",href:"#",style:"margin-left:1em"}).html("Download file list").on("click",function(){var a=$(this);(function(){var b=[];a.addClass("is-loading").attr("style","margin-left:1em;text-indent: -9999px;");var c=function(d){"undefined"===typeof d&&(d="/admin/settings/files");$.ajax({url:d,success:function(d){d=$(d);for(var e=
...
'" data-id="'+a[c].id+'">'+a[c].namespace+"."+a[c].key+"</option>",k.metafields[a[c].id]={namespace:a[c].namespace,value:a[c].value,key:a[c].key},"backups"===a[c].namespace&&$("#restorebackup").show(),"seo"===a[c].namespace&&"hidden"===a[c].key&&1===a[c].value&&E(a[c].id);b=x+b}else $("#metacount").text("0").addClass("hide"),h("m",!1),$("#restorebackup").hide(),b=x;$("#metafieldselect").html(b);P()})},xa=function(){if(!$("#toggleBigMode").length){var a=$(".ui-app-frame__main");if(a.length){var c=
...
$(".next-card-metafield").removeClass("next-card--aside"),u(a))):"settings"===b&&"shipping"===e?$(".ui-annotated-section__annotation .ui-annotated-section__description").eq(2).append("<br><br><p>Shipping rates copy and paste has moved into each shipping zone.</p>"):"shipping_zones"!==b||isNaN(e)||ta()}},1E3);f("ShopifyFD loaded")})()}else f("Browser unsupported (classList)")})();