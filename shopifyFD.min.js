...
c=a.find("a.create"),d=a.find("a.createint");a.find("a.update");a.find("a.delete");var e=a.find("#bulk_namespace"),f=a.find("#bulk_key"),k=a.find("#bulk_value"),g=a.find("textarea.debug"),l=function(){return 1<e.val().length&&1<f.val().length&&1<k.val().length?!0:!1};c.off("click").on("click",function(){if(l){var a={metafield:{namespace:e.val(),key:f.val(),value:k.val(),value_type:"string"}};b.bulk_save_metafield_queue(a,0,g)}else b.notice("No empty fields allowed")});d.off("click").on("click",function(){if(l)if(isNaN(k.val()))b.notice("Value not an integer",
!0);else{g.val(b.data("products"));var a={metafield:{namespace:e.val(),key:f.val(),value:k.val(),value_type:"integer"}};b.bulk_save_metafield_queue(a,0,g)}else b.notice("No empty fields allowed",!0)});$.ajax({type:"GET",url:"/admin/products.json?fields=id,title",dataType:"json",success:function(c){c.products&&(c.products.length?(b.data("products",c.products),b.fd_modal(!0,a,"Bulk Metafield editing (for "+c.products.length+" products)",!0)):b.notice("No products found",!0))},error:function(a){b.notice("Error getting products",
...
"";return!1};a.ondragend=function(){this.className="";return!1};a.ondrop=function(a){a.preventDefault&&a.preventDefault();var d=a.dataTransfer.files,e=d.length,f=0,k=new FileReader,g={};k.onload=function(a){b.flog("load");a=a.target.result.split(",")[1];g[f]={name:d[f].name,data:a};f++;f<e?(b.notice("Reading file ["+(f+1)+"] contents..."),k.readAsDataURL(d[f])):b.do_upload(g)};e&&(document.documentElement.className="dragit",b.notice("Reading file ["+(f+1)+"] contents..."),k.readAsDataURL(d[f]));return!1}}},
...
h)},setup_blogs:function(){var a=$("div.span6.section-summary a.view-in-store"),c=$('h1.header-main span[data-bind="blog.title"]');c.addClass("view-in-store").html('<a target="shopify_storeview" href="'+a.prop("href")+'">'+c.text()+"</a>").prop("title","View in store");a.remove();$("div.span6.section-summary").eq(0).find("p, h1").remove().end().append('<div class="sub_section-summary"><h1><strong>Metafields</strong> <span id="metacount">0</span></h1><div class="content"><i class="ico ico-20 ico-20-loading"></i></div></div>');
var d=$("div.sub_section-summary .content");window.setTimeout(function(){b.loadmeta(d,h)},250)},setup_rte:function(){b.data("hasbackup")&&$("#restorebackup").show();$("#clearformatting").on("click",function(){b.clearformatting();return!1});$("#createbackup").on("click",function(){b.createbackup(b.data("omega"));return!1});$("#restorebackup").on("click",function(){b.restorebackup(b.data("omega"));return!1});$("#save_images_to_meta").on("click",function(){b.save_images_to_meta();return!1})},save_images_to_meta:function(){var a=
...
g.val()+"&fields=id,tags",dataType:"json",success:function(a){d.addClass("disabled");s(a,0,l.val(),function(){b.notice("Matched tags have been removed.");d.text("Update tags").removeClass("disabled")})}})):b.notice("Choose a collection",!0);return!1});c.hide();$.ajax({type:"GET",url:"/admin/collections.json",dataType:"json",success:function(a){if(a.collections.length){b.data("collections",a);for(var d="",e=0,k=a.collections.length;e<k;e++)d+='<option value="'+a.collections[e].id+'">'+a.collections[e].title+
"</option>";g.append(d).find("option:eq(0)").text("Select a collection");c.show()}}});return!1});c.append(d);a.append(c);$(".header-right .segmented").eq(1).after(a)},seo_description:function(){var b=$("#seo-description-tag"),c=$("<textarea/>");c.val(b.val()).keyup(function(){b.val($(this).val())});b.after(c).hide()},setup_copypaste:function(){var a=$('<div><a class="btn btn-slim" id="fd_copymetafields">Copy Metafields</a> <a class="btn btn-slim" id="fd_pastemetafields">Paste Metafields</a> <a class="btn btn-slim" title="What have I copied?" href="#" id="fd_whatmetafields">?</a></div>'),
c=a.find("#fd_pastemetafields"),d=a.find("#fd_whatmetafields");a.find("#fd_copymetafields").on("click",function(){b.data("m")?(b.data("m-copy",b.data("m")),b.notice(b.data("m-copy").length+" Metafields copied"),c.show(),d.show()):(c.hide(),d.hide());return!1});d.on("click",function(){if(b.data("m-copy")){for(var a="",c=b.data("m-copy"),d=0,g=c.length;d<g;d++)a+="<p><strong>"+c[d].namespace+"."+c[d].key+" ("+c[d].value_type+")</strong><br>"+c[d].value+"</p><hr>";b.fd_modal(!0,a,"In the virtual clipboard...")}return!1});
c.on("click",function(){b.data("m-copy")&&b.save_metafield_queue(b.data("m-copy"),0);return!1});b.data("m-copy")||(c.hide(),d.hide());$("div.sub_section-summary").after(a)},save_metafield_queue:function(a,c){b.fd_modal(!0,"","Please wait whilst we past the metafields",!0);$.ajax({type:"POST",url:n.URL+"/metafields.json",dataType:"json",data:{metafield:{namespace:a[c].namespace,key:a[c].key,value:a[c].value,value_type:a[c].value_type}},success:function(d){c+1<a.length?b.save_metafield_queue(a,c+1):
(b.updatedropdown(),b.fd_modal(!1),b.notice("Pasted!"))}})},setup_products:function(){clearInterval(b.data("autosave"));$.ajax({type:"GET",url:"/admin/products.json?limit=25",dataType:"json",success:function(a){if(a&&(products=a.products,a=products.length,25>=a))for(var c=0;c<a;c++)b.data("omega")},error:function(a){b.notice("Error loading linklist data",!0)}});$("div.span6.section-summary").eq(0).append('<div class="sub_section-summary"><h1><strong>Metafields</strong> <span id="metacount">0</span></h1><div class="content"><i class="ico ico-20 ico-20-loading"></i></div></div>').find("div:first-child").remove();
0==$("#rte_extra").length?($("#product-body-html_ifr").eq(0).after('<div id="rte_extra"><a class="btn btn-slim" title="Careful, this method is brutal..." id="clearformatting" href="#">Purge html</a> <a class="btn btn-slim" id="createbackup" href="#">Create Backup</a> <a class="btn btn-slim" style="display:none;" id="restorebackup" href="#">Restore Backup</a> <a class="btn btn-slim" title="Add any images in the description to a Metafield" id="save_images_to_meta" href="#">Images to Metafields</a></div>'),
b.setup_rte(),$(".rtetools-buttons ul.fr").eq(1).append('<li><a id="autosave" tabindex="-1" class="btn btn-slim tooltip tooltip-bottom" href="#"><span class="tooltip-container"><span class="tooltip-label">Enable Autosave</span></span>Autosave</a></li>'),$("#autosave").on("click",function(){var a=!1;$(this).hasClass("rte-command-active")?(b.notice("Autosave disabled"),clearInterval(b.data("autosave"))):(a=$('#products-show header input[type="submit"]'),b.notice("Autosave enabled"),b.data("autosave",
setInterval(function(){a.length?a.click():(clearInterval(b.data("autosave")),a=null,b.notice("Autosave disabled"))},3E4)));$(this).toggleClass("rte-command-active");return!1})):b.notice("Bug! I tried to load the content editor twice.",!0);b.btn_removealltags();b.seo_description();var a=$("div.span6.section-summary a.view-in-store"),c=$('h1.header-main span[data-bind="product.title"]'),d=$("div.sub_section-summary .content");c.addClass("view-in-store").html('<a target="shopify_storeview" href="'+a.prop("href")+
'">'+c.text()+"</a>").prop("title","View in store");a.remove();b.loadmeta(d,h);$("#product-inner-variants th:last-child").before("<th>Variant ID</th>");$("th.inventory.tc").text("#").prop("title","Quantity");$("tr.variant").each(function(b){b=$("td.sku input.mock-edit-on-hover").eq(b).prop("id").split(/[- ]+/).pop();$(this).find("td:last-child").before('<td class="vid tooltip tooltip-bottom"><input class="mock-edit-on-hover" data-action="selectall" data-val="'+b+'" type="text" value="'+b+'" /><span class="tooltip-container"><span class="tooltip-label">Click to edit Metafields</span></span></td>')}).promise().done(function(){b.panel_editvariantmeta()});
$("table.product-collections").eq(0).find("tr").each(function(){var a=$("<a/>",{"class":"btn",href:"#",title:"Set a metafield with this collection handle"}).text("Set as preferred").on("click",function(){b.fd_modal(!0,"soon...","Future function");return!1});$(this).find("td.col-remove").prepend(a)});a=$("table.variants .bulk-actions").eq(0);if(a.length){var e=$("<a/>",{href:"#","class":"btn btn-slim hidden",style:"padding-left:.5em"}).text("Edit weight").on("click",function(){b.fd_modal(!0,'<label>New weight (grams)</label><input class="half" min="0" type="number" data-action="update-variant-weight" /><a data-action="update-variant-weight" href="#" class="btn btn-slim">Save</a><br><br><small>Note: You will need to reload this page before Shopify will show the new weight in the dashboard.</small>',
...
d<e.length?f(d,e):(b.notice("Weight updated"),a.removeClass("is-loading").text("Save"))}})};a.addClass("is-loading").text("");f(0,e)}else b.notice("Did you set a weight?",!0);return!1});return!1});$("<span/>",{"class":"hidden"});var f=$("<a/>",{href:"#","class":"btn btn-slim hidden",style:"padding-left:.5em"}).text("Edit metafields").on("click",function(){$('tr.variant input[type="checkbox"]:checked').eq(0).parent().parent().find("td.vid").click();return!1});a.append(e,f);$('tr.variant input[type="checkbox"]').on("change",
function(){var b=$('tr.variant input[type="checkbox"]:checked').length;1<b?(e.removeClass("hidden"),f.addClass("hidden")):(e.addClass("hidden"),1===b?f.removeClass("hidden"):f.addClass("hidden"))})}},setup_pages:function(){var a=$("div.span6.section-summary a.view-in-store"),c=$('h1.header-main span[data-bind="page.title"]');$("#page-content_ifr").eq(0).after('<div id="rte_extra"><a class="btn btn-slim" title="Careful, this method is brutal..." id="clearformatting" href="#">Purge html</a> <a class="btn btn-slim" id="createbackup" href="#">Create Backup</a> <a class="btn btn-slim" style="display:none;" id="restorebackup" href="#">Restore Backup</a> <a class="btn btn-slim" title="Add any images in the description to a Metafield" id="save_images_to_meta" href="#">Images to Metafields</a></div>');
b.setup_rte();c.addClass("view-in-store").html('<a target="shopify_storeview" href="'+a.prop("href")+'">'+c.text()+"</a>").prop("title","View in store");b.seo_description();a.remove();$("div.span6.section-summary").eq(0).find("p, h1").remove().end().append('<div class="sub_section-summary"><h1><strong>Metafields</strong> <span id="metacount">0</span></h1><div class="content"><i class="ico ico-20 ico-20-loading"></i></div></div>');a=$("div.sub_section-summary .content");b.loadmeta(a,h)},shipping_remove_all:function(a,
c){0<=a?$.ajax({type:"DELETE",url:"/admin/countries/"+c[a].id+".json",dataType:"json",success:function(d){b.notice("removed "+c[a].name);a-=1;b.shipping_remove_all(a,c)}}):$.ajax({url:"/admin/settings/shipping",success:function(){$("div.shipping-rate-table").remove()}})},save_new_rates:function(a,c,d){if(a[c]){var e=a[c],f={},k=e.type,g="";delete e.type;k?("weight"===k?(f={weight_based_shipping_rate:{}},f.weight_based_shipping_rate=e,g="/admin/weight_based_shipping_rates.json"):"price"===k?(f={price_based_shipping_rate:{}},
f.price_based_shipping_rate=e,g="/admin/price_based_shipping_rates.json"):"carrier"===k&&(f={carrier_shipping_rate_provider:{}},f.carrier_shipping_rate_provider=e,g="/admin/carrier_shipping_rate_providers.json"),$.ajax({type:"POST",url:g,dataType:"json",data:f,success:function(e){d.parent().parent().find("table").append('<tbody><tr style="background:#efefef"><td>'+a[c].name+'</td><td>Pasted a custom shipping rate. <a href=".">Refresh page</a> to view</td><td>'+a[c].price+"</td></tr></tbody>");c===
a.length-1?b.notice("Paste complete"):(c++,b.save_new_rates(a,c,d))}})):b.notice("missing type: "+k,!0)}else b.notice("save_new_rates error - length",!0)},setup_shipping:function(a){if(a){b.fd_modal(!1);$("div.span6.section-summary").eq(0).append('<p style="margin-top:1em" class="box warning">Warning: When you copy and paste over existing rates the old ones still show until the page is refreshed, even though they have been removed. <br><br>Be sure to do a test first. <strong>Use at own risk.</strong></p>');
...
a.find("a.delete_all").on("click",function(){$.ajax({type:"GET",url:"/admin/countries.json",dataType:"json",success:function(a){a.countries.length&&(h.countries=a.countries,b.notice(a.countries.length+" countries returned"),b.shipping_remove_all(a.countries.length-1,a.countries))}});return!1});b.fd_modal(!0,a,"Delete all countries",!0);return!1});a.find("header").eq(0).append(c);if($("div.shipping-rate-table").length===b.data("countries").countries.length){var d=[],e=[],f=[],k=function(a,c,d){if(c.length){var e=
[];$.ajax({type:"GET",url:"/admin/countries/"+a+".json",dataType:"json",success:function(a){var f=a.country.weight_based_shipping_rates,g=a.country.price_based_shipping_rates,k=a.country.carrier_shipping_rate_providers;a=0;for(var h=f.length;a<h;a++)e.push([f[a].id,"weight"]);a=0;for(h=g.length;a<h;a++)e.push([g[a].id,"price"]);a=0;for(h=k.length;a<h;a++)e.push([k[a].id,"carrier"]);a=0;for(h=e.length;a<h;a++)f="","weight"==e[a][1]&&(f="/admin/weight_based_shipping_rates/"),"price"==e[a][1]&&(f="/admin/price_based_shipping_rates/"),
...
"data-cid":b.data("countries").countries[a].id,"data-index":a,"class":"bulkpaste btn btn-slim",style:"float:right;margin-right:.5em"}).text("Paste rates").on("click",function(){var b=$(this),a=b.attr("data-cid"),c=d,g=e,l=f,p=[],h=0;b.parent().parent().find("tbody").remove();b.parent().find("a.copyrates").remove();for(var q=0,n=c.length;q<n;q++)c[q].country_id=a,delete c[q].id,c[q].type="weight",p[h]=c[q],h++;q=0;for(n=g.length;q<n;q++)g[q].country_id=a,delete g[q].id,g[q].type="price",p[h]=g[q],
h++;q=0;for(n=l.length;q<n;q++)l[q].country_id=a,delete l[q].id,l[q].type="carrier",p[h]=l[q],h++;k(a,p,b);return!1}).hide();c.find('a[data-event-click="setupNewShippingRateForm"]').after(a,p)})}else b.notice("Mismatch in country count. Reload this page.",!0)}else $.ajax({type:"GET",url:"/admin/countries.json",dataType:"json",success:function(a){a.countries.length&&(b.data("countries",a),b.notice(a.countries.length+" countries loaded"),b.setup_shipping(!0))}})},setup_custom_collections:function(){$("div.row.section.visibility").eq(0).after('<div class="row section" id="customer_meta_box"><div class="span12 section-summary"><div class="sub_section-summary"><h1><strong>Metafields</strong> <span id="metacount">0</span></h1><div class="content"><i class="ico ico-20 ico-20-loading"></i></div></div></div></div>');
var a=$("div.sub_section-summary .content");b.loadmeta(a,h);0==$("#rte_extra").length&&($("#collection-body-html_ifr").eq(0).after('<div id="rte_extra"><a class="btn btn-slim" title="Careful, this method is brutal..." id="clearformatting" href="#">Purge html</a> <a class="btn btn-slim" id="createbackup" href="#">Create Backup</a> <a class="btn btn-slim" style="display:none;" id="restorebackup" href="#">Restore Backup</a> <a class="btn btn-slim" title="Add any images in the description to a Metafield" id="save_images_to_meta" href="#">Images to Metafields</a></div>'),
b.setup_rte())},get_files:function(a,c){var d=$("#settings-general table");b.notice("Loading files...");$.ajax({type:"GET",url:"/admin/files.json?limit=50&direction=next&page="+a,success:function(a,f,k){if(a){$("");f=0;for(k=a.files.length;f<k;f++){var g=$("<tr />",{"class":"file_row"}),l=$("<td />"),p=$("<td />"),h=$("<td />"),r=$("<td />",{"class":"tr"}),n=$("<td />"),v=$("<a />",{href:"#","data-src":a.files[f].public_url.replace("http:","")});if(-1<a.files[f].content_type.indexOf("image")){v.on("click",
function(){var a=$(this);b.fd_modal(!0,'<img src="'+a.attr("data-src")+'" />',"Image Preview",!0);return!1}).text(a.files[f].key.replace("files/",""));var t=a.files[f].public_url.replace(/(\.[^\.]+)$/,"_thumb$1").replace("http:","");l.html('<img src="'+t+'" />');p.append(v);h.html('<input class="select-all-on-focus" value="'+a.files[f].public_url+'">')}else v.attr("href",a.files[f].public_url).attr("target","_blank").text(a.files[f].key.replace("files/",""));r.html(Math.floor(a.files[f].size/1024)+
" kB");g.append(l,p,h,r,n);d.append(g)}f>=c?(b.notice("All loaded"),$(".header-right .segmented").hide()):(++f,b.get_files(f,c))}}})},setup_files:function(){var a=$("<ul/>",{"class":"segmented",id:"get_all_images"}),c=$("<li/>"),d=$("<a/>",{"class":"btn",href:"#",style:"margin-left:1em"}).html("Show all files").on("click",function(){var a=$(this);a.addClass("is-loading").attr("style","margin-left:1em;text-indent: -9999px;");$.ajax({type:"GET",url:"/admin/files.json?limit=2&fields=id",success:function(a,
...
a=$("div.sub_section-summary .content");b.loadmeta(a,h)},setup_customers:function(){$("section.customer-details.ssb .box-details").eq(0).after('<div id="customer_meta_box" class="box box-details"><div class="box-header p"><h3>Metafields</h3></div><div class="box-content p"><div class="sub_section-summary"><h1><strong>Metafields</strong> <span id="metacount">0</span></h1><div class="content"><i class="ico ico-20 ico-20-loading"></i></div></div></div>');var a=$("div.sub_section-summary .content");b.loadmeta(a,
h)},setup_single_order:function(){$("div.order-sidebar .box-details").eq(0).after('<div id="customer_meta_box" class="box box-details"><div class="box-header p"><h3>Metafields</h3></div><div class="box-content p"><div class="sub_section-summary"><h1><strong>Metafields</strong> <span id="metacount">0</span></h1><div class="content"><i class="ico ico-20 ico-20-loading"></i></div></div></div>');var a=$("div.sub_section-summary .content");b.loadmeta(a,h);var a=$('div.address[data-showif="order.billing_address"]').eq(0),
...
$.ajax({type:"GET",url:"/admin/themes.json",success:function(a){if(a)for(var c=0,d=a.themes.length;c<d;c++)"main"===a.themes[c].role&&(b.flog(a.themes[c].id),b.data("themeID",a.themes[c].id),b.data("themeName",a.themes[c].name))}})},init:function(){b.set_drag_drop();b.get_theme_data();b.data("debug")||b.readCookie("shopifyfd")||(b.flash_notification(),b.createCookie("shopifyfd","loaded",3));$("#togglestyle").click();setInterval(function(){if(!b.data("content").hasClass("loading")){var a=n.URL.split("#")[0].split("?")[0].split("/"),
...
"link_lists"!=b.data("alpha")||isNaN(b.data("omega"))?"admin"==b.data("alpha")&&"discounts"==b.data("omega")?b.setup_discounts():"settings"==b.data("alpha")&&"general"==b.data("omega")?b.setup_settings_general():"settings"==b.data("alpha")&&"files"==b.data("omega")?b.setup_files():"settings"==b.data("alpha")&&"shipping"==b.data("omega")?b.setup_shipping():"settings"==b.data("alpha")&&b.data("omega"):b.setup_link_lists_edit():b.setup_single_order():b.setup_blogs():b.setup_custom_collections():b.setup_custom_collections():
b.setup_custom_collections():b.setup_pages():b.setup_articles():b.setup_customers()}},b.data("wait"))},data:function(a,b){if("undefined"===typeof b)return h[a];h[a]=b},toggleStyle:function(){$("html").toggleClass("shopifyJSoverride")},isloading:function(){return b.data("content").hasClass("loading")}}}();b.load_css();var y=$("body"),t=$("<div>",{id:"shopifyJSbar","class":"loading noprint"}),x=$("<div>",{"class":"wrapper clearfix"}),w=$("<ul>",{id:"shopifyJSnav"});w.html('<li><a title="About this tool" id="aboutapp" href="javascript:void(0)">About ShopifyFD</a></li><li><a title="View recent news" id="getnotifications" href="javascript:void(0)"><i class="ico ico-16 ico-announcements-inactive"></i></a></li><li><a id="togglestyle" href="javascript:void(0)">Toggle CSS</a></li>\x3c!--<li><a id="themesettings" href="javascript:void(0)">Theme Settings</a></li><li><a id="manageinventory" href="javascript:void(0)">Manage Inventory</a></li>--\x3e<li><a id="bulkmetafields" href="javascript:void(0)">Bulk Metafields</a></li><li><a href="//freakdesign-us.s3.amazonaws.com/shopify/shopifyFD/freakdesign-shopifyfd-for-shopify-guide.pdf" target="_blank">Help</a></li><li><a title="This tool is free, consider leaving a tip" href="http://shopify.freakdesign.com.au/#donate" target="_blank">Use this free tool? Tip me! ($)</a></li>');
w.find("a").on("click",function(){if(b.isloading())b.notice("We better wait for this page to load first...",!0);else{var h=$(this),a=h.prop("id");if(a){if("manageinventory"!=a||"inventory"===b.data("alpha"))"bulkmetafields"==a?b.bulkmetafields():"themesettings"==a&&isNaN(b.data("alpha"))?b.redirect("/themes/current/settings"):"togglestyle"==a?(b.toggleStyle(),h.toggleClass("active")):"aboutapp"==a?b.about_app():"getnotifications"==a&&b.show_notification()}else return!0}return!1});x.append(w);t.append(x);
y.append(t);t.removeClass("loading");b.notice("ShopifyFD loaded");b.init()}else alert("Error. This should be run within the Shopify Admin page.")}else alert("Error. jQuery not found.")})();