...
b.notice("Error creating linklist - ID not returned",!0):(b.notice("Link list added"),b.redirect("/admin/link_lists/"+linklistID))):(linklistID=$(a).find("form").eq(0).attr("action").split("/").pop(),isNaN(linklistID)||(b.notice("Link list added"),b.redirect("/admin/link_lists/"+linklistID)))},error:function(){b.notice("Error creating linklist",!0)}})},h=$("<a/>",{href:"#","class":"tooltip-bottom tooltip",style:"margin-right:1.5em"}).html('<span class="tooltip-container"><span class="tooltip-label">Make a copy of this linklist</span></span>Copy').on("click",
...
function(){$(this).addClass("is-loading disabled");e();return!1});h.length&&h.append("<br>",g,"<br>",k,"<br>",p);h=$('.section-summary a[href="/admin/link_lists/new"]');if(h.length&&(g=$("#link_lists .next-grid__cell header a:last-child"),g.length)){var n="";2<g.length&&(g.each(function(){var b=$(this),a=b.parent().parent().find("h3").text(),b=b.attr("href");a.length&&b.length&&(n+='<option value="'+b+'">'+a+"</option>")}),n.length&&(g=$("<select />",{style:"margin-top:1em;border-radius:3px;border-color: #D3D3D3;color: #479ccf;width: 100%"}).on("change",
function(){var a=$(this).val();a.length&&b.redirect(a)}).html('<option value="">Jump to linklist</option>'+n),k=$("<div />"),k.append(g,'<small style="display: block;background: #fff;padding: .5em;">Select a linklist to quickly jump to edit view. Useful for when you have many linklists...</small>'),h.after(k)))}},setup_collections:function(){b.data("collections",!1);var a=$(".header-right").eq(0);if(a.length){var c=$("<ul/>",{"class":"segmented"}),d=$("<li/>"),e=$("<a/>",{"class":"btn",style:"margin-left:.5em",
