...
b).change(function(){var a=$(this).val();a&&r("/admin/link_lists/"+a)});c.prepend(a)}},error:function(a){f("Error loading linklist data",!0)}})},I=function(){var a=$(".next-card__section .next-grid__cell--no-flex"),c=function(){$.ajax({type:"GET",url:"/admin/collections.json?limit=250",dataType:"json",success:function(a){for(var b=$.param({utf8:"\u2713","link_list[handle]":"all-collections","link_list[title]":"All Collections"}),c=[],d=0,p=a.collections.length;d<p;++d){c.push({position:d+1,title:a.collections[d].title,
...
100)},function(){clearTimeout(c);$(this).find("div.bubble").addClass("hide")})},E=function(a){"undefined"!==typeof a?$(".seo-hide-button").addClass("active").attr("data-id",a).text("Show in Sitemap"):$(".seo-hide-button").removeClass("active").removeAttr("data-id").text(q.hide_from_sitemap)},t=function(){var a=y();$.getJSON(a,function(a){var b="";a=a.metafields;E();if(a.length){h("m",a);$("#metacount").text(a.length).removeClass("hide");for(var c=0,e=a.length;c<e;c++)b+='<option data-type="'+a[c].value_type+
